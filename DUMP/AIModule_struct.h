...
struct FAIStimulus {
	...
	char pad_44[0x8]; // 0x44(0x08)
	char pad_4C_0 : 1; // 0x4c(0x01)
	char bSuccessfullySensed : 1; // 0x4c(0x01)
...
struct FEnvNamedValue {
	...
	enum class EAIParamType ParamType; // 0x04(0x01)
...
struct FBlackboardKeySelector {
	...
	struct FName SelectedKeyName; // 0x10(0x04)
...
struct FEnvTraceData {
	...
	struct FName TraceProfileName; // 0x2c(0x04)
	enum class EEnvTraceShape TraceShape; // 0x30(0x01)
	enum class EEnvQueryTrace TraceMode; // 0x31(0x01)
...
struct FAIDataProviderValue {
	...
	struct FName DataField; // 0x18(0x04)
