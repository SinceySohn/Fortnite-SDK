...
struct UAudioGameplayVolumeMutator : UAudioGameplayComponent {
	...
	void SetPriority(int32_t InPriority); // Function AudioGameplayVolume.AudioGameplayVolumeMutator.SetPriority // (Final|Native|Public|BlueprintCallable) // @ game+0x704f8e4
};
...
struct UAttenuationVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetInteriorVolume(float Volume, float InterpolateTime); // Function AudioGameplayVolume.AttenuationVolumeComponent.SetInteriorVolume // (Final|Native|Public|BlueprintCallable) // @ game+0x704f810
	void SetExteriorVolume(float Volume, float InterpolateTime); // Function AudioGameplayVolume.AttenuationVolumeComponent.SetExteriorVolume // (Final|Native|Public|BlueprintCallable) // @ game+0x704f73c
};
...
struct AAudioGameplayVolume : AVolume {
	...
	void SetEnabled(bool bEnable); // Function AudioGameplayVolume.AudioGameplayVolume.SetEnabled // (Final|Native|Public|BlueprintCallable) // @ game+0x704f6a4
	void OnRep_bEnabled(); // Function AudioGameplayVolume.AudioGameplayVolume.OnRep_bEnabled // (Native|Protected) // @ game+0x67a7e04
	void OnListenerExit(); // Function AudioGameplayVolume.AudioGameplayVolume.OnListenerExit // (Native|Event|Public|BlueprintEvent) // @ game+0x2905a84
	void OnListenerEnter(); // Function AudioGameplayVolume.AudioGameplayVolume.OnListenerEnter // (Native|Event|Public|BlueprintEvent) // @ game+0x28b6318
};
...
struct UFilterVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetInteriorLPF(float Volume, float InterpolateTime); // Function AudioGameplayVolume.FilterVolumeComponent.SetInteriorLPF // (Final|Native|Public|BlueprintCallable) // @ game+0x704f810
	void SetExteriorLPF(float Volume, float InterpolateTime); // Function AudioGameplayVolume.FilterVolumeComponent.SetExteriorLPF // (Final|Native|Public|BlueprintCallable) // @ game+0x704f73c
};
...
struct UReverbVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetReverbSettings(struct FReverbSettings& NewReverbSettings); // Function AudioGameplayVolume.ReverbVolumeComponent.SetReverbSettings // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x704f970
};
...
struct USubmixOverrideVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetSubmixOverrideSettings(struct TArray<struct FAudioVolumeSubmixOverrideSettings>& NewSubmixOverrideSettings); // Function AudioGameplayVolume.SubmixOverrideVolumeComponent.SetSubmixOverrideSettings // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x704fa34
};
...
struct USubmixSendVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetSubmixSendSettings(struct TArray<struct FAudioVolumeSubmixSendSettings>& NewSubmixSendSettings); // Function AudioGameplayVolume.SubmixSendVolumeComponent.SetSubmixSendSettings // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x704fad8
};
