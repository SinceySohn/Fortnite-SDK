...
struct UBP_Shotgun_RG_BFPA_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function BP_Shotgun_RG_BFPA.BP_Shotgun_RG_BFPA_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xdef49c
	void ExecuteUbergraph_BP_Shotgun_RG_BFPA(int32_t EntryPoint); // Function BP_Shotgun_RG_BFPA.BP_Shotgun_RG_BFPA_C.ExecuteUbergraph_BP_Shotgun_RG_BFPA // (Final|UbergraphFunction) // @ game+0xdef49c
};
