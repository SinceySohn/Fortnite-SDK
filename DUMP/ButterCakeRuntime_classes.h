...
struct UButterCakeUnstuckComponent : UActorComponent {
	...
	void ResetUnstuckLocationSamples(); // Function ButterCakeRuntime.ButterCakeUnstuckComponent.ResetUnstuckLocationSamples // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x65d90e0
	void HandleAthenaGamePhaseChanged(enum class EAthenaGamePhase GamePhase); // Function ButterCakeRuntime.ButterCakeUnstuckComponent.HandleAthenaGamePhaseChanged // (Final|Native|Private) // @ game+0x65d8dec
};
...
struct UFortAIAnimInstance_ButterCake : UFortAIAnimInstance {
	...
	void SetFootPhaseMembers(); // Function ButterCakeRuntime.FortAIAnimInstance_ButterCake.SetFootPhaseMembers // (Final|Native|Public|BlueprintCallable) // @ game+0x65d90f4
	float ComputeLeanAngleByVelocity(); // Function ButterCakeRuntime.FortAIAnimInstance_ButterCake.ComputeLeanAngleByVelocity // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65d8c84
	enum class EFortButterCakeFootPhase ComputeFootPhase(); // Function ButterCakeRuntime.FortAIAnimInstance_ButterCake.ComputeFootPhase // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65d8c60
};
...
struct UFortButterCakeComponent_Telemetry : UFortAIComponent_Telemetry {
	...
	void OnLured(); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnLured // (Final|Native|Public|BlueprintCallable) // @ game+0x65d90cc
	void OnItemsSneezed(int32_t ItemsCount); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnItemsSneezed // (Final|Native|Public|BlueprintCallable) // @ game+0x65d9048
	void OnItemsEaten(int32_t ItemsCount); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnItemsEaten // (Final|Native|Public|BlueprintCallable) // @ game+0x65d8fcc
	void OnEnterBerserk(struct AController* Instigator); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnEnterBerserk // (Final|Native|Public|BlueprintCallable) // @ game+0x65d8ee4
	void OnBlowHoleUsed(); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnBlowHoleUsed // (Final|Native|Public|BlueprintCallable) // @ game+0x65d8ed0
};
...
struct UFortButterCakeControlRig : UControlRig {
	...
	struct FVector GetGroundHitNormalAt(int32_t Index); // Function ButterCakeRuntime.FortButterCakeControlRig.GetGroundHitNormalAt // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x65d8d4c
	struct FVector GetGroundHitLocationAt(int32_t Index); // Function ButterCakeRuntime.FortButterCakeControlRig.GetGroundHitLocationAt // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x65d8cac
};
