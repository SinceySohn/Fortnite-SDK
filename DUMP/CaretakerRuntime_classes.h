...
struct AFortAthenaCaretakerAIController : AAthenaAIController {
	...
	void OnMovementModeChanged(struct ACharacter* CharacterOwner, enum class EMovementMode PreviousMovementMode, char PreviousCustomMode); // Function CaretakerRuntime.FortAthenaCaretakerAIController.OnMovementModeChanged // (Final|Native|Public) // @ game+0x675ebf8
	void DebugUpdate(float UpdateInterval); // Function CaretakerRuntime.FortAthenaCaretakerAIController.DebugUpdate // (Final|Native|Public|BlueprintCallable) // @ game+0x65384b8
};
...
struct UFortAIAnimInstance_Caretaker : UFortAIAnimInstance {
	...
	void SetDelayedMaterialParameters(); // Function CaretakerRuntime.FortAIAnimInstance_Caretaker.SetDelayedMaterialParameters // (Final|Native|Protected|BlueprintCallable) // @ game+0x675f010
	struct UFortAnimWorldStriderComponent* GetWorldStriderComponent(); // Function CaretakerRuntime.FortAIAnimInstance_Caretaker.GetWorldStriderComponent // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x675ebd0
	float GetWalkSpeedWarpingValue(); // Function CaretakerRuntime.FortAIAnimInstance_Caretaker.GetWalkSpeedWarpingValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x675eba4
	float GetWalkPlayRateValue(); // Function CaretakerRuntime.FortAIAnimInstance_Caretaker.GetWalkPlayRateValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x675eb84
	float GetStartAnimPosition(); // Function CaretakerRuntime.FortAIAnimInstance_Caretaker.GetStartAnimPosition // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x675eb58
};
