...
struct FLacklusterMaterialsAndTypes {
	enum class ELacklusterActorType ActorType; // 0x00(0x01)
	enum class ELacklusterChromeType ChromeType; // 0x01(0x01)
	char pad_2[0x6]; // 0x02(0x06)
	struct TArray<struct FLacklusterMaterialData> ChromeMaterialData; // 0x08(0x10)
	struct TArray<struct FLacklusterOriginalMaterialData> OriginalMaterialData; // 0x18(0x10)
	struct TMap<struct FName, float> ContainerMatScalarParamMap; // 0x28(0x50)
	struct TMap<struct FName, struct FLinearColor> ContainerMatVectorParamMap; // 0x78(0x50)
...
struct FLacklusterData {
	...
	struct UStaticMeshComponent* ShadowProxyMeshComponentClass; // 0x2d0(0x08)
	struct TMap<struct AActor*, struct FLacklusterMaterialsAndTypes> MaterialsAndTypes; // 0x2d8(0x50)
	struct FGameplayTag OffroadTireTag; // 0x328(0x04)
	char pad_32C[0x4]; // 0x32c(0x04)
	struct FGameplayTagContainer ContainerTags; // 0x330(0x20)
	struct UFortChromeSubsystem* ChromeSubsystemClass; // 0x350(0x08)
	bool bIsInitialized; // 0x358(0x01)
