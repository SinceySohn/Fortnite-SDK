...
struct ACreativeDataChannelTarget : AElectraDataChannelTarget {
	...
	void TestCreativeDataChannelTarget(struct FCreativeDataChannelEvents TestEvents); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTarget.TestCreativeDataChannelTarget // (Final|Native|Public|BlueprintCallable) // @ game+0x67fee8c
	void OnRep_Events(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTarget.OnRep_Events // (Final|Native|Public) // @ game+0x258f6c0
	void FireEvent(struct FName EventName); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTarget.FireEvent // (Event|Public|BlueprintEvent) // @ game+0xdef49c
};
...
struct ACreativeDataChannelTargetRL : AElectraDataChannelTarget {
	...
	void ReportServerStateStreamError(struct FString Error, struct FString UID, struct FString URL); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.ReportServerStateStreamError // (Final|Native|Public|BlueprintCallable) // @ game+0x67feae8
	void OnRep_VersionByte(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_VersionByte // (Final|Native|Public) // @ game+0x67feab0
	void OnRep_TeamNames(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_TeamNames // (Final|Native|Public) // @ game+0x67fea34
	void OnRep_SeriesState(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_SeriesState // (Final|Native|Public) // @ game+0x67fe9fc
	void OnRep_ScoreTotal(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_ScoreTotal // (Final|Native|Public) // @ game+0x67fe998
	void OnRep_ScoreTeam(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_ScoreTeam // (Final|Native|Public) // @ game+0x67fe984
	void OnRep_ScoreboardTimeLeft(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_ScoreboardTimeLeft // (Final|Native|Public) // @ game+0x67fe9c0
	void OnRep_ScoreboardBestOf(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_ScoreboardBestOf // (Final|Native|Public) // @ game+0x67fe9ac
	void OnRep_PlayerNames(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_PlayerNames // (Final|Native|Public) // @ game+0x67fe970
	void OnRep_PlayerCoords(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_PlayerCoords // (Final|Native|Public) // @ game+0x67fe95c
	void OnRep_PlayerBoostCollected(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_PlayerBoostCollected // (Final|Native|Public) // @ game+0x67fe948
	void OnRep_PlayerBoost(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_PlayerBoost // (Final|Native|Public) // @ game+0x67fe934
	void OnRep_Overtime(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_Overtime // (Final|Native|Public) // @ game+0x67fe8fc
	void OnRep_MediaStop(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_MediaStop // (Final|Native|Public) // @ game+0x67fe8c4
	void OnRep_MediaStart(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_MediaStart // (Final|Native|Public) // @ game+0x67fe8b0
	void OnRep_MatchState(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_MatchState // (Final|Native|Public) // @ game+0x67fe878
	void OnRep_FinaleState(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_FinaleState // (Final|Native|Public) // @ game+0x67fe840
	void OnRep_BallCoords(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_BallCoords // (Final|Native|Public) // @ game+0x67fe82c
};
