...
struct UDynamicUITransitionableWidgetInterface : UInterface {
	...
	void BroadcastTransitionCompleted(); // Function DynamicUI.DynamicUITransitionableWidgetInterface.BroadcastTransitionCompleted // (Native|Protected|BlueprintCallable) // @ game+0x63f0ab4
};
...
struct ADynamicUIDirectorBase : AActor {
	...
	void RemoveScene(struct UDynamicUIScene* Scene); // Function DynamicUI.DynamicUIDirectorBase.RemoveScene // (Final|Native|Public|BlueprintCallable) // @ game+0x63f0b34
	struct APlayerController* GetOwningLocalPlayerController(); // Function DynamicUI.DynamicUIDirectorBase.GetOwningLocalPlayerController // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x29fe9a4
	struct ULocalPlayer* GetOwningLocalPlayer(); // Function DynamicUI.DynamicUIDirectorBase.GetOwningLocalPlayer // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x63f0ac8
	void AddScene(struct UDynamicUIScene* Scene); // Function DynamicUI.DynamicUIDirectorBase.AddScene // (Final|Native|Public|BlueprintCallable) // @ game+0x1b21db8
};
...
struct UDynamicUIManager : UWorldSubsystem {
	...
	void RemoveScenes(struct TArray<struct UDynamicUIScene*> Scenes, struct APlayerController*& Player); // Function DynamicUI.DynamicUIManager.RemoveScenes // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x63f1288
	void RemoveSceneFromFirstLocalPlayer(struct UDynamicUIScene* Scene); // Function DynamicUI.DynamicUIManager.RemoveSceneFromFirstLocalPlayer // (Final|Native|Protected|BlueprintCallable) // @ game+0x63f0f40
	void RemoveScene(struct UDynamicUIScene* Scene, struct APlayerController*& Player); // Function DynamicUI.DynamicUIManager.RemoveScene // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x63f0bb4
	void AddSceneToFirstLocalPlayer(struct UDynamicUIScene* Scene); // Function DynamicUI.DynamicUIManager.AddSceneToFirstLocalPlayer // (Final|Native|Protected|BlueprintCallable) // @ game+0x63f062c
	void AddScenes(struct TArray<struct UDynamicUIScene*> Scenes, struct APlayerController*& Player); // Function DynamicUI.DynamicUIManager.AddScenes // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x63f0984
	void AddScene(struct UDynamicUIScene* Scene, struct APlayerController*& Player); // Function DynamicUI.DynamicUIManager.AddScene // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x63f0290
};
...
struct UDynamicUISizeBase : UObject {
	...
	char bUseRenderTransform : 1; // 0x78(0x01)
...
struct UDynamicUISizeMatchWidget : UDynamicUISizeBase {
	struct FDynamicUIConstraintTarget TargetWidget; // 0x80(0x38)
	enum class EDynamicUISizeMatch MatchType; // 0xb8(0x04)
	char pad_BC[0x4]; // 0xbc(0x04)
	struct TArray<struct UDynamicUISizeBase*> Fallbacks; // 0xc0(0x10)
	char bUseFallbacks : 1; // 0xd0(0x01)
...
struct UDynamicUIVisualizerWidget : UUserWidget {
	struct TArray<struct UDynamicUIScene*> Scenes; // 0x268(0x10)
	bool bRefresh; // 0x278(0x01)
