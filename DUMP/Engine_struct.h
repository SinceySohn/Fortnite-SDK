...
struct FPostProcessSettings {
	...
	enum class ERayTracingGlobalIlluminationType RayTracingGIType; // 0x414(0x01)
	char pad_415[0x3]; // 0x415(0x03)
	int32_t RayTracingGIMaxBounces; // 0x418(0x04)
	int32_t RayTracingGISamplesPerPixel; // 0x41c(0x04)
	enum class EReflectionMethod ReflectionMethod; // 0x420(0x01)
	enum class EReflectionsType ReflectionsType; // 0x421(0x01)
	char pad_422[0x2]; // 0x422(0x02)
	float LumenReflectionQuality; // 0x424(0x04)
	enum class ELumenRayLightingModeOverride LumenRayLightingMode; // 0x428(0x01)
	char LumenFrontLayerTranslucencyReflections : 1; // 0x429(0x01)
	char pad_429_1 : 7; // 0x429(0x01)
	char pad_42A[0x2]; // 0x42a(0x02)
	float ScreenSpaceReflectionIntensity; // 0x42c(0x04)
	float ScreenSpaceReflectionQuality; // 0x430(0x04)
	float ScreenSpaceReflectionMaxRoughness; // 0x434(0x04)
	float RayTracingReflectionsMaxRoughness; // 0x438(0x04)
	int32_t RayTracingReflectionsMaxBounces; // 0x43c(0x04)
	int32_t RayTracingReflectionsSamplesPerPixel; // 0x440(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingReflectionsShadows; // 0x444(0x01)
	char RayTracingReflectionsTranslucency : 1; // 0x445(0x01)
	char pad_445_1 : 7; // 0x445(0x01)
	char pad_446[0x2]; // 0x446(0x02)
	struct FLinearColor AmbientCubemapTint; // 0x448(0x10)
	float AmbientCubemapIntensity; // 0x458(0x04)
	...
	float DepthOfFieldFocalDistance; // 0x61c(0x04)
	float DepthOfFieldDepthBlurAmount; // 0x620(0x04)
	float DepthOfFieldDepthBlurRadius; // 0x624(0x04)
	float DepthOfFieldFocalRegion; // 0x628(0x04)
	float DepthOfFieldNearTransitionRegion; // 0x62c(0x04)
	float DepthOfFieldFarTransitionRegion; // 0x630(0x04)
	float DepthOfFieldScale; // 0x634(0x04)
	float DepthOfFieldNearBlurSize; // 0x638(0x04)
	float DepthOfFieldFarBlurSize; // 0x63c(0x04)
	float DepthOfFieldOcclusion; // 0x640(0x04)
	float DepthOfFieldSkyFocusDistance; // 0x644(0x04)
	float DepthOfFieldVignetteSize; // 0x648(0x04)
	float MotionBlurAmount; // 0x64c(0x04)
	float MotionBlurMax; // 0x650(0x04)
	int32_t MotionBlurTargetFPS; // 0x654(0x04)
	float MotionBlurPerObjectSize; // 0x658(0x04)
	float LPVIntensity; // 0x65c(0x04)
	float LPVVplInjectionBias; // 0x660(0x04)
	float LPVSize; // 0x664(0x04)
	float LPVSecondaryOcclusionIntensity; // 0x668(0x04)
	float LPVSecondaryBounceIntensity; // 0x66c(0x04)
	float LPVGeometryVolumeBias; // 0x670(0x04)
	float LPVEmissiveInjectionIntensity; // 0x674(0x04)
	float LPVDirectionalOcclusionIntensity; // 0x678(0x04)
	float LPVDirectionalOcclusionRadius; // 0x67c(0x04)
	float LPVDiffuseOcclusionExponent; // 0x680(0x04)
	float LPVSpecularOcclusionExponent; // 0x684(0x04)
	float LPVDiffuseOcclusionIntensity; // 0x688(0x04)
	float LPVSpecularOcclusionIntensity; // 0x68c(0x04)
	enum class ETranslucencyType TranslucencyType; // 0x690(0x01)
	char pad_691[0x3]; // 0x691(0x03)
	float RayTracingTranslucencyMaxRoughness; // 0x694(0x04)
	int32_t RayTracingTranslucencyRefractionRays; // 0x698(0x04)
	int32_t RayTracingTranslucencySamplesPerPixel; // 0x69c(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingTranslucencyShadows; // 0x6a0(0x01)
	char RayTracingTranslucencyRefraction : 1; // 0x6a1(0x01)
	char pad_6A1_1 : 7; // 0x6a1(0x01)
	char pad_6A2[0x2]; // 0x6a2(0x02)
	int32_t PathTracingMaxBounces; // 0x6a4(0x04)
	int32_t PathTracingSamplesPerPixel; // 0x6a8(0x04)
	float PathTracingFilterWidth; // 0x6ac(0x04)
	char PathTracingEnableEmissive : 1; // 0x6b0(0x01)
	char pad_6B0_1 : 7; // 0x6b0(0x01)
	char pad_6B1[0x3]; // 0x6b1(0x03)
	float PathTracingMaxPathExposure; // 0x6b4(0x04)
	char PathTracingEnableReferenceDOF : 1; // 0x6b8(0x01)
	char PathTracingEnableReferenceAtmosphere : 1; // 0x6b8(0x01)
	char PathTracingEnableDenoiser : 1; // 0x6b8(0x01)
	char pad_6B8_3 : 5; // 0x6b8(0x01)
	char pad_6B9[0x3]; // 0x6b9(0x03)
	float LPVFadeRange; // 0x6bc(0x04)
	float LPVDirectionalOcclusionFadeRange; // 0x6c0(0x04)
	float ScreenPercentage; // 0x6c4(0x04)
	struct FWeightedBlendables WeightedBlendables; // 0x6c8(0x10)
...
struct FMaterialOverrideNanite {
	struct TSoftObjectPtr<UMaterialInterface> OverrideMaterialRef; // 0x00(0x28)
	bool bEnableOverride; // 0x28(0x01)
	char pad_29[0x7]; // 0x29(0x07)
	struct UMaterialInterface* OverrideMaterial; // 0x30(0x08)
};
...
// Size: 0x7e0 (Inherited: 0x00)
struct FTViewTarget {
	struct AActor* Target; // 0x00(0x08)
	char pad_8[0x8]; // 0x08(0x08)
	struct FMinimalViewInfo POV; // 0x10(0x7c0)
	struct APlayerState* PlayerState; // 0x7d0(0x08)
...
struct FHierarchicalSimplification {
	...
	char pad_A[0x2]; // 0x0a(0x02)
	struct FMeshProxySettings ProxySetting; // 0x0c(0xd0)
	struct FMeshMergingSettings MergeSetting; // 0xdc(0xd0)
	struct FMeshApproximationSettings ApproximateSettings; // 0x1ac(0x118)
	float DesiredBoundRadius; // 0x2c4(0x04)
	float DesiredFillingPercentage; // 0x2c8(0x04)
	int32_t MinNumberOfActorsToBuild; // 0x2cc(0x04)
};
...
struct FMeshMergingSettings {
	...
	char bSupportRayTracing : 1; // 0xad(0x01)
...
struct FMeshProxySettings {
	...
	char bSupportRayTracing : 1; // 0xb2(0x01)
	char bAllowDistanceField : 1; // 0xb3(0x01)
...
struct FActorDesc {
	...
	char pad_6E[0x2]; // 0x6e(0x02)
	struct FName ActorPackage; // 0x70(0x04)
	struct FName ActorPath; // 0x74(0x04)
};
