...
struct UFortAIComponent_Telemetry : UActorComponent {
	...
	void OnTetheredFollowerChanged(struct AFortPawn* NewFollower, struct AFortPawn* OldFollower); // Function FortniteAI.FortAIComponent_Telemetry.OnTetheredFollowerChanged // (Final|Native|Private) // @ game+0x9a5a1e8
	void OnPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIComponent_Telemetry.OnPawnDied // (Final|Native|Private|HasDefaults) // @ game+0x9a59464
	void OnDidDamage(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIComponent_Telemetry.OnDidDamage // (Final|Native|Private|HasDefaults) // @ game+0x9a590a8
	struct UFortAthenaAITelemetryData* GetOrCreateTelemetryData(struct UFortAthenaAITelemetryData* TelemetryDataClass); // Function FortniteAI.FortAIComponent_Telemetry.GetOrCreateTelemetryData // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9a57a34
};
...
struct AFortAIController : AAIController {
	...
	void WakeUp(); // Function FortniteAI.FortAIController.WakeUp // (Final|Native|Public|BlueprintCallable) // @ game+0x9a5b438
	void UnlockMovementResource(); // Function FortniteAI.FortAIController.UnlockMovementResource // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9a5b404
	void UnlockBehaviorResource(); // Function FortniteAI.FortAIController.UnlockBehaviorResource // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9a5b3d0
	void SetupCustomVIM(struct UObject* VIM); // Function FortniteAI.FortAIController.SetupCustomVIM // (Final|Native|Public|BlueprintCallable) // @ game+0x9a5b300
	void SetTeamInt(char InTeam); // Function FortniteAI.FortAIController.SetTeamInt // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9a5b200
	void SetTeam(enum class EFortTeam InTeam); // Function FortniteAI.FortAIController.SetTeam // (Final|Native|Public|BlueprintCallable) // @ game+0x9a5b200
	void SetPawnAIType(enum class EFortressAIType NewAIType, struct AActor* SpawnSpot); // Function FortniteAI.FortAIController.SetPawnAIType // (Final|Native|Public|BlueprintCallable) // @ game+0x9a5aec8
	void SetIsSleeping(bool bNewSleepStatus); // Function FortniteAI.FortAIController.SetIsSleeping // (Final|Native|Public|BlueprintCallable) // @ game+0x9a5adbc
	void SetGoalActor(struct AActor* InActor, bool bLocationAlwaysKnown); // Function FortniteAI.FortAIController.SetGoalActor // (Final|Native|Public|BlueprintCallable) // @ game+0x9a5acf4
	void SetFullPeripheralVision(bool bNewFullPeripheralVision); // Function FortniteAI.FortAIController.SetFullPeripheralVision // (Final|Native|Public|BlueprintCallable) // @ game+0x9a5ac64
	void SetAlwaysGameplayRelevant(bool bInAlwaysGameplayRelevant); // Function FortniteAI.FortAIController.SetAlwaysGameplayRelevant // (Final|Native|Public|BlueprintCallable) // @ game+0x9a5ab18
	void OnBuildingActorGoalDestroyed(); // Function FortniteAI.FortAIController.OnBuildingActorGoalDestroyed // (Final|Native|Public) // @ game+0x9a59090
	void OnActorGoalDestroyed(struct AActor* DestroyedActor); // Function FortniteAI.FortAIController.OnActorGoalDestroyed // (Final|Native|Public) // @ game+0x9a58d38
	void LockMovementResource(); // Function FortniteAI.FortAIController.LockMovementResource // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9a588d8
	void LockBehaviorResource(); // Function FortniteAI.FortAIController.LockBehaviorResource // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9a588a4
	bool IsIgnoringProximity(struct AFortAIController* FortAIController); // Function FortniteAI.FortAIController.IsIgnoringProximity // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x7a15950
	bool IsAllowedToSleep(); // Function FortniteAI.FortAIController.IsAllowedToSleep // (Final|Native|Public|BlueprintCallable) // @ game+0x9a58818
	void IgnoreProximityForDuration(float DurationToIgnore); // Function FortniteAI.FortAIController.IgnoreProximityForDuration // (RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9a58668
	struct AActor* GetGoalActor(); // Function FortniteAI.FortAIController.GetGoalActor // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7819a90
	struct UFortAIEncounterInfo* GetEncounterInfo(); // Function FortniteAI.FortAIController.GetEncounterInfo // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57748
	bool CreateBuildingActor(struct ABuildingSMActor* BuildingClass, struct FVector BuildLoc, struct FRotator BuildRot, bool bMirrored); // Function FortniteAI.FortAIController.CreateBuildingActor // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x9a5721c
	void ClearAllFocalPoints(); // Function FortniteAI.FortAIController.ClearAllFocalPoints // (Final|Native|Public|BlueprintCallable) // @ game+0x9a571bc
};
...
struct UAthenaAIServicePlayerBots : UAthenaAIService {
	...
	struct FName AugmentsRegistryName; // 0x560(0x04)
	...
	struct TSoftObjectPtr<UFortAthenaAIBotNameDataAsset> BotNameDataAsset; // 0x5b8(0x28)
	...
	float MaxAroundBotDistanceToSearchPOIToLand; // 0x6f8(0x04)
	...
	struct TSoftClassPtr<UObject> BackfillSpawnerData; // 0x7a0(0x28)
	...
	struct TArray<struct ABuildingFoundation*> CachedBuildingFoundations; // 0x7f8(0x10)
	struct TArray<struct FFortBotAugmentsDataTableRow> CachedSupportedAugments; // 0x808(0x10)
	char pad_818[0x150]; // 0x818(0x150)
	struct AFortPlayerStartWarmup* LastTeamPlayerStart; // 0x968(0x08)
	char pad_970[0x8]; // 0x970(0x08)
	struct TMap<int32_t, struct UCacheSafeZoneLocation*> CacheSafeZoneLocationsMap; // 0x978(0x50)
	float DeadBotCleanupMinDelay; // 0x9c8(0x04)
	char pad_9CC[0xc]; // 0x9cc(0x0c)
	struct TSet<struct FString> ReservedPlayerNames; // 0x9d8(0x50)
	char pad_A28[0x8]; // 0xa28(0x08)
	struct TArray<int32_t> LocationsInSafeZoneFreeIndices; // 0xa30(0x10)
	char pad_A40[0x50]; // 0xa40(0x50)
	struct AFortTeamInfoAthena* CurrentFillingTeam; // 0xa90(0x08)
	char pad_A98[0x58]; // 0xa98(0x58)
	struct FScalableFloat BotsUniqueIDUseValidAccountID; // 0xaf0(0x28)
	int32_t CurrentBotControllerUID; // 0xb18(0x04)
	char pad_B1C[0x4]; // 0xb1c(0x04)
	struct TArray<struct UFortAthenaBeaconComponent*> BeaconList; // 0xb20(0x10)
	char pad_B30_0 : 6; // 0xb30(0x01)
	char bWaitForNavmeshToBeLoaded : 1; // 0xb30(0x01)
	char bDoSpawnBotFlow : 1; // 0xb30(0x01)
	char bDoMapSampling : 1; // 0xb31(0x01)
	char pad_B31_1 : 7; // 0xb31(0x01)
	enum class EAthenaGamePhase GamePhaseToStartSpawning; // 0xb32(0x01)
	char pad_B33[0x5]; // 0xb33(0x05)
	struct UFortAthenaAISpawnerData* DefaultBotAISpawnerData; // 0xb38(0x08)
	char pad_B40[0x10]; // 0xb40(0x10)
	struct TSoftObjectPtr<UEnvQuery> EQSMapSampling; // 0xb50(0x28)
	char pad_B78[0x30]; // 0xb78(0x30)
	struct FScalableFloat CanReviveDownedSquad; // 0xba8(0x28)
	struct UAthenaAIPopulationTracker* CachedAIPopulationTracker; // 0xbd0(0x08)
	...
	char pad_BF8[0x88]; // 0xbf8(0x88)
	struct TSoftObjectPtr<UDataTable> MMRSpawnTable; // 0xc80(0x28)
	...
	char pad_D28[0xb8]; // 0xd28(0xb8)
	struct FScalableFloat OnlyPickPOIsInSafeZone; // 0xde0(0x28)
	char pad_E08[0x8]; // 0xe08(0x08)

	struct APawn* SpawnAI(struct FVector& InSpawnLocation, struct FRotator& InSpawnRotation, struct UFortAthenaAISpawnerDataComponentList* AISpawnerComponentList); // Function FortniteAI.AthenaAIServicePlayerBots.SpawnAI // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9c1d98c
	void OnServerGameMemberRemoved(char InSquadId, char InTeamIndex, struct AFortPlayerStateAthena* ChangedPS); // Function FortniteAI.AthenaAIServicePlayerBots.OnServerGameMemberRemoved // (Final|Native|Private) // @ game+0x9c1d218
	void OnSafeZoneUpdated(); // Function FortniteAI.AthenaAIServicePlayerBots.OnSafeZoneUpdated // (Final|Native|Private) // @ game+0x9c1d204
	void OnPlaylistDataReady(struct AFortGameStateAthena* GameState, struct UFortPlaylist* Playlist, struct FGameplayTagContainer& PlaylistContextTags); // Function FortniteAI.AthenaAIServicePlayerBots.OnPlaylistDataReady // (Final|Native|Protected|HasOutParms) // @ game+0x9c1d0d4
	void OnPawnSpawned(struct APawn* Pawn, int32_t RequestId, bool bIsRespawn); // Function FortniteAI.AthenaAIServicePlayerBots.OnPawnSpawned // (Final|Native|Private) // @ game+0x9c1ce24
	void OnGamePhaseChanged(enum class EAthenaGamePhase NewPhase); // Function FortniteAI.AthenaAIServicePlayerBots.OnGamePhaseChanged // (Native|Protected) // @ game+0x9c1c7a8
	void OnAgentGameOver(struct AFortAthenaAIBotController* AIBotController, struct AFortPawn* Pawn, struct AController* Instigator); // Function FortniteAI.AthenaAIServicePlayerBots.OnAgentGameOver // (Final|Native|Private) // @ game+0x9c1c32c
	void KillBots(bool bKillPlayers, bool bKillNoneParticipants, char TeamIndex, struct AActor* BotOwner); // Function FortniteAI.AthenaAIServicePlayerBots.KillBots // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9c1bf90
	void JoinTeam(struct AController* SourceTeamController, struct AController* DestinationTeamController); // Function FortniteAI.AthenaAIServicePlayerBots.JoinTeam // (Final|Native|Public|BlueprintCallable) // @ game+0x9c1bce4
	bool IsWeaponSupported(struct AFortWeapon* FortWeapon); // Function FortniteAI.AthenaAIServicePlayerBots.IsWeaponSupported // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9c1bbb4
	int32_t FetchNextCustomBotCosmeticVariantID(struct AFortPlayerPawnAthena* BotPawn); // Function FortniteAI.AthenaAIServicePlayerBots.FetchNextCustomBotCosmeticVariantID // (Final|Native|Public|BlueprintCallable) // @ game+0x9c1ae3c
};
...
struct UAthenaAIServiceCreativePlayerBots : UAthenaAIServicePlayerBots {
	...
	struct TWeakObjectPtr<struct AFortMinigame> CachedMinigame; // 0xe18(0x08)
	struct TMap<struct AActor*, struct APlayerController*> HiringHistory; // 0xe28(0x50)
	char pad_E78[0x8]; // 0xe78(0x08)

	void OnMinigameStateChanged(struct AFortMinigame* Minigame, enum class EFortMinigameState MinigameState); // Function FortniteAI.AthenaAIServiceCreativePlayerBots.OnMinigameStateChanged // (RequiredAPI|Native|Public) // @ game+0x9c1c90c
	bool IsMinigameBotSpawningRequired(); // Function FortniteAI.AthenaAIServiceCreativePlayerBots.IsMinigameBotSpawningRequired // (RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7ea98b8
	struct APlayerController* GetLastHiringPlayer(struct AActor* HiredOwner); // Function FortniteAI.AthenaAIServiceCreativePlayerBots.GetLastHiringPlayer // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1b25c
	void ClearHiringHistory(struct AActor* HiredOwner); // Function FortniteAI.AthenaAIServiceCreativePlayerBots.ClearHiringHistory // (Final|Native|Public|BlueprintCallable) // @ game+0x9c1adb8
	void AddHiringHistory(struct AActor* HiredOwner, struct APlayerController* HiringPlayer); // Function FortniteAI.AthenaAIServiceCreativePlayerBots.AddHiringHistory // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9c1aca0
};

// Class FortniteAI.FortAthenaAIBotController
// Size: 0x1270 (Inherited: 0x3b0)
struct AFortAthenaAIBotController : AAIController {
	...
	struct FFortAthenaLoadout CosmeticLoadoutBC; // 0x7f0(0x178)
	struct TArray<struct UCustomCharacterPart*> CustomCharacterPartOverridesBC; // 0x968(0x10)
	struct UFortBotNameSettings* NameSettingsBC; // 0x978(0x08)
	struct FScalableFloat SpectateOnDeathMinTime; // 0x980(0x28)
	struct FScalableFloat SpectateOnDeathMaxTime; // 0x9a8(0x28)
	struct FScalableFloat EmotesMaxCount; // 0x9d0(0x28)
	struct UFortAthenaAIBotPerceptionDigestedSkillSet* CachePerceptionDigestedSkillSet; // 0x9f8(0x08)
	struct UFortAthenaAIBotHarvestDigestedSkillSet* CacheHarvestDigestedSkillSet; // 0xa00(0x08)
	struct UFortAthenaAIBotMovementDigestedSkillSet* CacheMovementSkillSet; // 0xa08(0x08)
	struct UFortAthenaAIBotLootingDigestedSkillSet* CacheLootingSkillSet; // 0xa10(0x08)
	struct UFortAthenaAIBotAttackingDigestedSkillSet* CacheAttackingSkillSet; // 0xa18(0x08)
	struct UFortAthenaAIBotPlayStyleDigestedSkillSet* CachePlayStyleSkillSet; // 0xa20(0x08)
	struct UFortAthenaAIBotUnstuckDigestedSkillSet* CacheUnstuckSkillSet; // 0xa28(0x08)
	struct UFortAthenaAIBotRangeAttackDigestedSkillSet* CacheRangeAttackSkillSet; // 0xa30(0x08)
	char pad_A38[0x60]; // 0xa38(0x60)
	struct UFortInteractContextInfo* InteractContextInfo; // 0xa98(0x08)
	char pad_AA0[0x68]; // 0xaa0(0x68)
	struct UFortAthenaAIBotAimingDigestedSkillSet* CacheAimingDigestedSkillSet; // 0xb08(0x08)
	char pad_B10[0x4]; // 0xb10(0x04)
	char bCanBeDestroyedOnDeath : 1; // 0xb14(0x01)
	char pad_B14_1 : 7; // 0xb14(0x01)
	char pad_B15[0xb]; // 0xb15(0x0b)
	struct FVector LastDeathLocation; // 0xb20(0x18)
	struct FRotator LastDeathRotation; // 0xb38(0x18)
	struct UFortWorldItem* CachedWorldItem; // 0xb50(0x08)
	char pad_B58[0x8]; // 0xb58(0x08)
	struct AFortWeapon* CacheWeaponUsedToCalculateType; // 0xb60(0x08)
	bool bCachedIsUsingArcedProjectileWeapon; // 0xb68(0x01)
	char pad_B69[0x3]; // 0xb69(0x03)
	float CachedProjectileGravityScale; // 0xb6c(0x04)
	struct AFortWeapon* CachedWeaponUsedToCalculateProjectileData; // 0xb70(0x08)
	struct UStatManager* StatManager; // 0xb78(0x08)
	struct TArray<struct FBuildingWeakSpotData> ActiveWeakSpots; // 0xb80(0x10)
	char pad_B90[0x28]; // 0xb90(0x28)
	struct AFortPawn* CacheBotPawnClass; // 0xbb8(0x08)
	char pad_BC0[0x8]; // 0xbc0(0x08)
	struct AActor* CurrentLootActor; // 0xbc8(0x08)
	struct UAthenaMarkerComponent* MarkerComponent; // 0xbd0(0x08)
	struct FString BotPlayerName; // 0xbd8(0x10)
	struct FGameplayTag DescriptorTag; // 0xbe8(0x04)
	char pad_BEC[0x4]; // 0xbec(0x04)
	struct FString BotIDSuffix; // 0xbf0(0x10)
	struct FString BotPlayerNameWithSkillRating; // 0xc00(0x10)
	char pad_C10[0x10]; // 0xc10(0x10)
	struct UFortAthenaMutator_SpawningPolicyData* PolicyDataSpawner; // 0xc20(0x08)
	char pad_C28[0xd8]; // 0xc28(0xd8)
	struct UFortControllerComponent_Telemetry* FortControllerComponent_Telemetry; // 0xd00(0x08)
	bool bForceUsingBuildingTool; // 0xd08(0x01)
	bool bForceHolsterWeapon; // 0xd09(0x01)
	char pad_D0A[0x6]; // 0xd0a(0x06)
	struct UFortWorldItem* PendingEquipWeapon; // 0xd10(0x08)
	char pad_D18[0x48]; // 0xd18(0x48)
	struct APawn* PlayerToSpectateOnDeath; // 0xd60(0x08)
	struct FMulticastInlineDelegate OnPlayerPawnAISpawnedDelegate; // 0xd68(0x10)
	char pad_D78[0x108]; // 0xd78(0x108)
	struct UAISenseConfig_Sight* AISenseConfig_SightOverride; // 0xe80(0x08)
	char pad_E88[0x10]; // 0xe88(0x10)
	struct AActor* BotOwner; // 0xe98(0x08)
	int32_t BotControllerUID; // 0xea0(0x04)
	char pad_EA4[0x4]; // 0xea4(0x04)
	struct AFortPlayerPawnAthena* ReviveTarget; // 0xea8(0x08)
	char pad_EB0[0x90]; // 0xeb0(0x90)
	struct UFortAthenaAIBotCustomizationData* BotData; // 0xf40(0x08)
	char pad_F48[0x8]; // 0xf48(0x08)
	struct FDebugMinimapData DebugMinimapData; // 0xf50(0x1b0)
	struct AFortPlayerPawnAthena* RevivePlayerPawnToken; // 0x1100(0x08)
	char pad_1108[0x18]; // 0x1108(0x18)
	struct AActor* LeashActorToFollow; // 0x1120(0x08)
	struct FVector LeashActorToFollowLocalOffset; // 0x1128(0x18)
	struct AFortAthenaAILeashVolume* LeashVolume; // 0x1140(0x08)
	struct UFortGameStateComponent_AffiliationManager* CachedAffiliationManager; // 0x1148(0x08)
	struct UFortActorComponent_Affiliation* CachedAffiliationComponent; // 0x1150(0x08)
	bool bIsAffectedByMutatorHealthAndShieldModifiers; // 0x1158(0x01)
	char pad_1159[0x7]; // 0x1159(0x07)
	bool bHasChangedPawnCullDistanceToAggroMode; // 0x1160(0x01)
	char pad_1161[0x7]; // 0x1161(0x07)
	struct UFortAthenaAIRuntimeParameters_AIBotRespawn* RespawnRuntimeParameters; // 0x1168(0x08)
	struct ABuildingWall* CurrentBlockingDoor; // 0x1170(0x08)
	char pad_1178[0x10]; // 0x1178(0x10)
	struct APawn* FinisherPawn; // 0x1188(0x08)
	char pad_1190[0x54]; // 0x1190(0x54)
	enum class EFortPawnStasisMode PreviousStasisMode; // 0x11e4(0x01)
	bool bPostponeGiveWeaponCheat; // 0x11e5(0x01)
	bool bPostponeGiveMaterialsCheat; // 0x11e6(0x01)
	char pad_11E7[0x1]; // 0x11e7(0x01)
	float StartSpectatingTime; // 0x11e8(0x04)
	char pad_11EC[0x3c]; // 0x11ec(0x3c)
	struct UAthenaDanceItemDefinition* RequestedEmoteAsset; // 0x1228(0x08)
	char pad_1230[0x8]; // 0x1230(0x08)
	struct UBehaviorTree* BTAssetToRunOnPawnAISpawned; // 0x1238(0x08)
	char pad_1240[0x30]; // 0x1240(0x30)

	void UpdateLeashActorToFollowLocation(); // Function FortniteAI.FortAthenaAIBotController.UpdateLeashActorToFollowLocation // (Final|Native|Protected) // @ game+0x9abf0ac
	void ThankBusDriver(); // Function FortniteAI.FortAthenaAIBotController.ThankBusDriver // (Final|Native|Protected) // @ game+0x9abf098
	void SwitchTeam(char TeamIndex); // Function FortniteAI.FortAthenaAIBotController.SwitchTeam // (Final|Native|Public|BlueprintCallable) // @ game+0x9abee18
	void StopSecondaryFire(bool bFireWhenStopping); // Function FortniteAI.FortAthenaAIBotController.StopSecondaryFire // (Final|Native|Public|BlueprintCallable) // @ game+0x9abed44
	void StopFire(); // Function FortniteAI.FortAthenaAIBotController.StopFire // (Final|Native|Public|BlueprintCallable) // @ game+0x9abed30
	void StopEmote(); // Function FortniteAI.FortAthenaAIBotController.StopEmote // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abed1c
	void StartSecondaryFire(); // Function FortniteAI.FortAthenaAIBotController.StartSecondaryFire // (Final|Native|Public|BlueprintCallable) // @ game+0x9abec8c
	void StartFire(); // Function FortniteAI.FortAthenaAIBotController.StartFire // (Final|Native|Public|BlueprintCallable) // @ game+0x9abec78
	void SetSkillSet(struct UFortAthenaAIBotSkillSet* SkillSetClass); // Function FortniteAI.FortAthenaAIBotController.SetSkillSet // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abe784
	void SetRadialLeashOuterRadius(float OuterRadius); // Function FortniteAI.FortAthenaAIBotController.SetRadialLeashOuterRadius // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abe700
	void SetRadialLeashInnerRadius(float InnerRadius); // Function FortniteAI.FortAthenaAIBotController.SetRadialLeashInnerRadius // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abe67c
	void SetPatrollingEnable(bool bEnable); // Function FortniteAI.FortAthenaAIBotController.SetPatrollingEnable // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abe5fc
	void SetLeashVolume(struct AFortAthenaAILeashVolume* InLeashVolume); // Function FortniteAI.FortAthenaAIBotController.SetLeashVolume // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abe560
	void SetLeashReturnLocationMode(enum class ELeashReturnLocationMode ReturnMode); // Function FortniteAI.FortAthenaAIBotController.SetLeashReturnLocationMode // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abe4e4
	void SetLeashActorToFollow(struct AActor* ActorToFollow, float LeashLocationUpdateRate, struct FVector LocalOffset); // Function FortniteAI.FortAthenaAIBotController.SetLeashActorToFollow // (Final|BlueprintAuthorityOnly|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x9abe3d4
	void SetBotOwner(struct AActor* InBotOwner); // Function FortniteAI.FortAthenaAIBotController.SetBotOwner // (Final|Native|Public|BlueprintCallable) // @ game+0x9abdfec
	void RequestEmote(struct FPrimaryAssetId& EmotePrimaryAssetId, float InfiniteEmoteMaxDuration); // Function FortniteAI.FortAthenaAIBotController.RequestEmote // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9abde94
	void RemoveSkillSet(struct UFortAthenaAIBotSkillSet* SkillSetClass); // Function FortniteAI.FortAthenaAIBotController.RemoveSkillSet // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abdca4
	void RemoveEmoteRequest(); // Function FortniteAI.FortAthenaAIBotController.RemoveEmoteRequest // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abd940
	void ReleaseBuildTool(); // Function FortniteAI.FortAthenaAIBotController.ReleaseBuildTool // (Final|Native|Protected) // @ game+0x9abd92c
	void QueueStim(struct AActor* SourceActor, struct FVector& SourceLocation, struct FVector& SourceDirection, enum class EStimType NewStimType, float StimStrength, struct FName StimTag); // Function FortniteAI.FortAthenaAIBotController.QueueStim // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9abd738
	void PlayEmote(struct FPrimaryAssetId& EmotePrimaryAssetId); // Function FortniteAI.FortAthenaAIBotController.PlayEmote // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9abd688
	void OverrideSkill(float NewSkill); // Function FortniteAI.FortAthenaAIBotController.OverrideSkill // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abd604
	void OverrideAggressivenessPlayStyle(bool bInIsAggressive); // Function FortniteAI.FortAthenaAIBotController.OverrideAggressivenessPlayStyle // (Final|Native|Public|BlueprintCallable) // @ game+0x9abd578
	void OnTargetPawnDestroyed(); // Function FortniteAI.FortAthenaAIBotController.OnTargetPawnDestroyed // (Final|Native|Public) // @ game+0x9abd564
	void OnTargetPawnDead(struct AFortPawn* FortPawn); // Function FortniteAI.FortAthenaAIBotController.OnTargetPawnDead // (Final|Native|Public) // @ game+0x9abd4e4
	void OnTargetPawnDamaged(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnTargetPawnDamaged // (Final|Native|Public|HasDefaults) // @ game+0x9abd2c0
	void OnTargetBuildingDestroyed(struct ABuildingActor* Building, struct AAthenaAIController* AIController); // Function FortniteAI.FortAthenaAIBotController.OnTargetBuildingDestroyed // (Final|Native|Public) // @ game+0x9abd1fc
	void OnTargetActorDestroyed(struct AActor* DestroyedActor); // Function FortniteAI.FortAthenaAIBotController.OnTargetActorDestroyed // (Final|Native|Public) // @ game+0x9abd17c
	void OnServerMarkerAdded(struct FFortWorldMarkerData& MarkerData); // Function FortniteAI.FortAthenaAIBotController.OnServerMarkerAdded // (Final|Native|Public|HasOutParms) // @ game+0x9abd0c8
	void OnSafeZoneUpdated(); // Function FortniteAI.FortAthenaAIBotController.OnSafeZoneUpdated // (Final|Native|Public) // @ game+0x9abd034
	void OnSafezoneStateChanged(enum class EFortSafeZoneState NewState); // Function FortniteAI.FortAthenaAIBotController.OnSafezoneStateChanged // (Final|Native|Public) // @ game+0x9abd048
	void OnPossessedPawnReceiveDamage(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnPossessedPawnReceiveDamage // (Final|Native|Public|HasDefaults) // @ game+0x9abcd38
	void OnPossesedPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnPossesedPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x9abcb04
	void OnPerceptionSensed(struct AActor* SourceActor, struct FAIStimulus Stim); // Function FortniteAI.FortAthenaAIBotController.OnPerceptionSensed // (Native|Public) // @ game+0x9abca14
	void OnPawnWeaponChanged(struct AFortWeapon* NewWeapon, struct AFortWeapon* OldWeapon); // Function FortniteAI.FortAthenaAIBotController.OnPawnWeaponChanged // (Final|Native|Public) // @ game+0x9abc950
	void OnPawnDidDamage(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* HitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnPawnDidDamage // (Final|Native|Public|HasDefaults) // @ game+0x9abc6d4
	void OnMovementModeChange(struct ACharacter* InCharacter, enum class EMovementMode PrevMovementMode, char PreviousCustomMode); // Function FortniteAI.FortAthenaAIBotController.OnMovementModeChange // (Final|Native|Public) // @ game+0x9abc58c
	void OnLaunched(struct FVector LaunchVelocity, bool bXYOverride, bool bZOverride); // Function FortniteAI.FortAthenaAIBotController.OnLaunched // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x9abc470
	void OnKnockbacked(struct FGameplayTag KnockbackTypeTag); // Function FortniteAI.FortAthenaAIBotController.OnKnockbacked // (Final|Native|Public|BlueprintCallable) // @ game+0x9abc3f0
	void OnGamePhaseStepChanged(struct TScriptInterface<IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep); // Function FortniteAI.FortAthenaAIBotController.OnGamePhaseStepChanged // (Final|Native|Public|HasOutParms) // @ game+0x9abc310
	void OnGamePhaseChanged(enum class EAthenaGamePhase GamePhase); // Function FortniteAI.FortAthenaAIBotController.OnGamePhaseChanged // (Final|Native|Public) // @ game+0x9abc290
	void OnEndSpectating(struct AFortPlayerStateZone* Spectator); // Function FortniteAI.FortAthenaAIBotController.OnEndSpectating // (Final|Native|Public) // @ game+0x6537ae4
	void OnCurrentHarvestableDestroyed(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnCurrentHarvestableDestroyed // (Final|Native|Protected|HasDefaults) // @ game+0x9abc064
	void OnBeginSpectating(struct AFortPlayerStateZone* Spectator); // Function FortniteAI.FortAthenaAIBotController.OnBeginSpectating // (Final|Native|Public) // @ game+0x6537ae4
	void OnAlertLevelChanged(enum class EAlertLevel OldAlertLevel, enum class EAlertLevel NewAlertLevel); // Function FortniteAI.FortAthenaAIBotController.OnAlertLevelChanged // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnAgentDBNO(struct AFortPawn* InPlayer, bool bInIsDBNO); // Function FortniteAI.FortAthenaAIBotController.OnAgentDBNO // (Final|Native|Public) // @ game+0x9abbf9c
	void NotifyPickupsSpawnedOnDeath(struct TArray<struct AFortPickup*>& SpawnedPickups); // Function FortniteAI.FortAthenaAIBotController.NotifyPickupsSpawnedOnDeath // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x65c7a20
	bool IsAnAthenaGameParticipant(); // Function FortniteAI.FortAthenaAIBotController.IsAnAthenaGameParticipant // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9ababac
	struct UAthenaMarkerComponent* GetMarkerComponent(); // Function FortniteAI.FortAthenaAIBotController.GetMarkerComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9abaa2c
	struct AActor* GetCurrentThreat(); // Function FortniteAI.FortAthenaAIBotController.GetCurrentThreat // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9aba964
	struct AActor* GetBotOwner(); // Function FortniteAI.FortAthenaAIBotController.GetBotOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9aba94c
	struct AFortWeapon* EquipWeaponByTag(struct FGameplayTag& WeaponTag); // Function FortniteAI.FortAthenaAIBotController.EquipWeaponByTag // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9aba7c4
	struct AFortWeapon* EquipWeapon(struct UFortWorldItem* Weapon); // Function FortniteAI.FortAthenaAIBotController.EquipWeapon // (Final|Native|Public|BlueprintCallable) // @ game+0x9aba734
	struct AFortWeapon* EquipMeleeWeapon(); // Function FortniteAI.FortAthenaAIBotController.EquipMeleeWeapon // (Final|Native|Public|BlueprintCallable) // @ game+0x9aba69c
	struct AFortWeapon* EquipBestWeapon(); // Function FortniteAI.FortAthenaAIBotController.EquipBestWeapon // (Final|Native|Public|BlueprintCallable) // @ game+0x9aba678
	...
	void Cheat_ClearForcedCosmeticItems(); // Function FortniteAI.FortAthenaAIBotController.Cheat_ClearForcedCosmeticItems // (Net|NetReliableNative|Event|Public|NetServer|NetValidate) // @ game+0x9aba120
	void ChangeActiveVariantForCosmeticItem(struct FName ItemTemplateToChange, struct FGameplayTag VariantChannelToChange, struct FGameplayTag DesiredActiveVariant); // Function FortniteAI.FortAthenaAIBotController.ChangeActiveVariantForCosmeticItem // (BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9aba028
	void BlueprintOnBehaviorTreeStarted(); // Function FortniteAI.FortAthenaAIBotController.BlueprintOnBehaviorTreeStarted // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void AddTargetInfos(struct TArray<struct AActor*>& Targets, enum class EPerceptionState PerceptionState, float ForgetTime, float ForgetDistance); // Function FortniteAI.FortAthenaAIBotController.AddTargetInfos // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9ab9df0
	void AddTargetInfo(struct AActor* Target, bool bForceTarget, enum class EPerceptionState PerceptionState, float ForgetTime, float ForgetDistance); // Function FortniteAI.FortAthenaAIBotController.AddTargetInfo // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9ab9c58
};
...
struct UFortNavModifierComponent : UNavModifierComponent {
	...
	void SetComponentAffectingNavMesh(struct UPrimitiveComponent* InComponentAffectingNavMesh); // Function FortniteAI.FortNavModifierComponent.SetComponentAffectingNavMesh // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9b5bda4
};
...
struct UFortPhysicsObjectNavigationComponent : UFortNavModifierComponent {
	...
	void OnSleepStateChanged(struct UPrimitiveComponent* SimulatingComponent, bool bIsAwake); // Function FortniteAI.FortPhysicsObjectNavigationComponent.OnSleepStateChanged // (Final|RequiredAPI|Native|Protected) // @ game+0x9b5bc10
};
...
struct UFortAIEnvironmentalDangerSourceInterface : UInterface {
	...
	struct FBox GetDangerSourceBounds(); // Function FortniteAI.FortAIEnvironmentalDangerSourceInterface.GetDangerSourceBounds // (Native|Event|Public|HasDefaults|BlueprintEvent|Const) // @ game+0x9a3b354
	bool GetDangerSourceActive(); // Function FortniteAI.FortAIEnvironmentalDangerSourceInterface.GetDangerSourceActive // (Native|Event|Public|BlueprintEvent|Const) // @ game+0x73991b8
	float GetDangerAtLocation(struct FVector& Location); // Function FortniteAI.FortAIEnvironmentalDangerSourceInterface.GetDangerAtLocation // (Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent|Const) // @ game+0x9a3b2bc
};
...
struct UFortAthenaAIBotCharacterCustomization : UObject {
	struct FFortAthenaLoadout CustomizationLoadout; // 0x28(0x178)
};
...
struct UFortAthenaAIBotEvaluator_Movement : UFortAthenaAIBotEvaluator {
	...
	void OnCurrentUnstuckSteeringAttemptFinished(enum class EBotUnstuckSteeringReason UnstuckSteeringReason); // Function FortniteAI.FortAthenaAIBotEvaluator_Movement.OnCurrentUnstuckSteeringAttemptFinished // (Final|Native|Private) // @ game+0x9bb1a04
	void EvaluateIsolatedIslandSteering(); // Function FortniteAI.FortAthenaAIBotEvaluator_Movement.EvaluateIsolatedIslandSteering // (Final|Native|Private) // @ game+0x9bb18c4
};

// Class FortniteAI.FortAthenaAIBotEvaluator_Flee
// Size: 0x248 (Inherited: 0x218)
struct UFortAthenaAIBotEvaluator_Flee : UFortAthenaAIBotEvaluator_Movement {
	float MinDistanceFromTarget; // 0x218(0x04)
	float MinValidDistanceForFleeLocation; // 0x21c(0x04)
	float FleeDistance; // 0x220(0x04)
	float MaxDistanceFromTargetWhenFleeing; // 0x224(0x04)
	float MinDistanceHysteresisWhenChangingTarget; // 0x228(0x04)
	struct FName FleeKeyName; // 0x22c(0x04)
	struct FName FleeMovementStateKeyName; // 0x230(0x04)
	struct FName FleeDestinationKeyName; // 0x234(0x04)
	struct FName FleeActorKeyName; // 0x238(0x04)
	char pad_23C[0x4]; // 0x23c(0x04)
	struct AActor* CurrentActorFleeingFrom; // 0x240(0x08)
};

// Class FortniteAI.FortAthenaAIBotEvaluator_WeaponSelection
// Size: 0xb8 (Inherited: 0x88)
struct UFortAthenaAIBotEvaluator_WeaponSelection : UFortAthenaAIBotEvaluator {
	struct FName ThrowableAttackIsReadyToThrowName; // 0x88(0x04)
	struct FName WeaponKeyName; // 0x8c(0x04)
	struct FName TargetActorName; // 0x90(0x04)
	char pad_94[0xc]; // 0x94(0x0c)
	struct UFortAthenaAIBotRangeAttackDigestedSkillSet* CacheRangeAttackDigestedSkillSet; // 0xa0(0x08)
	struct UFortAthenaAIBotAttackingDigestedSkillSet* CacheAttackingDigestedSkillSet; // 0xa8(0x08)
	struct UFortAthenaAIBotAimingDigestedSkillSet* CacheAimingDigestedSkillSet; // 0xb0(0x08)
};
...
struct UFortAthenaAISpawnerDataComponent_ConstructionBase : UFortAthenaAISpawnerDataComponent {
	...
	bool GetConstructionBuildingInfo(struct FConstructionBuildingList& OutConstructionInfoList); // Function FortniteAI.FortAthenaAISpawnerDataComponent_ConstructionBase.GetConstructionBuildingInfo // (Native|Event|Public|HasOutParms|BlueprintEvent|Const) // @ game+0x9bda810
};
...
struct UFortAthenaAISpawnerDataComponent_BehaviorBase : UFortAthenaAISpawnerDataComponent {
	...
	struct UBehaviorTree* GetBehaviorTree(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_BehaviorBase.GetBehaviorTree // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x9bda70c
};
...
struct UFortAthenaAISpawnerDataComponent_LODBase : UFortAthenaAISpawnerDataComponent {
	...
	struct FClientAILODSettings GetClientAILODSettings(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_LODBase.GetClientAILODSettings // (RequiredAPI|Native|Event|Public|BlueprintEvent|Const) // @ game+0x9bda7b0
	struct UFortAthenaAILODSettingsContainer* GetAILODSettingsContainer(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_LODBase.GetAILODSettingsContainer // (Native|Event|Public|BlueprintEvent|Const) // @ game+0x2325e40
};
...
struct UFortAthenaAISpawnerDataComponent_SkillsetBase : UFortAthenaAISpawnerDataComponent {
	...
	bool ShouldUseMatchMMRToOverrideSkillLevel(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SkillsetBase.ShouldUseMatchMMRToOverrideSkillLevel // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x7ea98e0
	struct TArray<struct UFortAthenaAIBotSkillSet*> GetSkillSets(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SkillsetBase.GetSkillSets // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x9bdb3cc
	float GetSkill(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SkillsetBase.GetSkill // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x9bdae40
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotSkillset : UFortAthenaAISpawnerDataComponent_SkillsetBase {
	...
	void SetSkill(float InSKill); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotSkillset.SetSkill // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdc63c
};
...
struct UFortAthenaAISpawnerData : UFortAthenaSpawnerDataBase {
	...
	struct UFortAthenaAISpawnerDataComponent_VoiceBase* GetVoiceComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetVoiceComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdb6d8
	struct UFortAthenaAISpawnerDataComponent_SpawnParamsBase* GetSpawnParamsComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetSpawnParamsComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdb480
	struct UFortAthenaAISpawnerDataComponent_SmartObjectBase* GetSmartObjectComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetSmartObjectComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdb444
	struct UFortAthenaAISpawnerDataComponent_ScriptBase* GetScriptComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetScriptComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdb354
	struct UFortAthenaAISpawnerDataComponent_PerceptionBase* GetPerceptionComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetPerceptionComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdb2dc
	struct UFortAthenaAISpawnerDataComponent_OptimBase* GetOptimizationComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetOptimizationComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdb178
	struct UFortAthenaAISpawnerDataComponent_InventoryBase* GetInventoryComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetInventoryComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdafac
	struct UFortAthenaAISpawnerDataComponent_GroupBase* GetGroupComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetGroupComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdadd8
	struct UFortAthenaAISpawnerDataComponent_GameplayBase* GetGameplayComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetGameplayComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdad70
	struct UFortAthenaAISpawnerDataComponent_GameplayAbilityBase* GetGameplayAbilityComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetGameplayAbilityComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdad34
	struct UFortAthenaAISpawnerDataComponent_DebugBase* GetDebugComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetDebugComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdac24
	struct UFortAthenaAISpawnerDataComponent_CosmeticBase* GetCosmeticComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetCosmeticComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bda95c
	struct UFortAthenaAISpawnerDataComponent_ConversationBase* GetConversationComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetConversationComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bda920
	struct UFortAthenaAISpawnerDataComponent_ChanceEncounterBase* GetChanceEncounterComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetChanceEncounterComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bda75c
	struct UFortAthenaAISpawnerDataComponent_BehaviorBase* GetBehaviorComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetBehaviorComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bda6d4
	struct UFortAthenaAISpawnerDataComponent_AnalyticBase* GetAnalyticComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetAnalyticComponent // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2b63830
	struct UFortAthenaAISpawnerDataComponent_LODBase* GetAILODComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetAILODComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bda4cc
	struct UFortAthenaAISpawnerDataComponent_AffiliationBase* GetAffiliationComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetAffiliationComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bda504
	struct UFortAthenaAISpawnerDataComponentList* CreateComponentListFromClass(struct UFortAthenaAISpawnerData* AISpawnerDataClass, struct UObject* OuterObject); // Function FortniteAI.FortAthenaAISpawnerData.CreateComponentListFromClass // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable) // @ game+0x9bda180
	struct UFortAthenaAISpawnerDataComponentList* CreateComponentList(struct UObject* OuterObject); // Function FortniteAI.FortAthenaAISpawnerData.CreateComponentList // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bda0f0
};
...
struct UFortAthenaAIBotSpawnerData : UFortAthenaAISpawnerData {
	...
	struct UFortAthenaAISpawnerDataComponent_VehicleBase* GetVehicleComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetVehicleComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdb69c
	struct UFortAthenaAISpawnerDataComponent_SkillsetBase* GetSkillSetComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetSkillSetComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdb390
	struct UFortAthenaAISpawnerDataComponent_PerksBase* GetPerksComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetPerksComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdb318
	struct UFortAthenaAISpawnerDataComponent_CoverBase* GetCoverComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetCoverComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bda998
	struct UFortAthenaAISpawnerDataComponent_ConstructionBase* GetConstructionComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetConstructionComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bda8e4
};
...
struct AAIHotSpot : AActor {
	...
	void SetEnabled(bool bEnabled); // Function FortniteAI.AIHotSpot.SetEnabled // (Native|Public|BlueprintCallable) // @ game+0x801f950
	int32_t RemoveGroupFromHotspot(struct TArray<struct AAIController*> GroupOfAI); // Function FortniteAI.AIHotSpot.RemoveGroupFromHotspot // (Native|Public|BlueprintCallable) // @ game+0x9a5a848
	bool RemoveFromHotspot(struct AAIController* AI, bool bAssignFromWaitingList); // Function FortniteAI.AIHotSpot.RemoveFromHotspot // (Native|Public|BlueprintCallable) // @ game+0x9a5a77c
	void OnSlotOccupied(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotOccupied // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x9a5a0ec
	void OnSlotFreed(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotFreed // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x9a59ff0
	void OnSlotEnabled(int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotEnabled // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x9a59f2c
	void OnSlotDisabled(int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotDisabled // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x9a59e68
	void OnSlotClaimed(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotClaimed // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x9a59d6c
	void OnSlotBlocked(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotBlocked // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x9a59c70
	void OnRemovedSlotlessBehavior(struct AAIController* AI, bool bIsClamingSlot); // Function FortniteAI.AIHotSpot.OnRemovedSlotlessBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x9a59ba4
	void OnRemovedBehavior(struct AAIController* AI, int32_t Index, int32_t UserId, enum class EAIHotSpotSlot PrevState, bool bWasOnWaitingList); // Function FortniteAI.AIHotSpot.OnRemovedBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x9a59a20
	void OnMoveToSlotFinished(struct AAIController* AI, int32_t Index, int32_t UserId, bool bResult); // Function FortniteAI.AIHotSpot.OnMoveToSlotFinished // (BlueprintAuthorityOnly|Native|Event|Protected|BlueprintEvent) // @ game+0x9a59324
	void OnHotSpotEnabled(); // Function FortniteAI.AIHotSpot.OnHotSpotEnabled // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x1639298
	void OnHotSpotDisabled(); // Function FortniteAI.AIHotSpot.OnHotSpotDisabled // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x1cf4608
	bool OnAssignedSlotlessBehavior(struct AAIController* AI); // Function FortniteAI.AIHotSpot.OnAssignedSlotlessBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x9a58ffc
	bool OnAssignedOccupiedBehavior(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnAssignedOccupiedBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x9a58efc
	bool OnAssignedClaimedBehavior(struct AAIController* AI, int32_t Index, int32_t UserId, bool bWasOnWaitingList); // Function FortniteAI.AIHotSpot.OnAssignedClaimedBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x9a58db8
	bool OccupySlotByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.OccupySlotByIndex // (Native|Public|BlueprintCallable) // @ game+0x7e2a890
	bool IsSlotlessAssignmentAllowed(); // Function FortniteAI.AIHotSpot.IsSlotlessAssignmentAllowed // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a58888
	bool IsEnabled(); // Function FortniteAI.AIHotSpot.IsEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a58850
	bool IsAIAllowed(struct AAIController* AI); // Function FortniteAI.AIHotSpot.IsAIAllowed // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent|Const) // @ game+0x9a586f0
	bool HasEnabledSlots(); // Function FortniteAI.AIHotSpot.HasEnabledSlots // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a58628
	bool HasAssignedAI(struct AAIController* AI, enum class EAIHotSpotAssignmentFilter Filter); // Function FortniteAI.AIHotSpot.HasAssignedAI // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a58564
	int32_t GetSlotUserIdByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotUserIdByIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a58108
	enum class EAIHotSpotSlot GetSlotStateByOwner(struct AAIController* AIOwner); // Function FortniteAI.AIHotSpot.GetSlotStateByOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a58050
	enum class EAIHotSpotSlot GetSlotStateByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotStateByIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57fbc
	struct FRotator GetSlotRotationByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotRotationByIndex // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57f04
	struct AAIController* GetSlotOwnerByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotOwnerByIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57e18
	struct FVector GetSlotLocationByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotLocationByIndex // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57d78
	int32_t GetSlotIndexByOwner(struct AAIController* AIOwner); // Function FortniteAI.AIHotSpot.GetSlotIndexByOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57cc0
	int32_t GetSlotCount(enum class EAIHotSpotSlotFilter Filter); // Function FortniteAI.AIHotSpot.GetSlotCount // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57c34
	struct UAIHotSpotSlot* GetSlotByOwner(struct AAIController* AIOwner); // Function FortniteAI.AIHotSpot.GetSlotByOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57b98
	struct UAIHotSpotSlot* GetSlotByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotByIndex // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57b0c
	int32_t GetAssignedAICount(enum class EAIHotSpotAssignmentFilter Filter); // Function FortniteAI.AIHotSpot.GetAssignedAICount // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a576bc
	struct TArray<struct AAIController*> GetAssignedAI(enum class EAIHotSpotAssignmentFilter Filter); // Function FortniteAI.AIHotSpot.GetAssignedAI // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a575f0
	struct TArray<int32_t> FindBestSlotIndices(struct TArray<struct AAIController*> AI); // Function FortniteAI.AIHotSpot.FindBestSlotIndices // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57424
	int32_t FindBestSlotIndex(struct AAIController* AI); // Function FortniteAI.AIHotSpot.FindBestSlotIndex // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57390
	bool CanUseSlotByIndex(struct AAIController* AI, int32_t Index); // Function FortniteAI.AIHotSpot.CanUseSlotByIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a570f8
	bool AssignToSlotByIndex(struct AAIController* AI, int32_t Index); // Function FortniteAI.AIHotSpot.AssignToSlotByIndex // (Native|Public|BlueprintCallable) // @ game+0x9a57030
	bool AssignToHotspot(struct AAIController* AI); // Function FortniteAI.AIHotSpot.AssignToHotspot // (Native|Public|BlueprintCallable) // @ game+0x9359e04
	int32_t AssignGroupToHotspot(struct TArray<struct AAIController*> GroupOfAI); // Function FortniteAI.AIHotSpot.AssignGroupToHotspot // (Native|Public|BlueprintCallable) // @ game+0x9a56e80
	void AssignFromWaitingList(); // Function FortniteAI.AIHotSpot.AssignFromWaitingList // (Final|Native|Public|BlueprintCallable) // @ game+0x9a56e6c
};
...
struct UAIHotSpotSlot : UObject {
	...
	void SetSlotState(enum class EAIHotSpotSlot NewState); // Function FortniteAI.AIHotSpotSlot.SetSlotState // (Native|Public|BlueprintCallable) // @ game+0x9a5b17c
	void SetSlotOwnerAndState(struct AAIController* NewOwner, enum class EAIHotSpotSlot NewState); // Function FortniteAI.AIHotSpotSlot.SetSlotOwnerAndState // (Native|Public|BlueprintCallable) // @ game+0x9a5b0b4
	void SetSlotEnabled(bool bNewEnabled); // Function FortniteAI.AIHotSpotSlot.SetSlotEnabled // (Native|Public|BlueprintCallable) // @ game+0x9a5b030
	void OnStateChanged(struct AAIController* SlotOwner, enum class EAIHotSpotSlot NewState); // Function FortniteAI.AIHotSpotSlot.OnStateChanged // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xdef49c
	bool IsEnabled(); // Function FortniteAI.AIHotSpotSlot.IsEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a5886c
	bool IsAIAllowed(struct AAIController* AI); // Function FortniteAI.AIHotSpotSlot.IsAIAllowed // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent|Const) // @ game+0x9a58784
	bool HasUserId(); // Function FortniteAI.AIHotSpotSlot.HasUserId // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a5864c
	int32_t GetSlotUserId(); // Function FortniteAI.AIHotSpotSlot.GetSlotUserId // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a580f0
	enum class EAIHotSpotSlot GetSlotState(); // Function FortniteAI.AIHotSpotSlot.GetSlotState // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57fa4
	struct FRotator GetSlotRotation(); // Function FortniteAI.AIHotSpotSlot.GetSlotRotation // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57ecc
	float GetSlotRadius(); // Function FortniteAI.AIHotSpotSlot.GetSlotRadius // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57eb4
	struct AAIController* GetSlotOwner(); // Function FortniteAI.AIHotSpotSlot.GetSlotOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6af50fc
	struct FVector GetSlotLocation(); // Function FortniteAI.AIHotSpotSlot.GetSlotLocation // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57d50
	int32_t GetSlotIndex(); // Function FortniteAI.AIHotSpotSlot.GetSlotIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2a726dc
	float GetSlotHeight(); // Function FortniteAI.AIHotSpotSlot.GetSlotHeight // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x69233d4
	struct FBox GetSlotBounds(); // Function FortniteAI.AIHotSpotSlot.GetSlotBounds // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57ac4
	struct AAIHotSpot* GetHotSpot(); // Function FortniteAI.AIHotSpotSlot.GetHotSpot // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57774
	void ClearSlot(); // Function FortniteAI.AIHotSpotSlot.ClearSlot // (Native|Public|BlueprintCallable) // @ game+0x5d51564
};
...
struct AFortAIDirector : AActor {
	...
	void UnregisterPatrolWard(struct TScriptInterface<IFortPatrolWardInterface> PatrolWard); // Function FortniteAI.FortAIDirector.UnregisterPatrolWard // (Final|Native|Public|BlueprintCallable) // @ game+0x9a817d4
	struct UFortAIEncounterInfo* StartEncounter(struct FString& EncounterInstigator, struct UFortDifficultyEncounterSettings* DifficultyEncounterSettings, struct FFortAIEncounterQueryData OptionalQueryData); // Function FortniteAI.FortAIDirector.StartEncounter // (Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9a8127c
	void RegisterPatrolWard(struct TScriptInterface<IFortPatrolWardInterface> PatrolWard); // Function FortniteAI.FortAIDirector.RegisterPatrolWard // (Final|Native|Public|BlueprintCallable) // @ game+0x9a80c08
	void ReceivePawnSpawned(struct AFortPawn* SpawnedPawn); // Function FortniteAI.FortAIDirector.ReceivePawnSpawned // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xdef49c
	void PostDayPhaseChanged(enum class EFortDayPhase CurrentDayPhase, enum class EFortDayPhase PreviousDayPhase, bool bAtCreation); // Function FortniteAI.FortAIDirector.PostDayPhaseChanged // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnRestStarted(); // Function FortniteAI.FortAIDirector.OnRestStarted // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnRampStarted(); // Function FortniteAI.FortAIDirector.OnRampStarted // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnPlayerSpawn(struct AFortPlayerPawn* PlayerPawn); // Function FortniteAI.FortAIDirector.OnPlayerSpawn // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnPlayerDied(struct AFortPlayerPawn* PlayerPawn); // Function FortniteAI.FortAIDirector.OnPlayerDied // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnPeakStarted(); // Function FortniteAI.FortAIDirector.OnPeakStarted // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnPawnDied(struct AFortAIPawn* KilledPawn); // Function FortniteAI.FortAIDirector.OnPawnDied // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnFadeStarted(); // Function FortniteAI.FortAIDirector.OnFadeStarted // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnDirectorDeactivated(); // Function FortniteAI.FortAIDirector.OnDirectorDeactivated // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnDayPhaseChanged(enum class EFortDayPhase CurrentDayPhase, enum class EFortDayPhase PreviousDayPhase, bool bAtCreation); // Function FortniteAI.FortAIDirector.OnDayPhaseChanged // (Native|Public) // @ game+0x9a8057c
	bool IsPointTooCloseToPatrolWards(struct FVector& Point, enum class EWardAffectType WardEffectTypeFilter); // Function FortniteAI.FortAIDirector.IsPointTooCloseToPatrolWards // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a80224
	bool IsLineTooCloseToPatrolWards(struct FVector& LineStart, struct FVector& LineEnd); // Function FortniteAI.FortAIDirector.IsLineTooCloseToPatrolWards // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a80134
	bool IsAnyEncounterGoalWithinDistanceOfPoint(struct FVector& Point, float Distance, bool bOnlyActiveEncounters); // Function FortniteAI.FortAIDirector.IsAnyEncounterGoalWithinDistanceOfPoint // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a8002c
	bool IsAnyAIRelevantToPlayer(struct AFortPlayerPawn* Player); // Function FortniteAI.FortAIDirector.IsAnyAIRelevantToPlayer // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a7f8ec
	bool IsAnyActiveEncounterRelevantToPlayer(struct AFortPlayerPawn* Player); // Function FortniteAI.FortAIDirector.IsAnyActiveEncounterRelevantToPlayer // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a7ff88
	bool IsAnyActiveEncounterRelevantToDefender(struct AFortAIPawn* Defender); // Function FortniteAI.FortAIDirector.IsAnyActiveEncounterRelevantToDefender // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a7fee4
	struct FVector GetVectorFromEncounterDirection(enum class EFortEncounterDirection Direction); // Function FortniteAI.FortAIDirector.GetVectorFromEncounterDirection // (Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x9a7f75c
	struct TArray<struct ABuildingRift*> GetRiftsFromClosestActiveEncounterTo(struct AActor* Target); // Function FortniteAI.FortAIDirector.GetRiftsFromClosestActiveEncounterTo // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a7f534
	int32_t GetNumPlayers(); // Function FortniteAI.FortAIDirector.GetNumPlayers // (BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7f6b5b8
	int32_t GetNumActiveEncounters(); // Function FortniteAI.FortAIDirector.GetNumActiveEncounters // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x7bab60c
	enum class EFortEncounterDirection GetEncounterDirectionFromVector(struct FVector DirectionVector); // Function FortniteAI.FortAIDirector.GetEncounterDirectionFromVector // (Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x9a7f1ec
	void GetAmbientThreatEncounterSpawnLocations(struct TArray<struct FVector>& AmbientThreatEncounterSpawnLocations); // Function FortniteAI.FortAIDirector.GetAmbientThreatEncounterSpawnLocations // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a7efb8
	void Deactivate(); // Function FortniteAI.FortAIDirector.Deactivate // (BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x1639298
	struct TArray<enum class EFortEncounterDirection> ConvertInvalidDirectionsToValidDirections(struct TArray<enum class EFortEncounterDirection> InvalidDirections); // Function FortniteAI.FortAIDirector.ConvertInvalidDirectionsToValidDirections // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x9a7ec00
	void Activate(); // Function FortniteAI.FortAIDirector.Activate // (BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x234515c
};
...
struct AAthenaAIDirector : AFortAIDirector {
	...
	void AggroOnActor(struct AAthenaAIController* AIController, struct AActor* Target); // Function FortniteAI.AthenaAIDirector.AggroOnActor // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9a56db4
};
...
struct UFortAISystem : UAISystem {
	...
	bool IsInCone2D(struct FVector ConeOrigin, struct FVector ConeDirection, float HalfAngle, struct FVector LocationToCheck); // Function FortniteAI.FortAISystem.IsInCone2D // (Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x9abad38
};
...
struct UAthenaAISystem : UFortAISystem {
	...
	void OnAIPawnSpawned(struct AController* SpawnedController, bool bIsABot, struct AFortPawn* FortAIPawn, struct AFortPlayerPawn* PlayerPawn); // Function FortniteAI.AthenaAISystem.OnAIPawnSpawned // (Final|Native|Protected) // @ game+0x9a58be0
	void OnAIPawnDied(struct AController* KilledController, bool bIsABot, struct AFortPawn* KilledAIPawn, struct AFortPlayerPawn* KilledPlayerPawn, struct AController* KillerController); // Function FortniteAI.AthenaAISystem.OnAIPawnDied // (Final|Native|Protected) // @ game+0x9a58a48
	void HandlePlayerExitAircraft(struct AController* ExitingController); // Function FortniteAI.AthenaAISystem.HandlePlayerExitAircraft // (Final|Native|Protected) // @ game+0x9a58290
	void HandleGamePhaseStepChanged(struct TScriptInterface<IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep); // Function FortniteAI.AthenaAISystem.HandleGamePhaseStepChanged // (Final|Native|Protected|HasOutParms) // @ game+0x9a5819c
	void AIProfiling_OnSafeZoneUpdated(); // Function FortniteAI.AthenaAISystem.AIProfiling_OnSafeZoneUpdated // (Final|Native|Public) // @ game+0x258f6c0
	void AIProfiling_OnGamePhaseChanged(enum class EAthenaGamePhase GamePhase); // Function FortniteAI.AthenaAISystem.AIProfiling_OnGamePhaseChanged // (Final|Native|Public) // @ game+0x6762920
};

// Class FortniteAI.AthenaCreativeRift
// Size: 0xc80 (Inherited: 0xb90)
struct AAthenaCreativeRift : ABuildingRift {
	struct USphereComponent* DespawnSphereComponent; // 0xb88(0x08)
	struct ABuildingProp_AISpawner* ParentTrap; // 0xb90(0x08)
	struct FFortEncounterSettings OverrideEncounterSettings; // 0xb98(0xc0)
	bool bHasLoadedSettings; // 0xc58(0x01)
	struct TArray<struct AFortPlayerPawn*> DespawnPlayerOverlaps; // 0xc60(0x10)
	char pad_C71[0x7]; // 0xc71(0x07)
	struct UFortAIManagerMinigameComponent* CachedAIMinigamecomponent; // 0xc78(0x08)

	void NotifyActorDespawnEndOverlap(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // Function FortniteAI.AthenaCreativeRift.NotifyActorDespawnEndOverlap // (Final|Native|Public) // @ game+0x9a5890c
	void BlueprintShowRift(); // Function FortniteAI.AthenaCreativeRift.BlueprintShowRift // (RequiredAPI|Event|Public|BlueprintEvent) // @ game+0xdef49c
};
...
struct UFortAIComponent_Voice : UActorComponent {
	...
	void SetVoiceSoundBank(struct UFortTaggedSoundBank* InSoundBank); // Function FortniteAI.FortAIComponent_Voice.SetVoiceSoundBank // (Final|Native|Public|BlueprintCallable) // @ game+0x9a5b280
	struct UFortTaggedSoundBank* GetVoiceSoundBank(); // Function FortniteAI.FortAIComponent_Voice.GetVoiceSoundBank // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x23f9d18
};
...
struct UFortAIManagerMinigameComponent : UActorComponent {
	...
	void OnPawnSpawned(struct APawn* Pawn, int32_t RequestId); // Function FortniteAI.FortAIManagerMinigameComponent.OnPawnSpawned // (Final|Native|Public) // @ game+0x9a5995c
	void OnPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIManagerMinigameComponent.OnPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x9a596e0
	void HandleMinigameStarted(); // Function FortniteAI.FortAIManagerMinigameComponent.HandleMinigameStarted // (Final|Native|Public) // @ game+0x9a5827c
};
...
struct UFortAISpawnerUtilityComponent : UActorComponent {
	...
	void StartEnvironmentQuery(); // Function FortniteAI.FortAISpawnerUtilityComponent.StartEnvironmentQuery // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9a5b3bc
	void SetQueryRadius(float Radius); // Function FortniteAI.FortAISpawnerUtilityComponent.SetQueryRadius // (Final|Native|Public|BlueprintCallable) // @ game+0x9a5afac
	void SetMinigame(struct AFortMinigame* Minigame); // Function FortniteAI.FortAISpawnerUtilityComponent.SetMinigame // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9a5ae3c
	void SetEQSQuery(struct TSoftObjectPtr<UEnvQuery> SelectedEQSQuery); // Function FortniteAI.FortAISpawnerUtilityComponent.SetEQSQuery // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9a5abac
	int32_t RequestSpawn(struct UFortAthenaAISpawnerDataComponentList* AISpawnerComponentList, struct FTransform& SpawnTransform); // Function FortniteAI.FortAISpawnerUtilityComponent.RequestSpawn // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9a5a9f8
	void OnUnownedPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAISpawnerUtilityComponent.OnUnownedPawnDied // (Final|Native|Private|HasDefaults) // @ game+0x9a5a3d8
	bool IsSpawnCountCapped(); // Function FortniteAI.FortAISpawnerUtilityComponent.IsSpawnCountCapped // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x236a68c
	void HandleUnownedPawnSpawned(struct AFortPawn* FortPawn); // Function FortniteAI.FortAISpawnerUtilityComponent.HandleUnownedPawnSpawned // (Final|Native|Public|BlueprintCallable) // @ game+0x9a58310
};
...
struct AFortAIDirectorDataManager : AActor {
	...
	void TriggerEvent(struct FFortAIDirectorEvent& TriggeredEvent); // Function FortniteAI.FortAIDirectorDataManager.TriggerEvent // (Native|Public|HasOutParms) // @ game+0x9a81498
	float GetAIDirectorFactorValue(enum class EFortAIDirectorFactor AIDirectorFactor); // Function FortniteAI.FortAIDirectorDataManager.GetAIDirectorFactorValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a7ef28
};
...
struct UFortAIEncounterInfo : UObject {
	...
	void UnRegisterAISpawner(struct AActor* InAISpawner); // Function FortniteAI.FortAIEncounterInfo.UnRegisterAISpawner // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9a8153c
	void SpawnTestAIGroup(struct UFortAISpawnGroup* SpawnGroupToSpawn, struct FVector SpawnLocation, struct FRotator SpawnRotation, struct AActor* SpawnSource, struct TArray<struct UFortAbilitySet*> AbilitySetsToGrantOnSpawn, struct FFortAISpawnGroupUpgradeData UpgradeData, bool bAllowAssigningToExternalSpawners, float SecondsBetweenSpawns); // Function FortniteAI.FortAIEncounterInfo.SpawnTestAIGroup // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x9a80fc4
	struct AFortAIPawn* SpawnAIPawnReservedForEnemySpawner(struct AActor* EnemySpawner, struct FVector SpawnLocation, struct FRotator SpawnRotation); // Function FortniteAI.FortAIEncounterInfo.SpawnAIPawnReservedForEnemySpawner // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x9a80e94
	void SetPawnNumberLimit(int32_t InPawnNumberLimit); // Function FortniteAI.FortAIEncounterInfo.SetPawnNumberLimit // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9a80e18
	void SetNukeWavesAtEncounterEnd(bool bNuke); // Function FortniteAI.FortAIEncounterInfo.SetNukeWavesAtEncounterEnd // (Final|Native|Public|BlueprintCallable) // @ game+0x9a80d98
	void SetEncounterActivationState(bool bEncounterActivityState); // Function FortniteAI.FortAIEncounterInfo.SetEncounterActivationState // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9a80d18
	void RequestActivation(int32_t ActivationDelay); // Function FortniteAI.FortAIEncounterInfo.RequestActivation // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9a80c98
	void RegisterAISpawner(struct AActor* InAISpawner); // Function FortniteAI.FortAIEncounterInfo.RegisterAISpawner // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9a80b88
	void OnRestStarted(); // Function FortniteAI.FortAIEncounterInfo.OnRestStarted // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnRampStarted(); // Function FortniteAI.FortAIEncounterInfo.OnRampStarted // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnPeakStarted(); // Function FortniteAI.FortAIEncounterInfo.OnPeakStarted // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnGoalTakeDamage(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIEncounterInfo.OnGoalTakeDamage // (Final|Native|Public|HasDefaults) // @ game+0x9a8090c
	void OnGameDifficultyChanged(); // Function FortniteAI.FortAIEncounterInfo.OnGameDifficultyChanged // (Final|Native|Private) // @ game+0x9a808f8
	void OnFadeStarted(); // Function FortniteAI.FortAIEncounterInfo.OnFadeStarted // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnEncounterPawnDamaged(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIEncounterInfo.OnEncounterPawnDamaged // (Final|Native|Protected|HasDefaults) // @ game+0x9a8067c
	void NotifyRiftDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIEncounterInfo.NotifyRiftDied // (Final|Native|Public|HasDefaults) // @ game+0x9a80300
	bool GroupHasAIRemainingToSpawn(struct FFortAISpawnerData& FortAISpawnerData); // Function FortniteAI.FortAIEncounterInfo.GroupHasAIRemainingToSpawn // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9a7f7f0
	int32_t GetPawnNumberLimit(); // Function FortniteAI.FortAIEncounterInfo.GetPawnNumberLimit // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a7f514
	float GetEncounterTimeSeconds(); // Function FortniteAI.FortAIEncounterInfo.GetEncounterTimeSeconds // (Final|Native|Public|BlueprintCallable) // @ game+0x7ebceb8
	void GetEncounterRifts(struct TArray<struct ABuildingRift*>& OutRifts); // Function FortniteAI.FortAIEncounterInfo.GetEncounterRifts // (Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a7f3b8
	struct AActor* GetEncounterQueryActor(); // Function FortniteAI.FortAIEncounterInfo.GetEncounterQueryActor // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a7f334
	void GetEncounterGameplayTags(struct FGameplayTagContainer& OutEncounterTags); // Function FortniteAI.FortAIEncounterInfo.GetEncounterGameplayTags // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a7f27c
	struct AFortAIDirectorDataManager* GetEncounterDataManager(); // Function FortniteAI.FortAIEncounterInfo.GetEncounterDataManager // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x9a7f1c0
	void GetEncounterAssignmentGoalActors(struct TArray<struct AActor*>& OutGoalActors); // Function FortniteAI.FortAIEncounterInfo.GetEncounterAssignmentGoalActors // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a7f124
	bool GetCurrentSpawnAreaDirections(struct TArray<enum class EFortEncounterDirection>& OutDirections); // Function FortniteAI.FortAIEncounterInfo.GetCurrentSpawnAreaDirections // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a7f078
	bool EncounterHasReservedSpawnRequestForEnemySpawner(struct AActor* EnemySpawner); // Function FortniteAI.FortAIEncounterInfo.EncounterHasReservedSpawnRequestForEnemySpawner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a7edec
	void DespawnPendingAndCurrentAI(); // Function FortniteAI.FortAIEncounterInfo.DespawnPendingAndCurrentAI // (Final|Native|Public|BlueprintCallable) // @ game+0x9a7edb4
	struct UFortAIAssignment* CreateEncounterAssignment(struct UFortAIAssignmentSettings* AssignmentSettings, struct AActor* GoalActor); // Function FortniteAI.FortAIEncounterInfo.CreateEncounterAssignment // (Final|Native|Public|BlueprintCallable) // @ game+0x9a7ecf0
};
...
struct UFortAIEncounterInfoOwnerInterface : UInterface {
	...
	struct UFortAIEncounterInfo* GetEncounterInfo(); // Function FortniteAI.FortAIEncounterInfoOwnerInterface.GetEncounterInfo // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2898a88
};
...
struct UFortAIEncounterRiftManager : UObject {
	...
	void OnRiftDestroyed(struct AActor* Rift); // Function FortniteAI.FortAIEncounterRiftManager.OnRiftDestroyed // (Final|Native|Public) // @ game+0x9abcfb4
	struct AFortMission* GetAssociatedMission(); // Function FortniteAI.FortAIEncounterRiftManager.GetAssociatedMission // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9aba8f4
};
...
struct UFortAIEncounterSequence : UObject {
	...
	void StopCurrentEncounter(); // Function FortniteAI.FortAIEncounterSequence.StopCurrentEncounter // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abed08
	struct UFortAIEncounterInfo* StartCurrentEncounterWithSavedData(enum class EFortEncounterSequenceResult& OutRequestResult, int32_t ActivationDelay); // Function FortniteAI.FortAIEncounterSequence.StartCurrentEncounterWithSavedData // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9abeb9c
	struct UFortAIEncounterInfo* StartCurrentEncounter(enum class EFortEncounterSequenceResult& OutRequestResult, struct TArray<struct AActor*>& InTargetActors, struct UFortAIAssignmentSettings* InAssignmentSettings, struct FEncounterEnvironmentQueryInfo InOverrideEnvironmentQueryInfo, struct AActor* InOptionalQueryActor, struct FGameplayTagContainer InInjectedTags, struct FFortEncounterSettings InEncounterSettings, int32_t ActivationDelay); // Function FortniteAI.FortAIEncounterSequence.StartCurrentEncounter // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9abe850
	void SetEncounterStartingData(struct TArray<struct AActor*>& InTargetActors, struct UFortAIAssignmentSettings* InAssignmentSettings, struct FEncounterEnvironmentQueryInfo InOverrideEnvironmentQueryInfo, struct AActor* InOptionalQueryActor, struct FGameplayTagContainer InInjectedTags, struct FFortEncounterSettings InEncounterSettings); // Function FortniteAI.FortAIEncounterSequence.SetEncounterStartingData // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9abe11c
	enum class EFortEncounterSequenceResult Previous(); // Function FortniteAI.FortAIEncounterSequence.Previous // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abd714
	enum class EFortEncounterSequenceResult Next(); // Function FortniteAI.FortAIEncounterSequence.Next // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abbf78
	enum class EFortEncounterSequenceResult Last(); // Function FortniteAI.FortAIEncounterSequence.Last // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9abaf04
	bool IsOnFinalIndexInSequence(); // Function FortniteAI.FortAIEncounterSequence.IsOnFinalIndexInSequence // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9abaed0
	bool HasEncounter(); // Function FortniteAI.FortAIEncounterSequence.HasEncounter // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9abab90
	int32_t GetNumEncountersInSequence(); // Function FortniteAI.FortAIEncounterSequence.GetNumEncountersInSequence // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x73185e8
	int32_t GetEncounterIndexInSequence(); // Function FortniteAI.FortAIEncounterSequence.GetEncounterIndexInSequence // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71d9f58
	struct UFortAIEncounterInfo* GetCurrentEncounter(); // Function FortniteAI.FortAIEncounterSequence.GetCurrentEncounter // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6923384
	bool EncounterBelongsToSequence(struct UFortAIEncounterInfo* InEncounter); // Function FortniteAI.FortAIEncounterSequence.EncounterBelongsToSequence // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9aba5ec
};
...
struct UFortAIEncounterTargetInterface : UInterface {
	...
	bool IsFloatingTarget(); // Function FortniteAI.FortAIEncounterTargetInterface.IsFloatingTarget // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	float GetObjectiveCompletionPercentage(); // Function FortniteAI.FortAIEncounterTargetInterface.GetObjectiveCompletionPercentage // (Event|Public|BlueprintEvent) // @ game+0xdef49c
};
...
struct UFortAIFunctionLibrary : UBlueprintFunctionLibrary {
	...
	bool TeleportAIPawn(struct AFortAIPawn* AIPawn, struct FVector DestLocation, struct FRotator DestRotation, bool bIgnoreCollision); // Function FortniteAI.FortAIFunctionLibrary.TeleportAIPawn // (Final|BlueprintAuthorityOnly|Native|Static|Public|HasDefaults|BlueprintCallable) // @ game+0x9abef74
	void SetHearingRange(struct AActor* AIAgent, float Range); // Function FortniteAI.FortAIFunctionLibrary.SetHearingRange // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x7f39254
	void RequestNavUpdateForBuilding(struct ABuildingActor* BuildingActor); // Function FortniteAI.FortAIFunctionLibrary.RequestNavUpdateForBuilding // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x9abdf68
	void MakeNoiseEventAtLocation(struct AActor* NoiseMaker, float MaxRange, struct FVector& NoiseLocation, struct FName NoiseTag); // Function FortniteAI.FortAIFunctionLibrary.MakeNoiseEventAtLocation // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9abbc84
	void MakeNoiseEvent(struct AActor* NoiseMaker, float MaxRange, struct FName NoiseTag); // Function FortniteAI.FortAIFunctionLibrary.MakeNoiseEvent // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9abb984
	bool IsConcealedByPerceptionModifiers(struct UObject* WorldContextObject, struct FVector ObserverLocation, struct FVector TargetLocation, float& OutConcealment); // Function FortniteAI.FortAIFunctionLibrary.IsConcealedByPerceptionModifiers // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9ababc8
	struct UFortAthenaAIRuntimeParameters* GetOrCreateAIRuntimeParameters(struct AAIController* AIController, struct UFortAthenaAIRuntimeParameters* ParametersClass); // Function FortniteAI.FortAIFunctionLibrary.GetOrCreateAIRuntimeParameters // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9abaa44
	struct UAthenaAISpawner* GetAISpawner(struct UObject* WorldContextObject); // Function FortniteAI.FortAIFunctionLibrary.GetAISpawner // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x9aba85c
};
...
struct AFortAIGoalManager : AActor {
	...
	void SetCurrentGoalDiscouragement(struct UObject* WorldContext, struct AFortAIController* AI); // Function FortniteAI.FortAIGoalManager.SetCurrentGoalDiscouragement // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x9abe06c
	void RemoveWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier AssignmentIdentifier); // Function FortniteAI.FortAIGoalManager.RemoveWorldAssignment // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x9abddac
	void RemoveGoalsFromWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, struct TArray<struct FFortAIGoalInfo>& GoalInfos); // Function FortniteAI.FortAIGoalManager.RemoveGoalsFromWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9abdaa4
	void RemoveGoalFromWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, struct FFortAIGoalInfo& GoalInfo); // Function FortniteAI.FortAIGoalManager.RemoveGoalFromWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9abd954
	void MakeGoalsFromLocationsAndActor(struct TArray<struct FFortAIGoalInfo>& Goals, struct UObject* WorldContextObject, struct TArray<struct FVector>& GoalLocations, struct AActor* GoalActor); // Function FortniteAI.FortAIGoalManager.MakeGoalsFromLocationsAndActor // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9abb744
	void MakeGoalsFromLocations(struct TArray<struct FFortAIGoalInfo>& Goals, struct UObject* WorldContextObject, struct TArray<struct FVector>& GoalLocations); // Function FortniteAI.FortAIGoalManager.MakeGoalsFromLocations // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9abb540
	void MakeGoalsFromActors(struct TArray<struct FFortAIGoalInfo>& Goals, struct UObject* WorldContextObject, struct TArray<struct AActor*>& GoalActors, bool bActorsAlwaysPerceived, bool bGoalActorsAllowUndermining); // Function FortniteAI.FortAIGoalManager.MakeGoalsFromActors // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9abb2c0
	void MakeGoalFromLocation(struct FFortAIGoalInfo& Goal, struct UObject* WorldContextObject, struct FVector& GoalLocation); // Function FortniteAI.FortAIGoalManager.MakeGoalFromLocation // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9abb158
	void MakeGoalFromActor(struct FFortAIGoalInfo& Goal, struct UObject* WorldContextObject, struct AActor* GoalActor, bool bActorAlwaysPerceived, bool bGoalActorAllowsUndermining); // Function FortniteAI.FortAIGoalManager.MakeGoalFromActor // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9abaf28
	void CreateWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier WorldAssignmentIdentifier, struct UFortAIAssignmentSettings* AssignmentSettings, struct UFortAIGoalProvider* GoalProvider, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, enum class EAssignmentCreationResult& CreationResult); // Function FortniteAI.FortAIGoalManager.CreateWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9aba3d8
	struct UFortAIAssignment* AddWorldAssignment(struct UFortAIAssignmentSettings* AssignmentSettings, struct AActor* GoalActor); // Function FortniteAI.FortAIGoalManager.AddWorldAssignment // (Final|Native|Public|BlueprintCallable) // @ game+0x9ab9f64
	void AddGoalToWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, struct FFortAIGoalInfo& GoalInfo); // Function FortniteAI.FortAIGoalManager.AddGoalToWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9ab9908
	void AddGoalsToWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, struct TArray<struct FFortAIGoalInfo>& GoalInfos); // Function FortniteAI.FortAIGoalManager.AddGoalsToWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9ab9a58
	void AddGoalActorToAssignment(struct UFortAIAssignment* Assignment, struct AActor* GoalActor); // Function FortniteAI.FortAIGoalManager.AddGoalActorToAssignment // (Final|Native|Public|BlueprintCallable) // @ game+0x9ab96bc
	void AddGoal(struct AActor* GoalActor, struct UFortAIAssignmentSettings* GoalSettings); // Function FortniteAI.FortAIGoalManager.AddGoal // (Final|Native|Public|BlueprintCallable) // @ game+0x9ab95f4
};
...
struct UFortAIRootAssignmentProviderInterface : UInterface {
	...
	struct FFortAIAssignmentIdentifier GetRootAssignmentIdentifier(); // Function FortniteAI.FortAIRootAssignmentProviderInterface.GetRootAssignmentIdentifier // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9abab48
};
...
struct UFortAISpawnerInterface : UInterface {
	...
	bool OnReceiveSpawnGroup(); // Function FortniteAI.FortAISpawnerInterface.OnReceiveSpawnGroup // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	bool IsReadyToReceiveNewSpawnGroup(); // Function FortniteAI.FortAISpawnerInterface.IsReadyToReceiveNewSpawnGroup // (Event|Public|BlueprintEvent) // @ game+0xdef49c
};
...
struct UFortAISpawnGroup : UPrimaryDataAsset {
	...
	bool IsValidForEnemySpawners(); // Function FortniteAI.FortAISpawnGroup.IsValidForEnemySpawners // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2302a7c
	bool IsPrototype(); // Function FortniteAI.FortAISpawnGroup.IsPrototype // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9abaeec
	bool IsLargeSpawnGroup(); // Function FortniteAI.FortAISpawnGroup.IsLargeSpawnGroup // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9abaeb8
	int32_t GetNumberOfEnemies(); // Function FortniteAI.FortAISpawnGroup.GetNumberOfEnemies // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x92fabe8
	struct UFortAIPawnVariant* GetEnemy(int32_t EnemyIndex); // Function FortniteAI.FortAISpawnGroup.GetEnemy // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9aba9a4
};
...
struct UFortAITetheringBoxBoundsInterface : UInterface {
	...
	float GetTetheredBoxBoundsWidth(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsWidth // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xdef49c
	float GetTetheredBoxBoundsHeight(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsHeight // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xdef49c
	float GetTetheredBoxBoundsEQSSpaceBetween(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsEQSSpaceBetween // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xdef49c
	float GetTetheredBoxBoundsEQSGridSize(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsEQSGridSize // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xdef49c
	struct FVector GetTetheredBoxBoundsCenter(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsCenter // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|HasDefaults|BlueprintEvent) // @ game+0xdef49c
};
...
struct UFortAthenaTrackableAIObjectVehicleComponent : UFortAthenaTrackableAIObjectComponent {
	...
	void HandleSleepStateChanged(bool bIsAwake); // Function FortniteAI.FortAthenaTrackableAIObjectVehicleComponent.HandleSleepStateChanged // (Final|Native|Private) // @ game+0x9adf648
};
...
struct UFortCreativeCreatureManagerInfoComponent : UFortMinigameLogicComponent {
	...
	void SetWeaponKnockbackImmunityEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetWeaponKnockbackImmunityEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae06f4
	void SetWeaponKnockbackImmunity(bool InImmuneToWeaponKnockback); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetWeaponKnockbackImmunity // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae0674
	void SetScorePoints(int32_t InScorePoints); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetScorePoints // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae05f8
	void SetScoreDistribution(enum class EScoreDistributionType InScoreDistribution); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetScoreDistribution // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae057c
	void SetOverrideDamage(float InOverrideDamage); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetOverrideDamage // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae04f8
	void SetMovementSpeedOverrideEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMovementSpeedOverrideEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae0478
	void SetMovementSpeedMultiplier(float InOverrideMovementSpeedMultiplier); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMovementSpeedMultiplier // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae03f4
	void SetMovementOverrideTag(struct FGameplayTag tag); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMovementOverrideTag // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae0378
	void SetMaxHealthOverrideTag(struct FGameplayTag tag); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMaxHealthOverrideTag // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae02fc
	void SetMaxHealthOverrideEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMaxHealthOverrideEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae027c
	void SetMaxHealth(int32_t InMaxHealth); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMaxHealth // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae0200
	void SetHearingAggroRange(float InHearingAggroRange); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetHearingAggroRange // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae017c
	void SetEnvironmentalDamageOverrideEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetEnvironmentalDamageOverrideEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae00fc
	void SetEnvironmentalDamageOverride(float InOverrideDamage); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetEnvironmentalDamageOverride // (Final|Native|Public|BlueprintCallable) // @ game+0x9ae0078
	void SetDamageOverrideTag(struct FGameplayTag tag); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetDamageOverrideTag // (Final|Native|Public|BlueprintCallable) // @ game+0x9adfffc
	void SetDamageOverrideEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetDamageOverrideEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x9adff7c
	void SetCreatureManagerComponent(struct UFortCreativeCreatureManagerComponent* InCreatureManagerComponent); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetCreatureManagerComponent // (Final|Native|Public|BlueprintCallable) // @ game+0x9adfefc
	void SetCreatureBlueprintClass(struct TSoftClassPtr<UObject> InCreatureBlueprintClass); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetCreatureBlueprintClass // (Final|Native|Public|BlueprintCallable) // @ game+0x9adfdd8
	void SetAffectedTargetsType(enum class ECreatureManagerAffectedTargets InAffectedTargetsType); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetAffectedTargetsType // (Final|Native|Public|BlueprintCallable) // @ game+0x9adfd5c
	void ResetWeaponKnockbackImmunity(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetWeaponKnockbackImmunity // (Final|Native|Public|BlueprintCallable) // @ game+0x9adfd44
	void ResetScorePoints(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetScorePoints // (Final|Native|Public|BlueprintCallable) // @ game+0x9adfd2c
	void ResetScoreDistribution(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetScoreDistribution // (Final|Native|Public|BlueprintCallable) // @ game+0x9adfd14
	void ResetOverrideDamage(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetOverrideDamage // (Final|Native|Public|BlueprintCallable) // @ game+0x9adfcfc
	void ResetMovementSpeedMultiplier(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetMovementSpeedMultiplier // (Final|Native|Public|BlueprintCallable) // @ game+0x9adfce4
	void ResetMaxHealth(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetMaxHealth // (Final|Native|Public|BlueprintCallable) // @ game+0x9adfccc
	void ResetHearingAggroRange(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetHearingAggroRange // (Final|Native|Public|BlueprintCallable) // @ game+0x9adfcb4
	void ResetEnvironmentalDamageOverride(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetEnvironmentalDamageOverride // (Final|Native|Public|BlueprintCallable) // @ game+0x9adfc9c
	bool GetWeaponKnockbackImmunity(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetWeaponKnockbackImmunity // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9adf630
	int32_t GetScorePoints(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetScorePoints // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7567bc0
	enum class EScoreDistributionType GetScoreDistribution(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetScoreDistribution // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9adf618
	float GetOverrideDamage(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetOverrideDamage // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9adf600
	float GetMovementSpeedMultiplier(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetMovementSpeedMultiplier // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9adf5e8
	int32_t GetMaxHealth(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetMaxHealth // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2670cfc
	float GetHearingAggroRange(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetHearingAggroRange // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7567ba8
	float GetEnvironmentalDamageOverride(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetEnvironmentalDamageOverride // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9adf5d0
	struct UFortCreativeCreatureManagerComponent* GetCreatureManagerComponent(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetCreatureManagerComponent // (Final|Native|Public|BlueprintCallable) // @ game+0x9adf5b8
	struct TSoftClassPtr<UObject> GetCreatureBlueprintClass(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetCreatureBlueprintClass // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9adf488
	enum class ECreatureManagerAffectedTargets GetAffectedTargetsType(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetAffectedTargetsType // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9adf470
};
...
struct UFortCreativeCreatureManagerComponent : UActorComponent {
	...
	void OnInfoComponentRemoved(struct UFortCreativeCreatureManagerInfoComponent* CreatureManagerInfoComponent); // Function FortniteAI.FortCreativeCreatureManagerComponent.OnInfoComponentRemoved // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9adfc00
	void OnInfoComponentAdded(struct UFortCreativeCreatureManagerInfoComponent* CreatureManagerInfoComponent); // Function FortniteAI.FortCreativeCreatureManagerComponent.OnInfoComponentAdded // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9adfb54
	void OnAIPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortCreativeCreatureManagerComponent.OnAIPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x9adf6c8
};
...
struct AFortEnemySpawn : ABuildingActor {
	float ClusterRadius; // 0x780(0x04)
	char pad_784[0x4]; // 0x784(0x04)
};
...
struct UFortEnvQueryManager : UEnvQueryManager {
	...
	void OnGamePhaseChanged(enum class EAthenaGamePhase GamePhase); // Function FortniteAI.FortEnvQueryManager.OnGamePhaseChanged // (Final|Native|Protected) // @ game+0x9adfad4
};
...
struct AFortEQSPrevisActor : AActor {
	...
	void SetQueryTemplate(struct UEnvQuery* InPrevisQueryTemplate); // Function FortniteAI.FortEQSPrevisActor.SetQueryTemplate // (Final|Native|Public|BlueprintCallable) // @ game+0x6537ae4
	void PrepForPrevis(); // Function FortniteAI.FortEQSPrevisActor.PrepForPrevis // (Event|Public|BlueprintEvent) // @ game+0xdef49c
};
...
// Class FortniteAI.FortQueryGenerator_PerceivedActors
// Size: 0x128 (Inherited: 0x50)
...
struct UFortQueryTwoPointSolver : UObject {
	...
	void Start(struct UObject* Querier); // Function FortniteAI.FortQueryTwoPointSolver.Start // (Final|Native|Public|BlueprintCallable) // @ game+0x9b0d620
	void SkipToNextPointA(); // Function FortniteAI.FortQueryTwoPointSolver.SkipToNextPointA // (Final|Native|Public|BlueprintCallable) // @ game+0x9b0d608
	void SetCustomRotationA(struct FRotator& Rotation); // Function FortniteAI.FortQueryTwoPointSolver.SetCustomRotationA // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9b0d570
	void OnCustomRotationMode(struct FVector& InPointA, struct FVector Querier); // Function FortniteAI.FortQueryTwoPointSolver.OnCustomRotationMode // (Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0xdef49c
	struct FRotator GetRandomRotationOffset(); // Function FortniteAI.FortQueryTwoPointSolver.GetRandomRotationOffset // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9b0d344
	void AddNamedFloatParamB(struct FName ParamName, float Value); // Function FortniteAI.FortQueryTwoPointSolver.AddNamedFloatParamB // (Final|Native|Public|BlueprintCallable) // @ game+0x9b0d248
	void AddNamedFloatParamA(struct FName ParamName, float Value); // Function FortniteAI.FortQueryTwoPointSolver.AddNamedFloatParamA // (Final|Native|Public|BlueprintCallable) // @ game+0x9b0d14c
};
...
struct UFortGameplayAbility_TeleportToActor : UFortGameplayAbility {
	...
	float TeleportDelay; // 0xb30(0x04)
	int32_t TeleportRetries; // 0xb34(0x04)
	float RetryDelay; // 0xb38(0x04)
	char pad_B3C[0xc]; // 0xb3c(0x0c)
	struct UEnvQuery* FindTeleportSpotEQSQuery; // 0xb48(0x08)
	char pad_B50[0x8]; // 0xb50(0x08)

	void PreTeleportPawn(struct AFortPawn* TeleportedPawn); // Function FortniteAI.FortGameplayAbility_TeleportToActor.PreTeleportPawn // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void PostTeleportedPawn(struct AFortPawn* TeleportedPawn); // Function FortniteAI.FortGameplayAbility_TeleportToActor.PostTeleportedPawn // (Event|Public|BlueprintEvent) // @ game+0xdef49c
};
...
struct UFortNavSystem : UNavigationSystemV1 {
	...
	void OnNavDataRegistered(struct ANavigationData* NavData); // Function FortniteAI.FortNavSystem.OnNavDataRegistered // (Final|Native|Protected) // @ game+0x9b0d490
	bool IsNavmeshInRadiusInitialized(struct UObject* WorldContext, struct FVector& TestLocation, float TestRadius); // Function FortniteAI.FortNavSystem.IsNavmeshInRadiusInitialized // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x9b0d37c
};
...
struct UFortPatrolWardInterface : UInterface {
	...
	enum class EWardAffectType GetAffectingType(); // Function FortniteAI.FortPatrolWardInterface.GetAffectingType // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent|Const) // @ game+0xdef49c
	float GetAffectingDistance(); // Function FortniteAI.FortPatrolWardInterface.GetAffectingDistance // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent|Const) // @ game+0xdef49c
};
...
struct AFortThreatVisualsManager : AActor {
	...
	bool StormsExist(); // Function FortniteAI.FortThreatVisualsManager.StormsExist // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9b3c9c8
	void SetMinimumCloudAltitude(float NewMinimumAltitude); // Function FortniteAI.FortThreatVisualsManager.SetMinimumCloudAltitude // (Final|Native|Public|BlueprintCallable) // @ game+0x940e394
	void SetCloudsAreHidden(bool bHide); // Function FortniteAI.FortThreatVisualsManager.SetCloudsAreHidden // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9b3c48c
	void ResetMinimumCloudAltitude(); // Function FortniteAI.FortThreatVisualsManager.ResetMinimumCloudAltitude // (Final|Native|Public|BlueprintCallable) // @ game+0x9b3c460
	void OnWorldReady(); // Function FortniteAI.FortThreatVisualsManager.OnWorldReady // (Event|Protected|BlueprintEvent) // @ game+0xdef49c
	void OnThreatCloudsChanged(struct TArray<struct FThreatLocationInfo>& ThreatLocationInfo); // Function FortniteAI.FortThreatVisualsManager.OnThreatCloudsChanged // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xdef49c
	void OnRep_ThreatLocations(); // Function FortniteAI.FortThreatVisualsManager.OnRep_ThreatLocations // (Final|Native|Private) // @ game+0x1cf4608
	void OnRep_StormWinds(); // Function FortniteAI.FortThreatVisualsManager.OnRep_StormWinds // (Final|Native|Private) // @ game+0x24df4b8
	void OnRep_HideClouds(); // Function FortniteAI.FortThreatVisualsManager.OnRep_HideClouds // (Final|Native|Private) // @ game+0x1639298
	void OnRep_GoalActorLocations(); // Function FortniteAI.FortThreatVisualsManager.OnRep_GoalActorLocations // (Final|Native|Private) // @ game+0x1639118
	void OnBeginThreatVisualsPrecursor(struct AActor* SourceActor, struct FVector& EndLocation); // Function FortniteAI.FortThreatVisualsManager.OnBeginThreatVisualsPrecursor // (BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0xdef49c
	struct TArray<struct FThreatLocationInfo> GetThreatClouds(); // Function FortniteAI.FortThreatVisualsManager.GetThreatClouds // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9b3b974
	struct AThreatCloud* GetThreatCloud(struct FThreatLocationInfo& ThreatLocInfo); // Function FortniteAI.FortThreatVisualsManager.GetThreatCloud // (Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9b3b880
	bool GetCloudsAreHidden(); // Function FortniteAI.FortThreatVisualsManager.GetCloudsAreHidden // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9b3b83c
	void BeginThreatVisualsPrecursor(struct AActor* SourceActor, struct FVector ThreatLocation); // Function FortniteAI.FortThreatVisualsManager.BeginThreatVisualsPrecursor // (Net|NetReliableNative|Event|NetMulticast|Public|HasDefaults) // @ game+0x9b3b598
};
...
struct UFortAIGoalProvider : UObject {
	...
	void UpdateGoals(); // Function FortniteAI.FortAIGoalProvider.UpdateGoals // (Native|Public|BlueprintCallable) // @ game+0x68932ec
	bool InitializeGoalProvider(struct UWorld* ContextWorld, struct UFortAIAssignment* Assignment); // Function FortniteAI.FortAIGoalProvider.InitializeGoalProvider // (Native|Public|BlueprintCallable) // @ game+0x9b3b9c8
	struct UFortAIEncounterInfo* GetEncounterInfo(); // Function FortniteAI.FortAIGoalProvider.GetEncounterInfo // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9b3b854
};
...
struct UAIHotSpotSlotGenerator : UObject {
	...
	struct AAIHotSpot* GetHotSpot(); // Function FortniteAI.AIHotSpotSlotGenerator.GetHotSpot // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9a57774
	void GenerateSlots(); // Function FortniteAI.AIHotSpotSlotGenerator.GenerateSlots // (Native|Event|Public|BlueprintEvent) // @ game+0x19d5234
	struct UAIHotSpotSlot* AddSlot(struct FVector& RelativeLocation, struct FRotator& RelativeRotation, struct UAIHotSpotSlot* CustomSlotClass, bool bEnabled); // Function FortniteAI.AIHotSpotSlotGenerator.AddSlot // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9b3b428
};
...
struct UFortInfluenceMap : UObject {
	...
	void K2_GetInfluenceSourcePositions(struct UObject* WorldContext, struct TArray<struct FVector>& InfluenceSourcePositions); // Function FortniteAI.FortInfluenceMap.K2_GetInfluenceSourcePositions // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9b3bca8
	void K2_AddInfluenceSource(struct UObject* WorldContext, struct FVector& Position, struct FString SourceName, float Strength); // Function FortniteAI.FortInfluenceMap.K2_AddInfluenceSource // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9b3ba94
};
...
struct UFortBotMissionLogic : UObject {
	...
	struct AFortBotStructureBuilder* SpawnStructureBuilder(struct AActor* MissionGoal, struct UFortBuildingInstructions* BuildingInstructions); // Function FortniteAI.FortBotMissionLogic.SpawnStructureBuilder // (Final|Native|Public|BlueprintCallable) // @ game+0x9b3c6cc
	void SetGoalsInvulnerable(bool bGodMode); // Function FortniteAI.FortBotMissionLogic.SetGoalsInvulnerable // (Final|Native|Public|BlueprintCallable) // @ game+0x9b3c5cc
	void SetCurrentBehavior(struct UBehaviorTree* Behavior); // Function FortniteAI.FortBotMissionLogic.SetCurrentBehavior // (Final|Native|Public|BlueprintCallable) // @ game+0x9b3c54c
	void ResetBehavior(); // Function FortniteAI.FortBotMissionLogic.ResetBehavior // (Final|Native|Public|BlueprintCallable) // @ game+0x9b3c3e8
	void OnMissionStarted(); // Function FortniteAI.FortBotMissionLogic.OnMissionStarted // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnMissionFinished(); // Function FortniteAI.FortBotMissionLogic.OnMissionFinished // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnMissionActivated(); // Function FortniteAI.FortBotMissionLogic.OnMissionActivated // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	bool OnInteractWithMissionGoal(struct AFortAIController* BotAI, struct AActor* MissionGoal); // Function FortniteAI.FortBotMissionLogic.OnInteractWithMissionGoal // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	bool OnCanStartOtherMission(struct AFortAIController* BotAI, struct AFortMission* OtherMission); // Function FortniteAI.FortBotMissionLogic.OnCanStartOtherMission // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnAssignedBehavior(struct AFortAIController* BotAI); // Function FortniteAI.FortBotMissionLogic.OnAssignedBehavior // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void MarkSingleLocator(struct AActor* LocatorActor); // Function FortniteAI.FortBotMissionLogic.MarkSingleLocator // (Final|Native|Public|BlueprintCallable) // @ game+0x9b3bdf4
	void MarkAllLocated(); // Function FortniteAI.FortBotMissionLogic.MarkAllLocated // (Final|Native|Public|BlueprintCallable) // @ game+0x9b3bda8
	void ClearAllLocated(); // Function FortniteAI.FortBotMissionLogic.ClearAllLocated // (Final|Native|Public|BlueprintCallable) // @ game+0x9b3b688
};
...
struct AFortBotStructureBuilder : AActor {
	...
	void RunDeconstructor(); // Function FortniteAI.FortBotStructureBuilder.RunDeconstructor // (Final|Native|Public|BlueprintCallable) // @ game+0x9b3c478
	void OnBuildingDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortBotStructureBuilder.OnBuildingDied // (Final|Native|Protected|HasDefaults) // @ game+0x9b3c16c
	void BuildAll(); // Function FortniteAI.FortBotStructureBuilder.BuildAll // (Final|Native|Public|BlueprintCallable) // @ game+0x9b3b674
};
...
struct AAthenaNavInvokerBox : AActor {
	...
	void SetInvokerEnabled(bool bEnable); // Function FortniteAI.AthenaNavInvokerBox.SetInvokerEnabled // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9b3c64c
};
...
struct AAthenaNavMesh : AFortNavMesh {
	...
	void MoveTiles(struct FBox& SourceBox, struct FIntPoint& TileOffset, float RotationDeg, struct FVector2D& FillerTilePosition); // Function FortniteAI.AthenaNavMesh.MoveTiles // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9b3bff8
	void ComputeOffsetForMoveTiles(struct FVector& StartPosition, struct FVector& DesiredPosition, struct FVector& OutEndPosition, struct FIntPoint& OutTileOffset); // Function FortniteAI.AthenaNavMesh.ComputeOffsetForMoveTiles // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9b3b6b8
};
...
struct UAthenaNavPresenceDetectorComponent : UActorComponent {
	...
	void OnNavMeshTilesUpdated(struct FUpdatedNavMeshTiles& UpdatedNavMeshTiles); // Function FortniteAI.AthenaNavPresenceDetectorComponent.OnNavMeshTilesUpdated // (Final|Native|Protected|HasOutParms) // @ game+0x9b5bb4c
	bool HasValidNavMeshLocation(); // Function FortniteAI.AthenaNavPresenceDetectorComponent.HasValidNavMeshLocation // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9b5ba64
};
...
struct UAthenaNavSystem : UFortNavSystem {
	...
	void UnregisterNavGenerationObserver(struct USceneComponent* Component); // Function FortniteAI.AthenaNavSystem.UnregisterNavGenerationObserver // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable) // @ game+0x9b5be24
	void RegisterNavGenerationObserver(struct USceneComponent* Component, struct FDelegate Event); // Function FortniteAI.AthenaNavSystem.RegisterNavGenerationObserver // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable) // @ game+0x9b5bcd8
	bool IsInitialNavigationLockActive(struct UObject* WorldContextObject); // Function FortniteAI.AthenaNavSystem.IsInitialNavigationLockActive // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x9b5ba88
};
...
struct UFortNavPathRendererComponent : UActorComponent {
	...
	void UpdatePathsVisualOnClient(); // Function FortniteAI.FortNavPathRendererComponent.UpdatePathsVisualOnClient // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9b5be94
	void OnRep_PathPointsUpdated(); // Function FortniteAI.FortNavPathRendererComponent.OnRep_PathPointsUpdated // (Final|Native|Private) // @ game+0x9b5bbfc
	void OnRep_PathModeUpdated(); // Function FortniteAI.FortNavPathRendererComponent.OnRep_PathModeUpdated // (Final|Native|Private) // @ game+0x9b5bbe8
	void OnRep_ColorIndexUpdated(); // Function FortniteAI.FortNavPathRendererComponent.OnRep_ColorIndexUpdated // (Final|Native|Private) // @ game+0x9b5bbe8
	void DeactivateFX(); // Function FortniteAI.FortNavPathRendererComponent.DeactivateFX // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9b5ba50
};
...
struct UFortGameplayInteractionSmartObjectBehaviorDefinition : UGameplayInteractionSmartObjectBehaviorDefinition {
	...
	bool CanBeUsedBy(struct AActor* User, struct AActor* SmartObjectActor); // Function FortniteAI.FortGameplayInteractionSmartObjectBehaviorDefinition.CanBeUsedBy // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9b3b9c8
};
...
struct AThreatCloud : AActor {
	...
	void OnThreatVolumeChanged(); // Function FortniteAI.ThreatCloud.OnThreatVolumeChanged // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnLightningStrike(struct FVector& StartLocation, struct FVector& EndLocation, struct ABuildingRift* Rift, bool bLightningStruckRift); // Function FortniteAI.ThreatCloud.OnLightningStrike // (BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0xdef49c
	void OnCloudStart(); // Function FortniteAI.ThreatCloud.OnCloudStart // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnCloudHiddenChange(bool bCloudsAreHidden); // Function FortniteAI.ThreatCloud.OnCloudHiddenChange // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnCloudDeactivated(enum class EFortThreatDeactivationType DeactivationType); // Function FortniteAI.ThreatCloud.OnCloudDeactivated // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnCloudActivated(); // Function FortniteAI.ThreatCloud.OnCloudActivated // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnBeginDeath(); // Function FortniteAI.ThreatCloud.OnBeginDeath // (Event|Protected|BlueprintEvent) // @ game+0xdef49c
	void ManualLightningFlash(); // Function FortniteAI.ThreatCloud.ManualLightningFlash // (RequiredAPI|Event|Public|BlueprintEvent) // @ game+0xdef49c
	struct FBox GetThreatVolume(); // Function FortniteAI.ThreatCloud.GetThreatVolume // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9b795fc
};
...
struct UAthenaAIBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	void MakeBotGroupsTakeEachOtherAsTargets(struct TArray<struct AActor*>& GroupA, struct TArray<struct AActor*>& GroupB, enum class EPerceptionState PerceptionState, float ForgetTime, float ForgetDistance); // Function FortniteAI.AthenaAIBlueprintLibrary.MakeBotGroupsTakeEachOtherAsTargets // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9b7a1cc
	void KillBots(struct UObject* WorldContextObject, bool bKillPlayers, bool bKillNoneParticipants, char TeamIndex, struct AActor* BotOwner); // Function FortniteAI.AthenaAIBlueprintLibrary.KillBots // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9b79ce4
	void JoinTeam(struct UObject* WorldContextObject, struct AController* SourceTeamController, struct AController* DestinationTeamController); // Function FortniteAI.AthenaAIBlueprintLibrary.JoinTeam // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9b79b98
	bool IsWeaponSupported(struct UObject* WorldContextObject, struct AFortWeapon* FortWeapon); // Function FortniteAI.AthenaAIBlueprintLibrary.IsWeaponSupported // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9b79a00
	bool IsItemDefinitionSupported(struct UObject* WorldContextObject, struct UFortItemDefinition* FortItemDef); // Function FortniteAI.AthenaAIBlueprintLibrary.IsItemDefinitionSupported // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable) // @ game+0x9b79710
	struct UAthenaAIServicePlayerBots* GetAIServicePlayerBots(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIBlueprintLibrary.GetAIServicePlayerBots // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9b79564
	struct UAthenaAIServiceLoot* GetAIServiceLoot(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIBlueprintLibrary.GetAIServiceLoot // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9b79490
	struct UAthenaAIServiceCreativePlayerBots* GetAIServiceCreativePlayerBots(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIBlueprintLibrary.GetAIServiceCreativePlayerBots // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9b79410
	struct UAthenaAIPopulationTracker* GetAIPopulationTracker(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIBlueprintLibrary.GetAIPopulationTracker // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9b79378
	struct APawn* AthenaSpawnAIFromClass(struct UObject* WorldContextObject, struct APawn* PawnClass, struct UBehaviorTree* BehaviorTree, struct FVector Location, struct FRotator Rotation, bool bNoCollisionFail, struct AActor* Owner); // Function FortniteAI.AthenaAIBlueprintLibrary.AthenaSpawnAIFromClass // (Final|Native|Static|Public|HasDefaults|BlueprintCallable) // @ game+0x9b78830
	bool AIPawnFromGAHasLuringPickupAsGoal(struct FGameplayAbilityActorInfo& ActorInfo, struct FGameplayTag GameplayTag, float MaxLifetime, enum class EFortPickupSpawnSource RequiredPickupSpawnSource); // Function FortniteAI.AthenaAIBlueprintLibrary.AIPawnFromGAHasLuringPickupAsGoal // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9b786c4
};
...
struct UFortAthenaAlertStateComponent : UActorComponent {
	...
	void SetStealthMeterTargetTime(float InStealthMeterTargetTime); // Function FortniteAI.FortAthenaAlertStateComponent.SetStealthMeterTargetTime // (Final|Native|Public|BlueprintCallable) // @ game+0x65c8848
	void SetStealthMeterTarget(float InStealthMeterTarget); // Function FortniteAI.FortAthenaAlertStateComponent.SetStealthMeterTarget // (Final|Native|Public|BlueprintCallable) // @ game+0x9b7b2e0
	void OnStealthMeterChanged(struct AFortAthenaAIBotController* BotController, float StealthMeterTarget, float StealthMeterTargetTime); // Function FortniteAI.FortAthenaAlertStateComponent.OnStealthMeterChanged // (Final|Native|Public) // @ game+0x9b7aba0
	float GetStealthMeterTargetTime(); // Function FortniteAI.FortAthenaAlertStateComponent.GetStealthMeterTargetTime // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6af46b8
	float GetStealthMeterTarget(); // Function FortniteAI.FortAthenaAlertStateComponent.GetStealthMeterTarget // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7ebceb8
};
...
struct UFortPawnComponent_AIBotPingCommand : UFortPawnComponent_PingCommand {
	...
	void OnServerMarkerRemoved(struct FMarkerID MarkerID); // Function FortniteAI.FortPawnComponent_AIBotPingCommand.OnServerMarkerRemoved // (Final|Native|Public) // @ game+0x9b7ab18
	void OnServerMarkerAdded(struct FFortWorldMarkerData& MarkerData); // Function FortniteAI.FortPawnComponent_AIBotPingCommand.OnServerMarkerAdded // (Final|Native|Public|HasOutParms) // @ game+0x9b7aa64
	void HandleOnNPCUnconvertEvent(struct AFortPawn* UnconvertedFortPawn, enum class EUnconvertReason UnconvertReason); // Function FortniteAI.FortPawnComponent_AIBotPingCommand.HandleOnNPCUnconvertEvent // (Final|Native|Public) // @ game+0x9b7963c
};
...
struct UFortPawnComponent_AIFormation : UFortPawnComponent {
	...
	void OnUserDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortPawnComponent_AIFormation.OnUserDied // (Final|Native|Private|HasDefaults) // @ game+0x9b7ac9c
};
...
struct UFortPawnComponent_AIGroup : UFortPawnComponent {
	...
	void OnGroupMemberDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortPawnComponent_AIGroup.OnGroupMemberDied // (Final|Native|Private|HasDefaults) // @ game+0x9b7a39c
};
...
struct AFortAthenaPatrolPath : AActor {
	...
	int32_t CurrentConcurrentUsage; // 0x3c8(0x04)
	char pad_3CC[0x4]; // 0x3cc(0x04)
	struct FScalableFloat MaxLifetimeUsage; // 0x3d0(0x28)
	float DebugLinkWidthSelected; // 0x3f8(0x04)
	float DebugLinkWidthNotSelected; // 0x3fc(0x04)
	struct FLinearColor DebugNotSelectedColor; // 0x400(0x10)
	char pad_410_0 : 1; // 0x410(0x01)
	char bIsPatrolPathEnabled : 1; // 0x410(0x01)
	char pad_410_2 : 6; // 0x410(0x01)
	char pad_411[0x3f]; // 0x411(0x3f)

	void SetPatrolPathEnabled(bool bIsEnabled); // Function FortniteAI.FortAthenaPatrolPath.SetPatrolPathEnabled // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9c1d90c
	void OnCurrentPlaylistLoaded(struct FName PlaylistName, struct FGameplayTagContainer& PlaylistContextTags); // Function FortniteAI.FortAthenaPatrolPath.OnCurrentPlaylistLoaded // (Final|Native|Protected|HasOutParms) // @ game+0x9c1c424
	void GetPatrolPoints(struct TArray<struct AFortAthenaPatrolPoint*>& OutPatrolPoints); // Function FortniteAI.FortAthenaPatrolPath.GetPatrolPoints // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1b348
	bool CanBeUsed(); // Function FortniteAI.FortAthenaPatrolPath.CanBeUsed // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1ad8c
};

// Class FortniteAI.FortCreativePatrolPath
// Size: 0x468 (Inherited: 0x450)
struct AFortCreativePatrolPath : AFortAthenaPatrolPath {
	enum class EFortCreativePatrolPathGroup PatrolPathGroup; // 0x450(0x01)
	char pad_451[0x7]; // 0x451(0x07)
	struct ABuildingActor* CreativePathRenderer; // 0x458(0x08)
	char pad_460[0x8]; // 0x460(0x08)

	void SetPatrolHasValidNavMesh(bool bValidNavMesh); // Function FortniteAI.FortCreativePatrolPath.SetPatrolHasValidNavMesh // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9b7b260
	bool HasPatrolValidNavMesh(); // Function FortniteAI.FortCreativePatrolPath.HasPatrolValidNavMesh // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9b796f8
};
...
struct UFortAthenaAIBotCosmeticData : UDataAsset {
	...
	struct TSoftObjectPtr<UFortAthenaAIBotCosmeticLibraryData> FindLibraryDataFromName(struct FString PartialName); // Function FortniteAI.FortAthenaAIBotCosmeticData.FindLibraryDataFromName // (Final|Native|Public|BlueprintCallable) // @ game+0x9b78e04
};
...
struct UFortAthenaAIBotCosmeticLibraryData : UPrimaryDataAsset {
	...
	struct TArray<struct UDataTable*> RetrieveDataTables(); // Function FortniteAI.FortAthenaAIBotCosmeticLibraryData.RetrieveDataTables // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9b7b1ec
	struct UDataTable* FindDataTableFromAssetType(struct FString AssetType); // Function FortniteAI.FortAthenaAIBotCosmeticLibraryData.FindDataTableFromAssetType // (Final|Native|Public|BlueprintCallable) // @ game+0x9b78ca0
	bool FillDataTableValuesFromSourceLibrary(struct UFortAthenaAIBotCosmeticLibraryData* SourceLibrary); // Function FortniteAI.FortAthenaAIBotCosmeticLibraryData.FillDataTableValuesFromSourceLibrary // (Final|Native|Public|BlueprintCallable) // @ game+0x9b78b08
};
...
struct UBotCosmeticBlueprintHelperLibrary : UBlueprintFunctionLibrary {
	...
	bool SplitDataArrayByType(struct TArray<struct FString>& InAssetNames, struct TArray<struct FString>& InAssetTypes, struct TArray<int32_t>& InAssetUsageCounts, struct TArray<int32_t>& InAssetTypeSplitIndices, int32_t CurrentSplitIndex, struct FString& OutAssetType, struct TArray<struct FString>& OutAssetNames, struct TArray<int32_t>& OutAssetUsageCounts); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.SplitDataArrayByType // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9b7b364
	struct TArray<struct FString> OpenCSVFileDialog(struct FString TitleDetails, bool bAllowMultipleFiles); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.OpenCSVFileDialog // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x9b7b044
	bool LoadDataFromCSV(struct FString FilePath, struct TArray<struct FString>& ForbiddenAssetNames, struct TArray<struct FString>& ForbiddenAssetPrefix, struct TArray<struct FString>& AssetNames, struct TArray<struct FString>& AssetTypes, struct TArray<int32_t>& AssetUsageCounts, struct TArray<int32_t>& AssetTypeSplitIndices); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.LoadDataFromCSV // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9b79ea0
	bool GenerateWeightedCSV(struct FString AssetTypeName, struct TArray<struct FString>& AssetNames, struct TArray<int32_t>& AssetWeight, struct FString& CSV); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.GenerateWeightedCSV // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9b78fc8
	bool ExportDataTableToSourceCSV(struct UDataTable* DataTable, bool bCanCheckOutFile); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.ExportDataTableToSourceCSV // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x9b78a5c
};
...
struct UFortAthenaAIBotCustomizationData : UPrimaryDataAsset {
	...
	void SetCharacterCustomizationFromPlayerPawn(struct AFortPlayerPawn* InFortPawn); // Function FortniteAI.FortAthenaAIBotCustomizationData.SetCharacterCustomizationFromPlayerPawn // (Final|Native|Public|BlueprintCallable) // @ game+0x9b96ae4
};
...
struct UFortAthenaAIBotEvaluator_Attack : UFortAthenaAIBotEvaluator_Movement {
	...
	struct FName MoveToDestinationKeyName; // 0x220(0x04)
	struct FName TargetActorName; // 0x224(0x04)
...
struct UFortAthenaAIBotEvaluator_Converted : UFortAthenaAIBotEvaluator_Movement {
	...
	void OnUnconvertedEvent(struct AFortPawn* UnconvertedPawn, enum class EUnconvertReason UnconvertReason); // Function FortniteAI.FortAthenaAIBotEvaluator_Converted.OnUnconvertedEvent // (Final|Native|Protected) // @ game+0x9b96a30
	void OnConvertedEvent(struct AFortPawn* InstigatorPawn, struct AFortPawn* ConvertedPawn); // Function FortniteAI.FortAthenaAIBotEvaluator_Converted.OnConvertedEvent // (Final|Native|Protected) // @ game+0x9b968ac
};
...
struct UFortAthenaAIBotEvaluator_DBNO : UFortAthenaAIBotEvaluator_Movement {
	...
	void OnAllyPawnDBNOStateChanged(struct AFortPawn* InPlayer, bool bInIsDBNO); // Function FortniteAI.FortAthenaAIBotEvaluator_DBNO.OnAllyPawnDBNOStateChanged // (Final|Native|Private) // @ game+0x9b967e4
};
...
struct UFortAthenaAIBotEvaluator_EvasiveManeuvers : UFortAthenaAIBotEvaluator {
	...
	void OnMoveCompleted(struct FAIRequestID RequestId, enum class EPathFollowingResult MovementResult); // Function FortniteAI.FortAthenaAIBotEvaluator_EvasiveManeuvers.OnMoveCompleted // (Final|Native|Public) // @ game+0x9b9696c
};
...
struct UFortAthenaAIBotEvaluator_Heal : UFortAthenaAIBotEvaluator {
	...
	bool bAllowEvaluationRetry; // 0xe8(0x01)
	char pad_E9[0x7]; // 0xe9(0x07)
	struct UFortAthenaAIBotHealingDigestedSkillSet* HealingSkillSet; // 0xf0(0x08)
	char pad_F8[0x8]; // 0xf8(0x08)

	void HandlePlayerHealthOrShieldChanged(); // Function FortniteAI.FortAthenaAIBotEvaluator_Heal.HandlePlayerHealthOrShieldChanged // (Final|Native|Private) // @ game+0x9b967d0
};
...
struct UFortAthenaAIBotEvaluator_MeleeAttack : UFortAthenaAIBotEvaluator_Attack {
	...
	struct FName WeaponTriggerMeleeName; // 0x234(0x04)
	struct FName ThrowableAttacksAllowedName; // 0x238(0x04)
	struct FName TraversalBlockMeleeAttackName; // 0x23c(0x04)
	char pad_240[0x8]; // 0x240(0x08)
	struct UFortAthenaAIBotAttackingDigestedSkillSet* AttackingSkillSet; // 0x248(0x08)
...
struct UFortAthenaAIBotEvaluator_RangeAttack : UFortAthenaAIBotEvaluator_Attack {
	struct FName WeaponReloadName; // 0x230(0x04)
	struct FName WeaponFireName; // 0x234(0x04)
	struct FName RangeAttackIsReadyToFireName; // 0x238(0x04)
	struct FName WeaponTargetingName; // 0x23c(0x04)
	struct FName AggressivenessName; // 0x240(0x04)
	struct FName HasLoSOnThreatName; // 0x244(0x04)
	struct FName UrgentMovementKeyName; // 0x248(0x04)
	char pad_24C[0x7]; // 0x24c(0x07)
	bool bAlwaysAllowTargetingEvaluation; // 0x253(0x01)
	bool bSkipADSEvaluation; // 0x254(0x01)
	bool bConsiderLoF; // 0x255(0x01)
	char pad_256[0x2]; // 0x256(0x02)
	float RangeReachHysteresisRatio; // 0x258(0x04)
	char pad_25C[0x1c]; // 0x25c(0x1c)
	struct UFortAthenaAIBotRangeAttackDigestedSkillSet* CacheRangeAttackDigestedSkillSet; // 0x278(0x08)
	struct UFortAthenaAIBotAimingDigestedSkillSet* CacheAimingDigestedSkillSet; // 0x280(0x08)
	struct UFortAthenaAIBotPerceptionDigestedSkillSet* CachePerceptionDigestedSkillSet; // 0x288(0x08)
	struct UFortAthenaAIBotAttackingDigestedSkillSet* CacheAttackingDigestedSkillSet; // 0x290(0x08)
	struct UAthenaAIServiceLOFOccluder* CacheLOFOccluderTracker; // 0x298(0x08)
	struct AActor* ExcludeReachingTarget; // 0x2a0(0x08)
	char pad_2A8[0x38]; // 0x2a8(0x38)
	struct AActor* CachedLastMoveToRangeTarget; // 0x2e0(0x08)
...
struct UFortAthenaAIBotEvaluator_Retreat : UFortAthenaAIBotEvaluator_Movement {
	...
	void HandlePlayerHealthOrShieldChanged(); // Function FortniteAI.FortAthenaAIBotEvaluator_Retreat.HandlePlayerHealthOrShieldChanged // (Final|Native|Protected) // @ game+0x9bb18d8
};
...
struct UFortAthenaAIBotEvaluator_SandTunnel : UFortAthenaAIBotEvaluator_TagQuery {
	...
	void OnBotControllerAlertLevelChanged(struct AFortAthenaAIBotController* BotController, enum class EAlertLevel OldAlertLevel, enum class EAlertLevel NewAlertLevel); // Function FortniteAI.FortAthenaAIBotEvaluator_SandTunnel.OnBotControllerAlertLevelChanged // (Final|Native|Private) // @ game+0x9bb1900
	void Jump(); // Function FortniteAI.FortAthenaAIBotEvaluator_SandTunnel.Jump // (Final|Native|Protected) // @ game+0x9bb18ec
};
...
struct UFortAthenaAIBotEvaluator_SmartObjects : UFortAthenaAIBotEvaluator_Movement {
	...
	struct FName SmartObjectRequestEvaluateKeyName; // 0x238(0x04)
...
struct UFortAthenaAIBotEvaluator_Storm : UFortAthenaAIBotEvaluator_Movement {
	...
	void OnSafezoneStateChanged(enum class EFortSafeZoneState NewState); // Function FortniteAI.FortAthenaAIBotEvaluator_Storm.OnSafezoneStateChanged // (Final|Native|Public) // @ game+0x9bb1a98
	void OnSafeZonePhaseChanged(); // Function FortniteAI.FortAthenaAIBotEvaluator_Storm.OnSafeZonePhaseChanged // (Final|Native|Public) // @ game+0x9bb1a84
};
...
struct UFortAthenaAIBotEvaluator_ThrowableAttack : UFortAthenaAIBotEvaluator_Attack {
	struct FName WeaponTriggerThrowableName; // 0x230(0x04)
	struct FName ThrowableAttackIsReadyToThrowName; // 0x234(0x04)
	char pad_238[0x8]; // 0x238(0x08)
	...
	struct UFortWorldItem* ChosenWeapon; // 0x258(0x08)
...
struct UFortAthenaAIBotPathFollowingComponent : UFortPathFollowingComponentBase {
	...
	void HandlePawnTeleported(struct AFortPawn* TeleportedPawn); // Function FortniteAI.FortAthenaAIBotPathFollowingComponent.HandlePawnTeleported // (Final|Native|Public) // @ game+0x9bdb7f4
};
...
struct UFortAthenaAIBotRangeAttackDigestedSkillSet : UFortAthenaAIBotDigestedSkillSet {
	...
	float ShootingMaxRadiusAround; // 0xcc(0x04)
	float ShootingNextQueryCooldown; // 0xd0(0x04)
	int32_t CoverPeekCountMin; // 0xd4(0x04)
	int32_t CoverPeekCountMax; // 0xd8(0x04)
	char pad_DC[0x4]; // 0xdc(0x04)
};
...
struct UFortAthenaAIEvaluator_DormantUntilPhase : UFortAthenaAIEvaluator {
	...
	void HandleGamePhaseStepChanged(struct TScriptInterface<IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep); // Function FortniteAI.FortAthenaAIEvaluator_DormantUntilPhase.HandleGamePhaseStepChanged // (Final|Native|Private|HasOutParms) // @ game+0x9bdb714
};
...
struct UFortAthenaAILODComponent : UActorComponent {
	...
	void OnRep_CurrentFortAILODLevel(); // Function FortniteAI.FortAthenaAILODComponent.OnRep_CurrentFortAILODLevel // (Final|Native|Private) // @ game+0x23b160c
};
...
struct UFortAthenaAIRuntimeParameters_SmartObjectBase : UFortAthenaAIRuntimeParameters {
	...
	struct FSmartObjectRequestResult SelectedResult; // 0x7c(0x0c)
	float LastSelectedSmartObjectTimestamp; // 0x88(0x04)
	struct FSmartObjectClaimHandle ClaimedHandle; // 0x8c(0x10)
	char pad_9C[0x4]; // 0x9c(0x04)
	struct UGameplayBehaviorConfig* BehaviorConfig; // 0xa0(0x08)
	struct UGameplayBehavior* GameplayBehavior; // 0xa8(0x08)
	struct UGameplayInteractionSmartObjectBehaviorDefinition* GameplayInteractionBehaviorDefinition; // 0xb0(0x08)
	float GlobalSmartObjectLastUseTimestamp; // 0xb8(0x04)
	float GlobalSmartObjectCooldown; // 0xbc(0x04)
	int32_t ActivitiesIDCount; // 0xc0(0x04)
	char pad_C4[0x4]; // 0xc4(0x04)

	void SetChooseClosestSmartObject(bool bInChooseClosestSmartObject); // Function FortniteAI.FortAthenaAIRuntimeParameters_SmartObjectBase.SetChooseClosestSmartObject // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9bdbd84
	bool GetChooseClosestSmartObject(); // Function FortniteAI.FortAthenaAIRuntimeParameters_SmartObjectBase.GetChooseClosestSmartObject // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bda798
};
...
struct UFortAthenaAISpawnerDataComponentList : UObject {
	...
	struct UFortAthenaAISpawnerDataComponentList* OverrideComponentClass(struct UFortAthenaAISpawnerDataComponent* NewComponentSubClass); // Function FortniteAI.FortAthenaAISpawnerDataComponentList.OverrideComponentClass // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdba20
	struct UFortAthenaAISpawnerDataComponentList* OverrideComponent(struct UFortAthenaAISpawnerDataComponent* NewComponent); // Function FortniteAI.FortAthenaAISpawnerDataComponentList.OverrideComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9bdb990
	struct UFortAthenaAISpawnerDataComponent* GetOrCreateComponentClassForModification(struct UObject* ComponentOuter, struct UFortAthenaAISpawnerDataComponent* ClassToClone); // Function FortniteAI.FortAthenaAISpawnerDataComponentList.GetOrCreateComponentClassForModification // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdb1b4
	struct TArray<struct UFortAthenaAISpawnerDataComponent*> GetList(); // Function FortniteAI.FortAthenaAISpawnerDataComponentList.GetList // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdafe4
};
...
struct UFortAthenaAISpawnerDataComponent_AffiliationBase : UFortAthenaAISpawnerDataComponent {
	...
	void SetFullTeamAwarenessPropagationDistance(float InFullTeamAwarenessMaxDistance); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.SetFullTeamAwarenessPropagationDistance // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdc0f4
	void SetFullTeamAwarenessPropagation(bool bInFullTeamAwarenessPropagation); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.SetFullTeamAwarenessPropagation // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdc070
	void SetFactionTags(struct FGameplayTagContainer& NewTags); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.SetFactionTags // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9bdbebc
	void SetAwarenessPropagationIsBasedOnAlertLevel(bool bInAwarenessPropagationIsBasedOnAlertLevel); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.SetAwarenessPropagationIsBasedOnAlertLevel // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdbb58
	bool GetFullTeamAwarenessPropagation(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.GetFullTeamAwarenessPropagation // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdad18
	float GetFullTeamAwarenessMaxDistance(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.GetFullTeamAwarenessMaxDistance // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7a79824
	struct FGameplayTagContainer GetFactionTag(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.GetFactionTag // (Final|Native|Public|BlueprintCallable) // @ game+0x69233ec
	bool GetAwarenessPropagationIsBasedOnAlertLevel(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.GetAwarenessPropagationIsBasedOnAlertLevel // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bda6b8
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotAffiliation : UFortAthenaAISpawnerDataComponent_AffiliationBase {
	...
	void SetOverrideTeamIndex(int32_t InOverrideTeamIdx); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotAffiliation.SetOverrideTeamIndex // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdc5c0
	bool GetTeamID(int32_t& OutTeamId); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotAffiliation.GetTeamID // (Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bdb5fc
	bool GetSquadID(int32_t& OutSquadId); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotAffiliation.GetSquadID // (Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bdb55c
};
...
struct UFortAthenaAIRuntimeParameters_BehaviorTreeControl : UFortAthenaAIRuntimeParameters {
	...
	bool IsBehaviorTreeBranchActive(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAIRuntimeParameters_BehaviorTreeControl.IsBehaviorTreeBranchActive // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdb870
	void EnableBehaviorTreeBranch(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAIRuntimeParameters_BehaviorTreeControl.EnableBehaviorTreeBranch // (Final|Native|Public|BlueprintCallable) // @ game+0x9bda34c
	void DisableBehaviorTreeBranch(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAIRuntimeParameters_BehaviorTreeControl.DisableBehaviorTreeBranch // (Final|Native|Public|BlueprintCallable) // @ game+0x9bda244
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotBehavior : UFortAthenaAISpawnerDataComponent_Behavior {
	...
	bool IsBehaviorTreeBranchActive(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotBehavior.IsBehaviorTreeBranchActive // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdb900
	void EnableBehaviorTreeBranch(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotBehavior.EnableBehaviorTreeBranch // (Final|Native|Public|BlueprintCallable) // @ game+0x9bda3cc
	void DisableBehaviorTreeBranch(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotBehavior.DisableBehaviorTreeBranch // (Final|Native|Public|BlueprintCallable) // @ game+0x9bda2c8
};
...
struct UFortAthenaAISpawnerDataComponent_CosmeticBase : UFortAthenaAISpawnerDataComponent {
	...
	void GetFallbackTag(struct FGameplayTag& OutFallbackTag); // Function FortniteAI.FortAthenaAISpawnerDataComponent_CosmeticBase.GetFallbackTag // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9bdac60
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotCosmeticBase : UFortAthenaAISpawnerDataComponent_CosmeticBase {
	...
	void GetLoadout(struct FFortAthenaLoadout& OutLoadout); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetLoadout // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9bdb058
	void GetDances(struct TArray<struct UAthenaDanceItemDefinition*>& Dances, struct AFortAthenaAIBotController* BotController); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetDances // (Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9bdaa74
	void GetCustomCharacterParts(struct TArray<struct UCustomCharacterPart*>& OutCustomCharacterParts); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetCustomCharacterParts // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9bda9d4
	void GetAnimBPOverride(struct UAnimInstance*& OutAnimBPOverride, int32_t& OutPriority); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetAnimBPOverride // (Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9bda5d8
	void GetAllLoadouts(struct TArray<struct FFortAthenaLoadout>& OutLoadouts); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetAllLoadouts // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9bda53c
};
...
struct UFortAthenaAIRuntimeParameters_AIConvert : UFortAthenaAIRuntimeParameters {
	...
	void SetForceKillWhenUnconverted(bool bInForceKillWhenUnconverted); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.SetForceKillWhenUnconverted // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdbff4
	void SetForceKillWhenConverterDies(bool bInForceKillWhenConverterDies); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.SetForceKillWhenConverterDies // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdbf78
	void SetCanBeConvertedFromDBNO(bool bInCanBeConvertedFromDBNO); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.SetCanBeConvertedFromDBNO // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdbd08
	void SetCanBeConverted(bool bInCanBeConverted); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.SetCanBeConverted // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdbbe4
	bool GetForceKillWhenUnconverted(); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.GetForceKillWhenUnconverted // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdad04
	bool GetForceKillWhenConverterDies(); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.GetForceKillWhenConverterDies // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdacf0
	bool GetCanBeConvertedFromDBNO(); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.GetCanBeConvertedFromDBNO // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bda748
	bool GetCanBeConverted(); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.GetCanBeConverted // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bda734
};
...
struct UFortAthenaAIRuntimeParameters_AIBotConvert : UFortAthenaAIRuntimeParameters_AIConvert {
	char bShouldLeashFollowConverter : 1; // 0xf8(0x01)
	char bShouldScanAroundWhenWaiting : 1; // 0xf8(0x01)
	char bShouldMoveTowardsConverter : 1; // 0xf8(0x01)
	char bShouldTeleportTowardsConverter : 1; // 0xf8(0x01)
	char bCanDanceWithConverter : 1; // 0xf8(0x01)
	char pad_F8_5 : 3; // 0xf8(0x01)
	char pad_F9[0x3]; // 0xf9(0x03)
	float SkillLevelOverride; // 0xfc(0x04)
	float PreConversionSkillLevel; // 0x100(0x04)
	float InnerLeashRadius; // 0x104(0x04)
	float OuterLeashRadius; // 0x108(0x04)
	char pad_10C[0x4]; // 0x10c(0x04)
	struct UFortAthenaAIRuntimeParameters_Leash* PreConversionLeashParams; // 0x110(0x08)
	float LeashFollowActorUpdateRate; // 0x118(0x04)
	char pad_11C[0x4]; // 0x11c(0x04)
	struct FVector LeashFollowActorLocalOffset; // 0x120(0x18)
	float MoveTowardsConverterInnerDistanceSq; // 0x138(0x04)
	float MoveTowardsConverterOuterDistanceSq; // 0x13c(0x04)
	float TeleportTowardsConverterDistanceSq; // 0x140(0x04)
	float MinDistanceFromConverterWhenTeleported; // 0x144(0x04)
	struct TArray<struct UFortAthenaAIBotSkillSet*> ConvertedSkillSetClasses; // 0x148(0x10)
	struct TArray<struct UFortAthenaAIBotSkillSet*> PreConversionSkillSetClasses; // 0x158(0x10)
};
...
struct UFortAthenaAISpawnerDataComponent_GameplayBase : UFortAthenaAISpawnerDataComponent {
	...
	bool bEnableDBNO; // 0x2b8(0x01)
	enum class TInteractionType DBNOInteractionType; // 0x2b9(0x01)
	char pad_2BA[0x2]; // 0x2ba(0x02)
	float DBNOInteractionDuration; // 0x2bc(0x04)
	bool bOnlyLeaderInteraction; // 0x2c0(0x01)
	char pad_2C1[0x7]; // 0x2c1(0x07)

	bool ShouldOverrideGlobalSpeedMultiplier(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.ShouldOverrideGlobalSpeedMultiplier // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x7ea98e0
	void SetCopyConverterSpecificRelations(bool bInCopyConverterSpecificRelations); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.SetCopyConverterSpecificRelations // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdbe08
	void SetCanBeConverted(bool bInCanBeConverted); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.SetCanBeConverted // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdbc60
	void PostOnSpawnedBP(struct APawn* PawnAI); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.PostOnSpawnedBP // (Event|Public|BlueprintEvent|Const) // @ game+0xdef49c
	float GetGlobalSpeedMultiplier(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.GetGlobalSpeedMultiplier // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bdadac
};

// Class FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay
// Size: 0x5c8 (Inherited: 0x2c8)
struct UFortAthenaAISpawnerDataComponent_AIBotGameplay : UFortAthenaAISpawnerDataComponent_GameplayBase {
	struct UFortBotNameSettings* NameSettings; // 0x2c8(0x08)
	char bRequiresUniqueNetId : 1; // 0x2d0(0x01)
	...
	float PawnCullDistanceAfterPlayerAggroMode; // 0x350(0x04)
	enum class EReachLocationValidationMode ReachLocationValidationMode; // 0x354(0x01)
	char pad_355[0x3]; // 0x355(0x03)
	struct FVector LeashLocation; // 0x358(0x18)
	float LeashInnerRadius; // 0x370(0x04)
	float LeashOuterRadius; // 0x374(0x04)
	bool bCheckForReachabilityOnRandomLocationGeneration; // 0x378(0x01)
	enum class ELeashReturnLocationMode LeashReturnLocationMode; // 0x379(0x01)
	char pad_37A[0x6]; // 0x37a(0x06)
	struct AFortAthenaPatrolPath* AssociatedPatrolPath; // 0x380(0x08)
	bool bCanInvestigateWithMeleeWeapon; // 0x388(0x01)
	bool bApplyMutatorsHealthAndShieldModifiers; // 0x389(0x01)
	bool bSupportsTethering; // 0x38a(0x01)
	bool bEnableRenderCustomDepth; // 0x38b(0x01)
	bool bDisableGiveWeaponCheat; // 0x38c(0x01)
	bool bDisableGiveMaterialsCheat; // 0x38d(0x01)
	...
	struct FScalableFloat ShouldMoveTowardsConverter; // 0x498(0x28)
	struct FScalableFloat ShouldTeleportTowardsConverter; // 0x4c0(0x28)
	struct FScalableFloat MoveTowardsConverterInnerRadius; // 0x4e8(0x28)
	struct FScalableFloat MoveTowardsConverterOuterRadius; // 0x510(0x28)
	struct FScalableFloat CanDanceWithConverter; // 0x538(0x28)
	struct FScalableFloat TeleportTowardsConverterDistance; // 0x560(0x28)
	struct FScalableFloat MinDistanceFromConverterWhenTeleported; // 0x588(0x28)
	struct TArray<struct UFortAthenaAIBotSkillSet*> ConvertedSkillSetClasses; // 0x5b0(0x10)
	char pad_5C0[0x8]; // 0x5c0(0x08)

	void SetNameSettings(enum class EBotNamingMode InNamingMode, struct FString InName, bool bInAddPlayerIDSuffix); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetNameSettings // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdc3c4
	void SetLeashOuterRadius(float InLeashOuterRadius); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetLeashOuterRadius // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdc284
	void SetLeashLocation(struct FVector InLeashLocation); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetLeashLocation // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x9bdc1fc
	void SetLeashInnerRadius(float InLeashInnerRadius); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetLeashInnerRadius // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdc178
	void SetAssociatedPatrolPath(struct AFortAthenaPatrolPath* InAssociatedPatrolPath); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetAssociatedPatrolPath // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdbad8
};
...
struct UFortAthenaAISpawnerDataComponent_GameplayAbilityBase : UFortAthenaAISpawnerDataComponent {
	...
	void SetLooseTagsToApplyToPawn(struct FGameplayTagContainer& InGameplayTagContainer); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayAbilityBase.SetLooseTagsToApplyToPawn // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9bdc308
	struct FGameplayTagContainer GetLooseTagsToApplyToPawn(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayAbilityBase.GetLooseTagsToApplyToPawn // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bdb120
	void GetInitialGameplayEffects(struct TArray<struct FInitialGameplayEffectInfo>& OutGEs); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayAbilityBase.GetInitialGameplayEffects // (Native|Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bdaf0c
	void GetInitialGameplayAbilities(struct TArray<struct UFortAbilitySet*>& OutGASets); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayAbilityBase.GetInitialGameplayAbilities // (Native|Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bdae6c
};
...
struct UFortAthenaAISpawnerDataComponent_InventoryBase : UFortAthenaAISpawnerDataComponent {
	...
	bool bDeathTagsCanBlockLootDrop; // 0x98(0x01)
	bool bUseDefenderInventoryManagement; // 0x99(0x01)
	char pad_9A[0x6]; // 0x9a(0x06)

	void GetInventoryItems(struct TArray<struct FItemAndCount>& OutList); // Function FortniteAI.FortAthenaAISpawnerDataComponent_InventoryBase.GetInventoryItems // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9bdae6c
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotInventory : UFortAthenaAISpawnerDataComponent_InventoryBase {
	...
	void SetInventoryItems(struct TArray<struct FItemAndCount>& InItems); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotInventory.SetInventoryItems // (Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9bdaf0c
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotPerception : UFortAthenaAISpawnerDataComponent_PerceptionBase {
	...
	void SetVisibilityRange(float InSightRadius, float LoseSightRadius); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotPerception.SetVisibilityRange // (Final|Native|Public|BlueprintCallable) // @ game+0x9bdc6c0
};
...
struct UFortAthenaAISpawnerDataComponent_AIGameplay : UFortAthenaAISpawnerDataComponent_GameplayBase {
	float MoveSoundStimulusBroadcastInterval; // 0x2c8(0x04)
	float MaxMoveSoundRange; // 0x2cc(0x04)
	char bGenerateSoundInAllMovementModes : 1; // 0x2d0(0x01)
	char pad_2D0_1 : 7; // 0x2d0(0x01)
	char pad_2D1[0x7]; // 0x2d1(0x07)
	struct FScalableFloat DefaultLifespanAfterDeath; // 0x2d8(0x28)
	enum class EFortAthenaAISpawnerDataComponentTriBool IsAlwaysGameplayRelevantOverride; // 0x300(0x01)
...
struct UFortAthenaAISpawnerDataComponent_CosmeticLibrary : UFortAthenaAISpawnerDataComponent_AIBotCosmeticBase {
	...
	int32_t GetAICosmeticLibraryDataIndex(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_CosmeticLibrary.GetAICosmeticLibraryDataIndex // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bda4a4
	struct UFortAthenaAIBotCosmeticLibraryData* GetAICosmeticLibraryData(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_CosmeticLibrary.GetAICosmeticLibraryData // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bda47c
};
...
struct UFortAthenaAISpawnerDataComponent_CosmeticLoadout : UFortAthenaAISpawnerDataComponent_AIBotCosmeticBase {
	...
	struct TArray<struct UCustomCharacterPart*> CustomCharacterParts; // 0x1b8(0x10)
	bool bCanShowDefaultSkin; // 0x1c8(0x01)
	char pad_1C9[0x3]; // 0x1c9(0x03)
	struct FGameplayTag FallbackTag; // 0x1cc(0x04)
	struct UAnimInstance* AnimBPOverride; // 0x1d0(0x08)
	int32_t AnimBPOverridePriority; // 0x1d8(0x04)
...
struct UFortAthenaAISpawnerDataComponent_SpawnParamsBase : UFortAthenaAISpawnerDataComponent {
	...
	bool ShouldSpawnInAir(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.ShouldSpawnInAir // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x28922a8
	bool ShouldCheckForOverlaps(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.ShouldCheckForOverlaps // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bdc78c
	float GetSpawnTracePadding(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetSpawnTracePadding // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bdb4b8
	struct TArray<struct UFortAthenaAISpawnerData*> GetSpawnerDataSpawnedAsChildren(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetSpawnerDataSpawnedAsChildren // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bdb4e4
	struct FDataTableRowHandle GetPawnStatHandle(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetPawnStatHandle // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bdb2a8
	struct APawn* GetPawnClass(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetPawnClass // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bdb278
	float GetInAirSpawnTraceStartHeight(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetInAirSpawnTraceStartHeight // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bdae40
	float GetInAirSpawnTraceSphereRadius(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetInAirSpawnTraceSphereRadius // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bdadac
	float GetInAirSpawnTraceEndHeight(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetInAirSpawnTraceEndHeight // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bdae14
	struct AAIController* GetAIControllerClass(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetAIControllerClass // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9bda44c
};
...
struct UFortAthenaBTService_ManageWeapon : UBTService {
	...
	void ManageWeaponTargeting(struct UBehaviorTreeComponent* OwnerComp); // Function FortniteAI.FortAthenaBTService_ManageWeapon.ManageWeaponTargeting // (Final|Native|Protected|Const) // @ game+0x9bf6068
};
...
struct UFortAthenaBTService_Slide : UBTService {
	...
	void OnStopSliding(struct AFortPlayerPawn* Pawn); // Function FortniteAI.FortAthenaBTService_Slide.OnStopSliding // (Final|Native|Private) // @ game+0x9bf6188
};
...
struct UFortAthenaBTService_SmartObject : UBTService {
	...
	struct FName SmartObjectRequestEvaluateKeyName; // 0x78(0x04)
	char pad_7C[0x4]; // 0x7c(0x04)
};
...
// Class FortniteAI.FortAthenaBTTask_RunDynamicSubtree
// Size: 0x90 (Inherited: 0x88)
...
struct UFortAthenaBTTask_UseSmartObject : UBTTaskNode {
	...
	char pad_74[0x2c]; // 0x74(0x2c)
	struct FGameplayInteractionContext GameplayInteractionContext; // 0xa0(0x60)
};
...
struct UFortAthenaLeashComponent : UActorComponent {
	...
	void SetLeashRadius(float NewRadius); // Function FortniteAI.FortAthenaLeashComponent.SetLeashRadius // (Final|Native|Public|BlueprintCallable) // @ game+0x9bf624c
	bool IsInsideLeash(struct FVector& Location); // Function FortniteAI.FortAthenaLeashComponent.IsInsideLeash // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bf5fd4
	float GetLeashRadius(); // Function FortniteAI.FortAthenaLeashComponent.GetLeashRadius // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bf5fa0
	struct FVector GetLeashCenter(); // Function FortniteAI.FortAthenaLeashComponent.GetLeashCenter // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9bf5f78
};
...
struct AFortAthenaLocalGameplayBehavior : AActor {
	...
	void OnExecute(struct AActor* Activator); // Function FortniteAI.FortAthenaLocalGameplayBehavior.OnExecute // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void OnAbort(); // Function FortniteAI.FortAthenaLocalGameplayBehavior.OnAbort // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void FinishExecute(); // Function FortniteAI.FortAthenaLocalGameplayBehavior.FinishExecute // (Final|Native|Public|BlueprintCallable) // @ game+0x9bf5f20
};
...
struct UFortAthenaNpcGalileoComponent : UActorComponent {
	...
	void SetPatrolPath(struct TArray<struct FVector>& NewPatrolPath); // Function FortniteAI.FortAthenaNpcGalileoComponent.SetPatrolPath // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9c1d7a0
	void SetCommunicationGroup(struct TArray<struct AFortAthenaAIBotController*>& AIBotControllerList); // Function FortniteAI.FortAthenaNpcGalileoComponent.SetCommunicationGroup // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9c1d604
	void OnPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaNpcGalileoComponent.OnPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x9c1cb90
	struct TArray<struct FVector> GetPatrolPath(); // Function FortniteAI.FortAthenaNpcGalileoComponent.GetPatrolPath // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1b32c
	struct TArray<struct AFortAthenaAIBotController*> GetCommunicationGroup(); // Function FortniteAI.FortAthenaNpcGalileoComponent.GetCommunicationGroup // (Final|Native|Public|BlueprintCallable) // @ game+0x9c1b200
};
...
struct UFortAthenaNpcPatrollingComponent : UActorComponent {
	...
	void UpdateCurrentDestinationToNearestNextPoint(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.UpdateCurrentDestinationToNearestNextPoint // (Final|Native|Public|BlueprintCallable) // @ game+0x9c1dc20
	void SetPatrolPath(struct AFortAthenaPatrolPath* NewPatrolPath, bool bOrientationAlreadyRandomized); // Function FortniteAI.FortAthenaNpcPatrollingComponent.SetPatrolPath // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9c1d844
	void SelectNextPatrolPoint(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.SelectNextPatrolPoint // (Final|Native|Public|BlueprintCallable) // @ game+0x9c1d5f0
	void RemovePatrolPath(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.RemovePatrolPath // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9c1d5c8
	bool IsPatrollingEnable(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.IsPatrollingEnable // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1bb9c
	bool IsCurrentPatrolPointAnEndPoint(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.IsCurrentPatrolPointAnEndPoint // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1ba68
	int32_t GetPatrolPointsCount(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.GetPatrolPointsCount // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1b4ec
	struct AFortAthenaPatrolPath* GetPatrolPath(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.GetPatrolPath // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7cd00ac
	struct AFortAthenaPatrolPoint* GetCurrentPatrolPoint(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.GetCurrentPatrolPoint // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1b238
	bool FindAndSetDynamicPatrolPath(struct FFortAthenaAIObjectTrackerQuery& FindQuery, bool bOrientationAlreadyRandomized, bool bExcludeCurrentlyUsedPatrolPath); // Function FortniteAI.FortAthenaNpcPatrollingComponent.FindAndSetDynamicPatrolPath // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9c1aef0
};
...
struct UAthenaAIPerceptionStimuliSourceComponent : UAIPerceptionStimuliSourceComponent {
	...
	void OnOwnerTeamIndexChanged(); // Function FortniteAI.AthenaAIPerceptionStimuliSourceComponent.OnOwnerTeamIndexChanged // (Final|Native|Private) // @ game+0x9c1cb7c
};
...
struct UFortCollisionResponseSwapperComponent : UActorComponent {
	...
	void UnregisterCallbacksForOverlap(); // Function FortniteAI.FortCollisionResponseSwapperComponent.UnregisterCallbacksForOverlap // (Final|Native|Protected|BlueprintCallable) // @ game+0x165c4ec
	void RestoreCollisionResponses(); // Function FortniteAI.FortCollisionResponseSwapperComponent.RestoreCollisionResponses // (Final|Native|Protected) // @ game+0x9c1d5dc
	void RegisterCallbacksForOverlap(struct UPrimitiveComponent* InCollisionPrimitiveComponent, struct UPrimitiveComponent* InOverlapPrimitiveComponent); // Function FortniteAI.FortCollisionResponseSwapperComponent.RegisterCallbacksForOverlap // (Final|Native|Protected|BlueprintCallable) // @ game+0x165cdbc
	void HandleEndOverlap(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // Function FortniteAI.FortCollisionResponseSwapperComponent.HandleEndOverlap // (Final|Native|Protected) // @ game+0x9c1b750
	void HandleBeginOverlap(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult); // Function FortniteAI.FortCollisionResponseSwapperComponent.HandleBeginOverlap // (Final|Native|Protected|HasOutParms) // @ game+0x9c1b50c
};
...
// Class FortniteAI.FortAthenaAttachToActorStateTreeTask
// Size: 0x80 (Inherited: 0x38)
struct UFortAthenaAttachToActorStateTreeTask : UStateTreeTaskBlueprintBase {
	struct AActor* Actor; // 0x38(0x08)
	struct AActor* TargetActor; // 0x40(0x08)
	enum class EFortAthenaStateTreeTaskFeatureExecutionMode AttachExecutionMode; // 0x48(0x04)
	bool bHandleAthenaMovComponent; // 0x4c(0x01)
	bool bSetPhysicsToQueryOnlyWhileAttached; // 0x4d(0x01)
	bool bTryToAttachToSkeletalMeshOnTargetActor; // 0x4e(0x01)
	bool bChangeBaseToSkeletalMeshOnTargetActor; // 0x4f(0x01)
	...
	bool bWeldSimulatedBodiesOnAttach; // 0x53(0x01)
	struct FName AttachmentSocketName; // 0x54(0x04)
	enum class EFortAthenaStateTreeTaskFeatureExecutionMode DetachExecutionMode; // 0x58(0x04)
	bool bForceChangeBaseOnDetach; // 0x5c(0x01)
	enum class EDetachmentRule DetachmentLocationRule; // 0x5d(0x01)
	enum class EDetachmentRule DetachmentRotationRule; // 0x5e(0x01)
	enum class EDetachmentRule DetachmentScaleRule; // 0x5f(0x01)
	bool bCallModifyOnDetach; // 0x60(0x01)
	bool bHandleLaunchCharacter; // 0x61(0x01)
	bool bHasHandledLaunchCharacter; // 0x62(0x01)
	char pad_63[0x5]; // 0x63(0x05)
	struct AFortPawn* FortPawnActor; // 0x68(0x08)
	char pad_70[0x10]; // 0x70(0x10)
};

// Class FortniteAI.FortAthenaPlayInteractionStateTreeTask
// Size: 0xb0 (Inherited: 0x38)
struct UFortAthenaPlayInteractionStateTreeTask : UStateTreeTaskBlueprintBase {
	struct AActor* InteractorActor; // 0x38(0x08)
	struct AActor* InteractableActor; // 0x40(0x08)
	struct UAnimMontage* InteractorMontage; // 0x48(0x08)
	struct UAnimMontage* InteractableMontage; // 0x50(0x08)
	bool bWaitForNotifyEventToEnd; // 0x58(0x01)
	char pad_59[0x3]; // 0x59(0x03)
	struct FName NotifyEventNameToEnd; // 0x5c(0x04)
	bool bAddMotionWarpingTargets; // 0x60(0x01)
	bool bDisableCollisionBetweenActors; // 0x61(0x01)
	bool bSetMovementModeToFlying; // 0x62(0x01)
	...
	bool bStopInteractorAnimMontageOnExit; // 0x74(0x01)
	bool bStopInteractableAnimMontageOnExit; // 0x75(0x01)
	char pad_76[0x3a]; // 0x76(0x3a)

	void OnNotifyBeginReceived(struct FName NotifyName, struct FBranchingPointNotifyPayload& BranchingPointNotifyPayload); // Function FortniteAI.FortAthenaPlayInteractionStateTreeTask.OnNotifyBeginReceived // (Final|Native|Private|HasOutParms) // @ game+0x9c1ca9c
	void OnMontageEnded(struct UAnimMontage* EndedMontage, bool bInterrupted); // Function FortniteAI.FortAthenaPlayInteractionStateTreeTask.OnMontageEnded // (Final|Native|Private) // @ game+0x9c1c9d4
};
...
struct UFortAthenaPlayMontageStateTreeTask : UStateTreeTaskBlueprintBase {
	...
	bool bWaitForNotifyEventToEnd; // 0x48(0x01)
	char pad_49[0x3]; // 0x49(0x03)
	struct FName NotifyEventNameToEnd; // 0x4c(0x04)
	bool bSetMovementModeToFlying; // 0x50(0x01)
	char pad_51[0x3]; // 0x51(0x03)
	int32_t LoopsToRun; // 0x54(0x04)
	bool bLoopForever; // 0x58(0x01)
	char pad_59[0x3]; // 0x59(0x03)
	float DelayBetweenLoops; // 0x5c(0x04)
	float RandomDeviationBetweenLoops; // 0x60(0x04)
	bool bStopAnimMontageOnExit; // 0x64(0x01)
	char pad_65[0x13]; // 0x65(0x13)

	void HandleNotifyBeginReceived(struct FName NotifyName, struct FBranchingPointNotifyPayload& BranchingPointNotifyPayload); // Function FortniteAI.FortAthenaPlayMontageStateTreeTask.HandleNotifyBeginReceived // (Final|Native|Private|HasOutParms) // @ game+0x9c1b988
	void HandleMontageEnded(struct UAnimMontage* EndedMontage, bool bInterrupted); // Function FortniteAI.FortAthenaPlayMontageStateTreeTask.HandleMontageEnded // (Final|Native|Private) // @ game+0x9c1b8c0
};
...
struct UAthenaAIPopulationTracker : UAISubsystem {
	...
	void OnFortPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.AthenaAIPopulationTracker.OnFortPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x9c1c52c
	void OnAISpawned(struct APawn* Pawn, int32_t RequestId); // Function FortniteAI.AthenaAIPopulationTracker.OnAISpawned // (Final|Native|Private) // @ game+0x9c1c0e0
	void OnAgentGameOver(struct AFortAthenaAIBotController* AIBotController, struct AFortPawn* Pawn, struct AController* Instigator); // Function FortniteAI.AthenaAIPopulationTracker.OnAgentGameOver // (Final|Native|Private) // @ game+0x9c1c20c
	int32_t GetNumTotalBots(); // Function FortniteAI.AthenaAIPopulationTracker.GetNumTotalBots // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1b314
	int32_t GetNumPlayerBots(); // Function FortniteAI.AthenaAIPopulationTracker.GetNumPlayerBots // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x93aeeb8
	int32_t GetNumNonAthenaParticipantBots(); // Function FortniteAI.AthenaAIPopulationTracker.GetNumNonAthenaParticipantBots // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1b300
	int32_t GetNumAIPawn(); // Function FortniteAI.AthenaAIPopulationTracker.GetNumAIPawn // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1b2ec
	struct FAIPopulationCountSnapshot GetAIPopulationTrackerCount(); // Function FortniteAI.AthenaAIPopulationTracker.GetAIPopulationTrackerCount // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1b144
	struct TArray<struct AController*> GetAIMatchingQuery(struct FGameplayTagQuery& TagQuery); // Function FortniteAI.AthenaAIPopulationTracker.GetAIMatchingQuery // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1b030
};
...
struct UAthenaAIServiceCover : UAthenaAIService {
	...
	struct UAthenaAIServiceCover* GetAthenaAIServiceCover(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIServiceCover.GetAthenaAIServiceCover // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x9c1b180
};
...
struct UAthenaAIServiceLOFOccluder : UAthenaAIService {
	...
	void UnregisterOccluder(struct AActor* OccluderActor); // Function FortniteAI.AthenaAIServiceLOFOccluder.UnregisterOccluder // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9c1da7c
	void RegisterOccluder(struct AActor* OccluderActor, float SphereRadius); // Function FortniteAI.AthenaAIServiceLOFOccluder.RegisterOccluder // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9c1d310
	bool IsLOFOccluded(struct FVector& StartLocation, struct FVector& EndLocation); // Function FortniteAI.AthenaAIServiceLOFOccluder.IsLOFOccluded // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9c1baac
	struct UAthenaAIServiceLOFOccluder* GetAthenaAIServiceLOFOccluder(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIServiceLOFOccluder.GetAthenaAIServiceLOFOccluder // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x263d170
};
...
struct UAthenaAIServiceLoot : UAthenaAIService {
	...
	void UpdateSupplyDropStatus(); // Function FortniteAI.AthenaAIServiceLoot.UpdateSupplyDropStatus // (Final|Native|Private) // @ game+0x9c1dc48
	void UpdateMovingLoots(); // Function FortniteAI.AthenaAIServiceLoot.UpdateMovingLoots // (Final|Native|Private) // @ game+0x9c1dc34
	void OnGamePhaseStepChanged(struct TScriptInterface<IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep); // Function FortniteAI.AthenaAIServiceLoot.OnGamePhaseStepChanged // (Final|Native|Public|HasOutParms) // @ game+0x9c1c82c
	void K2_RemoveGameplayTagFromLoot(struct AActor* LootActor, struct FGameplayTag& GameplayTag); // Function FortniteAI.AthenaAIServiceLoot.K2_RemoveGameplayTagFromLoot // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9c1bec0
	void K2_AddGameplayTagToLoot(struct AActor* LootActor, struct FGameplayTag& GameplayTag); // Function FortniteAI.AthenaAIServiceLoot.K2_AddGameplayTagToLoot // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9c1bdf0
};
...
struct UAthenaAISpawner : UAISubsystem {
	...
	int32_t RequestSpawn(struct UFortAthenaAISpawnerDataComponentList* AISpawnerComponentList, struct FTransform& SpawnTransform, bool bUrgentRequest); // Function FortniteAI.AthenaAISpawner.RequestSpawn // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9c233f4
	void QueueForDespawn(struct AActor* ActorToDespawn); // Function FortniteAI.AthenaAISpawner.QueueForDespawn // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9c23374
	bool CancelRequest(int32_t RequestId); // Function FortniteAI.AthenaAISpawner.CancelRequest // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9c23274
};
...
struct UDespawnExpiredPawnComponent : UFortPawnComponent {
	...
	struct TArray<struct ABuildingRift*> GetDespawnRifts(); // Function FortniteAI.DespawnExpiredPawnComponent.GetDespawnRifts // (Final|Native|Public|BlueprintCallable) // @ game+0x9c23300
	void DespawnExpired(); // Function FortniteAI.DespawnExpiredPawnComponent.DespawnExpired // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x7adcc38
	void AddDespawnRift(struct ABuildingRift* NewRift); // Function FortniteAI.DespawnExpiredPawnComponent.AddDespawnRift // (Final|Native|Public|BlueprintCallable) // @ game+0x9c23188
};
