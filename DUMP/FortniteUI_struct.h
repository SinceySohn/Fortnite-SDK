...
struct FVideoWidgetConfig {
	...
	bool bControlShaderPipelineCacheBatching; // 0x71(0x01)
	bool bDisablePiP; // 0x72(0x01)
	...
	bool bPrePostRollNoAudioMix; // 0x90(0x01)
...
struct FAthenaShopSpecialOffer {
	...
	char pad_1[0x7]; // 0x01(0x07)
	struct FVideoWidgetConfig SpecialOfferVideo; // 0x08(0x98)
};
...
// ScriptStruct FortniteUI.CreativeDeviceEvent
// Size: 0x18 (Inherited: 0x00)
struct FCreativeDeviceEvent {
	struct FText DisplayName; // 0x00(0x18)
};

// ScriptStruct FortniteUI.CreativeDeviceFunction
// Size: 0x18 (Inherited: 0x00)
struct FCreativeDeviceFunction {
	struct FText DisplayName; // 0x00(0x18)
};
...
struct FCreativeDeviceInfo {
	int32_t DeviceTrackingGUID; // 0x00(0x04)
	char pad_4[0x4]; // 0x04(0x04)
	struct TSoftObjectPtr<AActor> ActorPtr; // 0x08(0x28)
	struct FString DisplayName; // 0x30(0x10)
	struct TArray<struct FCreativeDeviceEvent> BoundEvents; // 0x40(0x10)
	struct TArray<struct FCreativeDeviceFunction> BoundFunctions; // 0x50(0x10)
	int32_t NumBoundEvents; // 0x60(0x04)
	int32_t NumBoundFunctions; // 0x64(0x04)
};
