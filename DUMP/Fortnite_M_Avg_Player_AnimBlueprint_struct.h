...
struct FAnimBlueprintGeneratedConstantData : FAnimBlueprintConstantData {
	...
	struct TArray<int32_t> ; // 0x230(0x10)
	...
	struct UAnimSequenceBase* ; // 0x298(0x08)
	...
	struct TArray<float> ; // 0x368(0x10)
	struct TArray<int32_t> ; // 0x378(0x10)
	struct FName ; // 0x388(0x04)
	char pad_38C[0x4]; // 0x38c(0x04)
	struct TArray<float> ; // 0x390(0x10)
	enum class EAlphaBlendOption ; // 0x3a0(0x01)
	char pad_3A1[0x7]; // 0x3a1(0x07)
	struct TArray<float> ; // 0x3a8(0x10)
	struct TArray<float> ; // 0x3b8(0x10)
	struct TArray<int32_t> ; // 0x3c8(0x10)
	struct UBlendSpace* ; // 0x3d8(0x08)
	struct UBlendSpace* ; // 0x3e0(0x08)
	struct FName ; // 0x3e8(0x04)
	char pad_3EC[0x4]; // 0x3ec(0x04)
	struct TArray<float> ; // 0x3f0(0x10)
	struct FName ; // 0x400(0x04)
	...
	struct TArray<float> ; // 0x428(0x10)
	struct TArray<int32_t> ; // 0x438(0x10)
	struct UAnimSequenceBase* ; // 0x448(0x08)
	struct FName ; // 0x450(0x04)
	struct FName ; // 0x454(0x04)
	struct FName ; // 0x458(0x04)
	struct FName ; // 0x45c(0x04)
	struct FName ; // 0x460(0x04)
	char pad_464[0x4]; // 0x464(0x04)
	struct TArray<float> ; // 0x468(0x10)
	struct TArray<float> ; // 0x478(0x10)
	struct FName ; // 0x488(0x04)
	struct FName ; // 0x48c(0x04)
	struct TArray<int32_t> ; // 0x490(0x10)
	enum class EAnimGroupRole ; // 0x4a0(0x01)
	char pad_4A1[0x3]; // 0x4a1(0x03)
	struct FName ; // 0x4a4(0x04)
	struct FName ; // 0x4a8(0x04)
	enum class ERefPoseType ; // 0x4ac(0x01)
	...
	int32_t ; // 0x56c(0x04)
	struct FName ; // 0x570(0x04)
	int32_t ; // 0x574(0x04)
	struct UAnimSequenceBase* ; // 0x578(0x08)
	struct FName ; // 0x580(0x04)
	struct FName ; // 0x584(0x04)
	struct TArray<float> ; // 0x588(0x10)
	struct FName ; // 0x598(0x04)
	float ; // 0x59c(0x04)
	struct FInputScaleBiasClampConstants ; // 0x5a0(0x2c)
	float ; // 0x5cc(0x04)
	enum class EAnimSyncMethod ; // 0x5d0(0x01)
	char pad_5D1[0x3]; // 0x5d1(0x03)
	struct FName ; // 0x5d4(0x04)
	int32_t ; // 0x5d8(0x04)
	enum class ERefPoseType ; // 0x5dc(0x01)
	char pad_5DD[0x3]; // 0x5dd(0x03)
	struct FName ; // 0x5e0(0x04)
	int32_t ; // 0x5e4(0x04)
	bool ; // 0x5e8(0x01)
	enum class EBlendListTransitionType ; // 0x5e9(0x01)
	char pad_5EA[0x2]; // 0x5ea(0x02)
	struct FName ; // 0x5ec(0x04)
	struct FName ; // 0x5f0(0x04)
	int32_t ; // 0x5f4(0x04)
	struct TArray<float> ; // 0x5f8(0x10)
	struct TArray<float> ; // 0x608(0x10)
	struct UBlendProfile* ; // 0x618(0x08)
	struct UCurveFloat* ; // 0x620(0x08)
	bool ; // 0x628(0x01)
	enum class EAlphaBlendOption ; // 0x629(0x01)
	enum class EBlendListTransitionType ; // 0x62a(0x01)
	char pad_62B[0x5]; // 0x62b(0x05)
	struct TArray<float> ; // 0x630(0x10)
	struct FAnimNodeFunctionRef ; // 0x640(0x18)
	struct FAnimSubsystem_Tag AnimBlueprintExtension_Tag; // 0x658(0x60)
	struct FAnimSubsystem_PropertyAccess AnimBlueprintExtension_PropertyAccess; // 0x6b8(0x80)
	struct FAnimSubsystem AnimBlueprintExtension_NodeRelevancy; // 0x738(0x08)
	struct FAnimSubsystem_Base AnimBlueprintExtension_Base; // 0x740(0x18)
};

// ScriptStruct Fortnite_M_Avg_Player_AnimBlueprint.Fortnite_M_Avg_Player_AnimBlueprint_C.AnimBlueprintGeneratedMutableData
// Size: 0x56c (Inherited: 0x01)
