...
struct AGCNL_Athena_Player_SlideImpulse_VelocityMet_C : AFortGameplayCueNotify_Loop {
	...
	void ReceiveTick(float DeltaSeconds); // Function GCNL_Athena_Player_SlideImpulse_VelocityMet.GCNL_Athena_Player_SlideImpulse_VelocityMet_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	...
	void ExecuteUbergraph_GCNL_Athena_Player_SlideImpulse_VelocityMet(int32_t EntryPoint); // Function GCNL_Athena_Player_SlideImpulse_VelocityMet.GCNL_Athena_Player_SlideImpulse_VelocityMet_C.ExecuteUbergraph_GCNL_Athena_Player_SlideImpulse_VelocityMet // (Final|UbergraphFunction|HasDefaults) // @ game+0xdef49c
};
