...
struct AGCNL_Athena_UnderwaterDamage_C : AFortGameplayCueNotify_Loop {
	...
	void ExecuteUbergraph_GCNL_Athena_UnderwaterDamage(int32_t EntryPoint); // Function GCNL_Athena_UnderwaterDamage.GCNL_Athena_UnderwaterDamage_C.ExecuteUbergraph_GCNL_Athena_UnderwaterDamage // (Final|UbergraphFunction|HasDefaults) // @ game+0xdef49c
};
