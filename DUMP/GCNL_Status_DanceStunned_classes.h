...
struct AGCNL_Status_DanceStunned_C : AFortGameplayCueNotify_Loop {
	...
	void OnApplicationGeneric(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UFXSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents, struct ULegacyCameraShake* BurstCameraShakeInstance, struct ADecalActor* BurstDecalInstance); // Function GCNL_Status_DanceStunned.GCNL_Status_DanceStunned_C.OnApplicationGeneric // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xdef49c
	...
	void ExecuteUbergraph_GCNL_Status_DanceStunned(int32_t EntryPoint); // Function GCNL_Status_DanceStunned.GCNL_Status_DanceStunned_C.ExecuteUbergraph_GCNL_Status_DanceStunned // (Final|UbergraphFunction|HasDefaults) // @ game+0xdef49c
};
