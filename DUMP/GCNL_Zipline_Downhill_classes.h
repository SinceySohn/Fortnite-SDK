...
struct AGCNL_Zipline_Downhill_C : AFortGameplayCueNotify_Loop {
	...
	void cameraShakeTimer(); // Function GCNL_Zipline_Downhill.GCNL_Zipline_Downhill_C.cameraShakeTimer // (BlueprintCallable|BlueprintEvent) // @ game+0xdef49c
	void ExecuteUbergraph_GCNL_Zipline_Downhill(int32_t EntryPoint); // Function GCNL_Zipline_Downhill.GCNL_Zipline_Downhill_C.ExecuteUbergraph_GCNL_Zipline_Downhill // (Final|UbergraphFunction|HasDefaults) // @ game+0xdef49c
};
