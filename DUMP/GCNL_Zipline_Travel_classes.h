...
struct AGCNL_Zipline_Travel_C : AFortGameplayCueNotifyLoop_ZiplineTravel {
	...
	void OnApplicationGeneric(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UFXSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents, struct ULegacyCameraShake* BurstCameraShakeInstance, struct ADecalActor* BurstDecalInstance); // Function GCNL_Zipline_Travel.GCNL_Zipline_Travel_C.OnApplicationGeneric // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xdef49c
	...
	void ExecuteUbergraph_GCNL_Zipline_Travel(int32_t EntryPoint); // Function GCNL_Zipline_Travel.GCNL_Zipline_Travel_C.ExecuteUbergraph_GCNL_Zipline_Travel // (Final|UbergraphFunction|HasDefaults) // @ game+0xdef49c
};
