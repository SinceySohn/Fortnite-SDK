...
struct UGCN_Irwin_EnterWater_C : UFortGameplayCueNotify_Burst {
	...
	void OnBurstGeneric(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UFXSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents, struct ULegacyCameraShake* BurstCameraShakeInstance, struct ADecalActor* BurstDecalInstance); // Function GCN_Irwin_EnterWater.GCN_Irwin_EnterWater_C.OnBurstGeneric // (Event|Public|HasOutParms|BlueprintEvent|Const) // @ game+0xdef49c
	void ExecuteUbergraph_GCN_Irwin_EnterWater(int32_t EntryPoint); // Function GCN_Irwin_EnterWater.GCN_Irwin_EnterWater_C.ExecuteUbergraph_GCN_Irwin_EnterWater // (Final|UbergraphFunction|HasDefaults) // @ game+0xdef49c
};
