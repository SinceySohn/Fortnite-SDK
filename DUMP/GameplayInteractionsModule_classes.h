...
struct UAITask_UseGameplayInteraction : UAITask {
	...
	struct FGameplayInteractionAbortContext AbortContext; // 0xe8(0x01)
	char pad_E9[0x7]; // 0xe9(0x07)

	struct UAITask_UseGameplayInteraction* UseClaimedGameplayInteractionSmartObject(struct AAIController* Controller, struct FSmartObjectClaimHandle ClaimHandle, bool bLockAILogic); // Function GameplayInteractionsModule.AITask_UseGameplayInteraction.UseClaimedGameplayInteractionSmartObject // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x7186b38
	void RequestAbort(); // Function GameplayInteractionsModule.AITask_UseGameplayInteraction.RequestAbort // (Final|Native|Public|BlueprintCallable) // @ game+0x7186944
};
...
struct UGameplayTask_PlayContextualAnim : UGameplayTask {
	...
	void SetExit(enum class EPlayContextualAnimExitMode ExitMode, struct FName NewExitSectionName); // Function GameplayInteractionsModule.GameplayTask_PlayContextualAnim.SetExit // (Final|Native|Public|BlueprintCallable) // @ game+0x7186960
	struct UGameplayTask_PlayContextualAnim* PlayContextualAnim(struct AActor* Interactor, struct FName InteractorRole, struct AActor* InteractableObject, struct FName InteractableObjectRole, struct FName SectionName, struct FName ExitSectionName, struct UContextualAnimSceneAsset* SceneAsset); // Function GameplayInteractionsModule.GameplayTask_PlayContextualAnim.PlayContextualAnim // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x7186740
	void OnSectionEndTimeReached(struct UContextualAnimSceneInstance* SceneInstance); // Function GameplayInteractionsModule.GameplayTask_PlayContextualAnim.OnSectionEndTimeReached // (Final|Native|Protected) // @ game+0x71866c0
	enum class EPlayContextualAnimStatus GetStatus(); // Function GameplayInteractionsModule.GameplayTask_PlayContextualAnim.GetStatus // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71861c0
};
...
struct UGameplayTask_StandAt : UGameplayTask {
	...
	struct UGameplayTask_StandAt* StandAt(struct APawn* Pawn, float Duration); // Function GameplayInteractionsModule.GameplayTask_StandAt.StandAt // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x7186a2c
};
