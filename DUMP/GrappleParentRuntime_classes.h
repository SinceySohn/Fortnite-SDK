...
struct UFortCameraModifier_Swinging : UCameraModifier {
	...
	void RemoveSelfFromCameraManager(); // Function GrappleParentRuntime.FortCameraModifier_Swinging.RemoveSelfFromCameraManager // (Final|Native|Protected) // @ game+0x653f348
	void CalculateDynamicMultipliers(float& OutFOVBoundsMultiplier, float& OutBoostOffsetMultiplier); // Function GrappleParentRuntime.FortCameraModifier_Swinging.CalculateDynamicMultipliers // (Native|Event|Protected|HasOutParms|BlueprintEvent|Const) // @ game+0x653f098
};
...
struct UFortSwingingLayerAnimInstance : UFortBaseLayerAnimInstance {
	...
	void GetPlayerAnglesFromAttachPoint(float& Pitch, float& Roll, float& Yaw); // Function GrappleParentRuntime.FortSwingingLayerAnimInstance.GetPlayerAnglesFromAttachPoint // (Final|Native|Public|HasOutParms) // @ game+0x653f220
	struct FVector GetAttachVectorInPlayerSpace(struct FVector& InPlayerToAttachPoint); // Function GrappleParentRuntime.FortSwingingLayerAnimInstance.GetAttachVectorInPlayerSpace // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x653f178
};
