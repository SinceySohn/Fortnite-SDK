...
struct UImagePlateComponent : UPrimitiveComponent {
	...
	void SetImagePlate(struct FImagePlateParameters Plate); // Function ImagePlate.ImagePlateComponent.SetImagePlate // (Final|Native|Public|BlueprintCallable) // @ game+0x6ee45a4
	void OnRenderTextureChanged(); // Function ImagePlate.ImagePlateComponent.OnRenderTextureChanged // (Final|Native|Public) // @ game+0x6ee4590
	struct FImagePlateParameters GetPlate(); // Function ImagePlate.ImagePlateComponent.GetPlate // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6ee4550
};
