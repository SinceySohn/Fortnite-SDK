...
struct UFortAIFaunaAnimInstance : UFortAIAnimInstance {
	...
	void UpdateTurnAngleStored(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateTurnAngleStored // (Native|Event|Public|BlueprintEvent) // @ game+0x6103618
	void UpdateSwimmingYaw(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateSwimmingYaw // (Native|Event|Public|BlueprintEvent) // @ game+0x65cb0b8
	void UpdateRidingMovePlayRate(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateRidingMovePlayRate // (Native|Event|Public|BlueprintEvent) // @ game+0x65cafe4
	void UpdatePlayLandAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdatePlayLandAdditive // (Native|Event|Public|BlueprintEvent) // @ game+0x65cafcc
	void UpdateFootPhaseStop(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateFootPhaseStop // (Native|Event|Public|BlueprintEvent) // @ game+0x65cae98
	void UpdateBoostPlayRate(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateBoostPlayRate // (Native|Event|Public|BlueprintEvent) // @ game+0x65cae14
	void UpdateBodyRoll(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateBodyRoll // (Native|Event|Public|BlueprintEvent) // @ game+0x65cadfc
	void UpdateBackwardVelocity(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateBackwardVelocity // (Native|Event|Public|BlueprintEvent) // @ game+0x65cada0
	void UpdateBackwardsPlayRate(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateBackwardsPlayRate // (Native|Event|Public|BlueprintEvent) // @ game+0x65cadb8
	void FinishFootPhaseStopUpdate(); // Function IrwinRuntime.FortAIFaunaAnimInstance.FinishFootPhaseStopUpdate // (Native|Event|Public|BlueprintEvent) // @ game+0x65cad88
	void CalculateLookAtAlpha(bool bForceDisableLookAt, float DeltaSeconds); // Function IrwinRuntime.FortAIFaunaAnimInstance.CalculateLookAtAlpha // (Final|Native|Public|BlueprintCallable) // @ game+0x65cab8c
};
...
struct UFortAIFaunaAnimInstance_Grandma : UFortAIFaunaAnimInstance {
	...
	void UpdateStateVariables(bool bAccelerating); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateStateVariables // (Final|Native|Public|BlueprintCallable) // @ game+0x65cb024
	void UpdateShouldPlayFullBodyInPlace(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateShouldPlayFullBodyInPlace // (Final|Native|Public|BlueprintCallable) // @ game+0x65caffc
	void UpdateMovingRates(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateMovingRates // (Final|Native|Public|BlueprintCallable) // @ game+0x65cafa4
	void UpdateMeshScale(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateMeshScale // (Final|Native|Public|BlueprintCallable) // @ game+0x65caf80
	void UpdateLocomotionPoseAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateLocomotionPoseAlpha // (Final|Native|Public|BlueprintCallable) // @ game+0x65caf54
	void UpdateIdleStartTurn(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateIdleStartTurn // (Final|Native|Public|BlueprintCallable) // @ game+0x65caeb0
	void UpdateEnableSniffAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateEnableSniffAdditive // (Final|Native|Public|BlueprintCallable) // @ game+0x65cae74
	void UpdateEnableAlertAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateEnableAlertAdditive // (Final|Native|Public|BlueprintCallable) // @ game+0x65cae2c
	void UpdateBlinkAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateBlinkAlpha // (Final|Native|Public|BlueprintCallable) // @ game+0x65cadd0
	bool DetermineShouldPlayFullBodyInPlace(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineShouldPlayFullBodyInPlace // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65cad64
	bool DetermineIdleStartTurn(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineIdleStartTurn // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65cacf8
	bool DetermineEnableSniffAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineEnableSniffAdditive // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65cacd8
	bool DetermineEnableAlertAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineEnableAlertAdditive // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65cac98
	float CalculateWalkRunPlayRate(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateWalkRunPlayRate // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65cac74
	float CalculateMeshScale(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateMeshScale // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65cac54
	float CalculateLocomotionPoseAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateLocomotionPoseAlpha // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65cab64
	float CalculateBlinkAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateBlinkAlpha // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65cab14
};
...
struct UFortAIFaunaAnimInstance_Robert : UFortAIFaunaAnimInstance {
	...
	void UpdateStateVariables(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateStateVariables // (Final|Native|Public|BlueprintCallable) // @ game+0x65cb0a4
	void UpdateLocomotionPoseAdditiveAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateLocomotionPoseAdditiveAlpha // (Final|Native|Public|BlueprintCallable) // @ game+0x65caf28
	void UpdateIsFullBodyInPlace(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateIsFullBodyInPlace // (Final|Native|Public|BlueprintCallable) // @ game+0x65caf00
	void UpdateIdleStartTurn(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateIdleStartTurn // (Final|Native|Public|BlueprintCallable) // @ game+0x65caed8
	void UpdateEnableHeadTiltDownAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateEnableHeadTiltDownAdditive // (Final|Native|Public|BlueprintCallable) // @ game+0x65cae50
	bool DetermineIsFullBodyInPlace(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.DetermineIsFullBodyInPlace // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65cad40
	bool DetermineIdleStartTurn(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.DetermineIdleStartTurn // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65cad1c
	bool DetermineEnableHeadTiltDownAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.DetermineEnableHeadTiltDownAdditive // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65cacb8
	float CalculateLocomotionPoseAdditiveAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.CalculateLocomotionPoseAdditiveAlpha // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65cab3c
};
