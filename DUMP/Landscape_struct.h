...
struct FLandscapeLayer {
	...
	bool bLocked; // 0x15(0x01)
	char pad_16[0x2]; // 0x16(0x02)
	float HeightmapAlpha; // 0x18(0x04)
	float WeightmapAlpha; // 0x1c(0x04)
	enum class ELandscapeBlendMode BlendMode; // 0x20(0x01)
...
struct FGrassVariety {
	...
	bool bCastContactShadow; // 0x52(0x01)
	bool bKeepInstanceBufferCPUCopy; // 0x53(0x01)
	uint32_t InstanceWorldPositionOffsetDisableDistance; // 0x54(0x04)
};

// ScriptStruct Landscape.LandscapeMaterialTextureStreamingInfo
// Size: 0x08 (Inherited: 0x00)
struct FLandscapeMaterialTextureStreamingInfo {
	struct FName TextureName; // 0x00(0x04)
	float TexelFactor; // 0x04(0x04)
};
...
struct FLandscapeSplineSegmentConnection {
	...
	struct FName SocketName; // 0x0c(0x04)
};
...
struct FLayerBlendInput {
	struct FName LayerName; // 0x00(0x04)
	enum class ELandscapeLayerBlendType BlendType; // 0x04(0x01)
	char pad_5[0x3]; // 0x05(0x03)
	struct FExpressionInput LayerInput; // 0x08(0x28)
	struct FExpressionInput HeightInput; // 0x30(0x28)
	float PreviewWeight; // 0x58(0x04)
	char pad_5C[0x4]; // 0x5c(0x04)
	struct FVector ConstLayerInput; // 0x60(0x18)
	float ConstHeightInput; // 0x78(0x04)
...
struct FLandscapeInfoLayerSettings {
	...
	struct FName LayerName; // 0x08(0x04)
