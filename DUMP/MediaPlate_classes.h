...
struct UMediaPlateComponent : UActorComponent {
	...
	void Stop(); // Function MediaPlate.MediaPlateComponent.Stop // (Final|Native|Public|BlueprintCallable) // @ game+0x736a7b8
	void Play(); // Function MediaPlate.MediaPlateComponent.Play // (Final|Native|Public|BlueprintCallable) // @ game+0x736a7a4
	struct UMediaTexture* GetMediaTexture(); // Function MediaPlate.MediaPlateComponent.GetMediaTexture // (Final|Native|Public|BlueprintCallable) // @ game+0x736a784
	struct UMediaPlayer* GetMediaPlayer(); // Function MediaPlate.MediaPlateComponent.GetMediaPlayer // (Final|Native|Public|BlueprintCallable) // @ game+0x736a764
};
