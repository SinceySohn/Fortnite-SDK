...
struct UMetaSound : UObject {
	...
	struct TSet<struct UObject*> ReferencedAssetClassObjects; // 0x288(0x50)
	struct TSet<struct FSoftObjectPath> ReferenceAssetClassCache; // 0x2d8(0x50)
	struct FGuid AssetClassID; // 0x328(0x10)
};
...
struct UMetaSoundAssetSubsystem : UEngineSubsystem {
	...
	void UnregisterAssetClassesInDirectories(struct TArray<struct FMetaSoundAssetDirectory>& Directories); // Function MetasoundEngine.MetaSoundAssetSubsystem.UnregisterAssetClassesInDirectories // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x6d9e4cc
	void RegisterAssetClassesInDirectories(struct TArray<struct FMetaSoundAssetDirectory>& Directories); // Function MetasoundEngine.MetaSoundAssetSubsystem.RegisterAssetClassesInDirectories // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x6d9e434
};

// Class MetasoundEngine.MetaSoundSource
// Size: 0x680 (Inherited: 0x360)
struct UMetaSoundSource : USoundWaveProcedural {
	...
	struct TSet<struct UObject*> ReferencedAssetClassObjects; // 0x5c0(0x50)
	struct TSet<struct FSoftObjectPath> ReferenceAssetClassCache; // 0x610(0x50)
	enum class EMetasoundSourceAudioFormat OutputFormat; // 0x660(0x01)
	char pad_661[0x3]; // 0x661(0x03)
	struct FGuid AssetClassID; // 0x664(0x10)
