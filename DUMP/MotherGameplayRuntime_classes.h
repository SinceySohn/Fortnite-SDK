...
struct UGravityGunTargetTrackingComponent : UActorComponent {
	...
	bool IsValidTarget(struct AActor* OwningPlayer, struct AActor* PotentialTarget, struct FGameplayTagContainer& ReasonForFailure); // Function MotherGameplayRuntime.GravityGunTargetTrackingComponent.IsValidTarget // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x67c3a6c
	bool FindTargetProjectile(struct AActor* OwningPlayer, struct FVector& TraceStart, struct FVector& TraceEnd, float TargetingRadius); // Function MotherGameplayRuntime.GravityGunTargetTrackingComponent.FindTargetProjectile // (Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x67c2f74
	void FindTargetActor(struct AActor* OwningPlayer, struct FVector& TraceStart, struct FVector& TraceEnd); // Function MotherGameplayRuntime.GravityGunTargetTrackingComponent.FindTargetActor // (Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x67c258c
};

// Class MotherGameplayRuntime.FortCabbageIglooVehicle
// Size: 0x24e0 (Inherited: 0x24e0)
...
struct AReactorGradeGameplayCue_ChargeUp : AFortGameplayCueNotify_Loop {
	...
	void UpdateAimEndPoint(); // Function MotherGameplayRuntime.ReactorGradeGameplayCue_ChargeUp.UpdateAimEndPoint // (Final|Native|Public|BlueprintCallable) // @ game+0x67c3ee4
	void OnEndPointUpdated(struct FVector& FoundPoint); // Function MotherGameplayRuntime.ReactorGradeGameplayCue_ChargeUp.OnEndPointUpdated // (Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0xdef49c
	struct FVector GetFoundEndPoint(); // Function MotherGameplayRuntime.ReactorGradeGameplayCue_ChargeUp.GetFoundEndPoint // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x67c3a44
};
