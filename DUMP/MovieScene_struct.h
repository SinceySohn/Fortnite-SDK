...
struct FMovieScenePropertyBinding {
	...
	struct FName PropertyPath; // 0x04(0x04)
	bool bCanUseClassLookup; // 0x08(0x01)
...
struct FActorForWorldTransforms {
	...
	struct FName SocketName; // 0x10(0x04)
};
...
struct FMovieSceneEvaluationTrack {
	...
	struct FName EvaluationGroup; // 0x68(0x04)
	char bEvaluateInPreroll : 1; // 0x6c(0x01)
	char bEvaluateInPostroll : 1; // 0x6c(0x01)
	char bTearDownPriority : 1; // 0x6c(0x01)
...
struct FMovieSceneSpawnable {
	...
	struct FName LevelName; // 0xb4(0x04)
