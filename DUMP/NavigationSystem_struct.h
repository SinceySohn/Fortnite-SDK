...
struct FRecastNavMeshTileGenerationDebug {
	...
	char bHeightfieldSolidFromRasterization : 1; // 0x10(0x01)
	char bHeightfieldSolidPostRadiusFiltering : 1; // 0x10(0x01)
	char bHeightfieldSolidPostHeightFiltering : 1; // 0x10(0x01)
	char bCompactHeightfield : 1; // 0x10(0x01)
	char bCompactHeightfieldEroded : 1; // 0x10(0x01)
	char bCompactHeightfieldRegions : 1; // 0x10(0x01)
	char bCompactHeightfieldDistances : 1; // 0x10(0x01)
	char bTileCacheLayerAreas : 1; // 0x10(0x01)
	char bTileCacheLayerRegions : 1; // 0x11(0x01)
	char bTileCacheContours : 1; // 0x11(0x01)
	char bTileCachePolyMesh : 1; // 0x11(0x01)
	char bTileCacheDetailMesh : 1; // 0x11(0x01)
	char pad_11_4 : 4; // 0x11(0x01)
