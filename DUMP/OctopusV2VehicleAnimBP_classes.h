...
struct UOctopusV2VehicleAnimBP_C : UFortOctopusVehicleAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function OctopusV2VehicleAnimBP.OctopusV2VehicleAnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xdef49c
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function OctopusV2VehicleAnimBP.OctopusV2VehicleAnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0xdef49c
	void ExecuteUbergraph_OctopusV2VehicleAnimBP(int32_t EntryPoint); // Function OctopusV2VehicleAnimBP.OctopusV2VehicleAnimBP_C.ExecuteUbergraph_OctopusV2VehicleAnimBP // (Final|UbergraphFunction) // @ game+0xdef49c
};
