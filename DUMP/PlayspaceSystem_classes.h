...
struct UOverlapComponent : UStaticMeshComponent {
	...
	void OnEndActorOverlap(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // Function PlayspaceSystem.OverlapComponent.OnEndActorOverlap // (Native|Protected) // @ game+0x639b528
	void OnBeginActorOverlap(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult); // Function PlayspaceSystem.OverlapComponent.OnBeginActorOverlap // (Native|Protected|HasOutParms) // @ game+0x639b338
};
...
struct UPlayspaceControllerComponent_PlayerSpawning : UControllerComponent {
	...
	void ServerMarkReadyForSpawning(); // Function PlayspaceSystem.PlayspaceControllerComponent_PlayerSpawning.ServerMarkReadyForSpawning // (Net|NetReliableNative|Event|Public|NetServer|NetValidate) // @ game+0x639b994
	void OnRep_ReplicatedSpawnInfo(); // Function PlayspaceSystem.PlayspaceControllerComponent_PlayerSpawning.OnRep_ReplicatedSpawnInfo // (Final|Native|Private) // @ game+0x639b8ec
	struct FReplicatedSpawnInfo GetSpawnInfo(); // Function PlayspaceSystem.PlayspaceControllerComponent_PlayerSpawning.GetSpawnInfo // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x639b25c
};
...
struct AGameplayVolume : AActor {
	...
	void UpdateSize(struct FVector& NewScale); // Function PlayspaceSystem.GameplayVolume.UpdateSize // (Native|Public|HasOutParms|HasDefaults) // @ game+0x639b9e0
	void OnOverlappedPawnControllerChanged(struct APawn* Pawn, struct AController* OldController, struct AController* NewController); // Function PlayspaceSystem.GameplayVolume.OnOverlappedPawnControllerChanged // (Native|Protected) // @ game+0x639b668
	void InitializeBoundsComponent(struct UOverlapComponent* NewBoundsComponent); // Function PlayspaceSystem.GameplayVolume.InitializeBoundsComponent // (Final|Native|Private|BlueprintCallable) // @ game+0x639b2b4
	struct APlayspace* GetPlayspace(); // Function PlayspaceSystem.GameplayVolume.GetPlayspace // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2270abc
};
...
struct APlayspace : AInfo {
	...
	enum class EWithinBoundsEvaluationType BoundsEvaluationType; // 0x4d1(0x01)
	...
	void OnRep_PlayspaceUsers(); // Function PlayspaceSystem.Playspace.OnRep_PlayspaceUsers // (Final|Native|Protected) // @ game+0x129a010
	void OnRep_MatchStartTime(); // Function PlayspaceSystem.Playspace.OnRep_MatchStartTime // (Native|Protected) // @ game+0x2c084fc
	void OnRep_bMatchHasEnded(); // Function PlayspaceSystem.Playspace.OnRep_bMatchHasEnded // (Final|Native|Protected) // @ game+0x24dff18
	void OnRep_bIsInitialized(); // Function PlayspaceSystem.Playspace.OnRep_bIsInitialized // (Final|Native|Protected) // @ game+0xfcc524
};
...
struct UPlayspaceLibrary : UBlueprintFunctionLibrary {
	...
	void DestroyPlayspace(struct APlayspace* PlayspaceToDestroy); // Function PlayspaceSystem.PlayspaceLibrary.DestroyPlayspace // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x639af80
};
...
struct APlayspaceLogic : AActor {
	...
	void OnRep_MatchStartTime(); // Function PlayspaceSystem.PlayspaceLogic.OnRep_MatchStartTime // (Native|Protected) // @ game+0x28b6318
	void OnRep_bMatchHasEnded(); // Function PlayspaceSystem.PlayspaceLogic.OnRep_bMatchHasEnded // (Final|Native|Private) // @ game+0x1639118
};
...
struct UPlayspaceManagerComponent : UGameStateComponent {
	...
	enum class EPlayspaceRootType PlayspaceRootType; // 0xc0(0x01)
	char pad_C1[0x11f]; // 0xc1(0x11f)
	...
	struct TSet<struct APlayerController*> UnassignedPlayers; // 0x200(0x50)

	bool ProcessOverlapEvents(float DeltaTime); // Function PlayspaceSystem.PlayspaceManagerComponent.ProcessOverlapEvents // (Final|Native|Private) // @ game+0x639b900
	void OnRep_RootPlayspace(); // Function PlayspaceSystem.PlayspaceManagerComponent.OnRep_RootPlayspace // (Final|Native|Private) // @ game+0x260673c
	void OnPlayerEndOverlapGameplayVolume(struct APlayerState* PlayerState, struct AGameplayVolume* Volume); // Function PlayspaceSystem.PlayspaceManagerComponent.OnPlayerEndOverlapGameplayVolume // (Final|Native|Private) // @ game+0x639b828
	void OnPlayerBeginOverlapGameplayVolume(struct APlayerState* PlayerState, struct AGameplayVolume* Volume); // Function PlayspaceSystem.PlayspaceManagerComponent.OnPlayerBeginOverlapGameplayVolume // (Final|Native|Private) // @ game+0x639b764
};
