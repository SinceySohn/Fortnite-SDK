...
struct UHISMBuilderSettings : UObject {
	...
	void SetOverriddenLightMapRes(int32_t Value); // Function Procedural.HISMBuilderSettings.SetOverriddenLightMapRes // (Final|Native|Public|BlueprintCallable) // @ game+0x71d9f94
	int32_t GetOverriddenLightMapRes(); // Function Procedural.HISMBuilderSettings.GetOverriddenLightMapRes // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x5ff19b0
};
...
struct UProceduralParameterModifier : UObject {
	...
	float GetContribution(); // Function Procedural.ProceduralParameterModifier.GetContribution // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71d9bec
};
...
struct UProceduralGenerationContext : UObject {
	...
	struct AVolume* GetGenerationVolume(); // Function Procedural.ProceduralGenerationContext.GetGenerationVolume // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71d9cf4
	struct UProceduralGenerationComponent* GetGenerationComponent(); // Function Procedural.ProceduralGenerationContext.GetGenerationComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71d9cac
};
...
struct AProceduralGenerationVolume : AVolume {
	...
	void Generate(); // Function Procedural.ProceduralGenerationVolume.Generate // (Final|Native|Public|BlueprintCallable) // @ game+0x71d9bac
	void ClearGeneratedContent(); // Function Procedural.ProceduralGenerationVolume.ClearGeneratedContent // (Final|Native|Public|BlueprintCallable) // @ game+0x71d9af8
};
...
struct UProceduralGeneratorContext : UObject {
	...
	bool OnGenerate(); // Function Procedural.ProceduralGeneratorContext.OnGenerate // (Native|Event|Public|BlueprintEvent) // @ game+0x2b69778
	void OnDrawVisualization(); // Function Procedural.ProceduralGeneratorContext.OnDrawVisualization // (Event|Public|BlueprintEvent|Const) // @ game+0xdef49c
	void OnClearGeneratedContent(); // Function Procedural.ProceduralGeneratorContext.OnClearGeneratedContent // (Native|Event|Public|BlueprintEvent) // @ game+0x19d5234
	void GetOrCreateGeneratorContext(struct UProceduralGenerator* Generator, struct UProceduralGeneratorContext*& Context); // Function Procedural.ProceduralGeneratorContext.GetOrCreateGeneratorContext // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x71d9d50
	struct TArray<struct UProceduralGeneratorContext*> GetGeneratedContexts(); // Function Procedural.ProceduralGeneratorContext.GetGeneratedContexts // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71d9c0c
	bool Generate(); // Function Procedural.ProceduralGeneratorContext.Generate // (Final|Native|Public|BlueprintCallable) // @ game+0x71d9bc8
	void ClearGeneratedContent(); // Function Procedural.ProceduralGeneratorContext.ClearGeneratedContent // (Final|Native|Public|BlueprintCallable) // @ game+0x71d9b28
};
...
struct UProceduralPointCloud : UObject {
	...
	struct TArray<struct FProceduralPointCloudPoint> GetPointsByTag(struct FName InTag); // Function Procedural.ProceduralPointCloud.GetPointsByTag // (Final|Native|Public|BlueprintCallable) // @ game+0x71d9e24
	void Empty(); // Function Procedural.ProceduralPointCloud.Empty // (Final|Native|Public|BlueprintCallable) // @ game+0x71d9b3c
};
...
struct UProceduralRotationMapModifier : UProceduralRotationModifier {
	...
	void SetYawMin(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetYawMin // (Final|Native|Public|BlueprintCallable) // @ game+0x71da40c
	void SetYawMax(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetYawMax // (Final|Native|Public|BlueprintCallable) // @ game+0x71da37c
	void SetRollMin(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetRollMin // (Final|Native|Public|BlueprintCallable) // @ game+0x71da52c
	void SetRollMax(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetRollMax // (Final|Native|Public|BlueprintCallable) // @ game+0x71da49c
	void SetPitchMin(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetPitchMin // (Final|Native|Public|BlueprintCallable) // @ game+0x71da0ac
	void SetPitchMax(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetPitchMax // (Final|Native|Public|BlueprintCallable) // @ game+0x71da01c
	float GetYawMin(); // Function Procedural.ProceduralRotationMapModifier.GetYawMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71d9f6c
	float GetYawMax(); // Function Procedural.ProceduralRotationMapModifier.GetYawMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71d9f58
	float GetRollMin(); // Function Procedural.ProceduralRotationMapModifier.GetRollMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71d9f80
	float GetRollMax(); // Function Procedural.ProceduralRotationMapModifier.GetRollMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2a7228c
	float GetPitchMin(); // Function Procedural.ProceduralRotationMapModifier.GetPitchMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2a72278
	float GetPitchMax(); // Function Procedural.ProceduralRotationMapModifier.GetPitchMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2273800
};
...
struct UProceduralRotationNoiseModifier : UProceduralRotationModifier {
	...
	void SetRandomYawMin(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomYawMin // (Final|Native|Public|BlueprintCallable) // @ game+0x71da40c
	void SetRandomYawMax(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomYawMax // (Final|Native|Public|BlueprintCallable) // @ game+0x71da37c
	void SetRandomRollMin(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomRollMin // (Final|Native|Public|BlueprintCallable) // @ game+0x71da2ec
	void SetRandomRollMax(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomRollMax // (Final|Native|Public|BlueprintCallable) // @ game+0x71da25c
	void SetRandomPitchMin(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomPitchMin // (Final|Native|Public|BlueprintCallable) // @ game+0x71da1cc
	void SetRandomPitchMax(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomPitchMax // (Final|Native|Public|BlueprintCallable) // @ game+0x71da13c
	float GetRandomYawMin(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomYawMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71d9f6c
	float GetRandomYawMax(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomYawMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71d9f58
	float GetRandomRollMin(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomRollMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2712db0
	float GetRandomRollMax(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomRollMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71d9f44
	float GetRandomPitchMin(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomPitchMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2a7228c
	float GetRandomPitchMax(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomPitchMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2a72278
};
...
struct UProceduralScaleMapModifier : UProceduralScaleModifier {
	...
	void SetRemapScaleMin(float InValue); // Function Procedural.ProceduralScaleMapModifier.SetRemapScaleMin // (Final|Native|Public|BlueprintCallable) // @ game+0x71da2ec
	void SetRemapScaleMax(float InValue); // Function Procedural.ProceduralScaleMapModifier.SetRemapScaleMax // (Final|Native|Public|BlueprintCallable) // @ game+0x71da25c
	float GetRemapScaleMin(); // Function Procedural.ProceduralScaleMapModifier.GetRemapScaleMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2712db0
	float GetRemapScaleMax(); // Function Procedural.ProceduralScaleMapModifier.GetRemapScaleMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71d9f44
};
...
struct UProceduralScaleNoiseModifier : UProceduralScaleModifier {
	...
	void SetScaleMin(float InValue); // Function Procedural.ProceduralScaleNoiseModifier.SetScaleMin // (Final|Native|Public|BlueprintCallable) // @ game+0x71dad64
	void SetScaleMax(float InValue); // Function Procedural.ProceduralScaleNoiseModifier.SetScaleMax // (Final|Native|Public|BlueprintCallable) // @ game+0x71dacd4
	float GetScaleMin(); // Function Procedural.ProceduralScaleNoiseModifier.GetScaleMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x5ff19b0
	float GetScaleMax(); // Function Procedural.ProceduralScaleNoiseModifier.GetScaleMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2712db0
};
...
struct UProceduralScatterSettings : UObject {
	...
	void SetSourcePointDistanceMin(float InValue); // Function Procedural.ProceduralScatterSettings.SetSourcePointDistanceMin // (Final|Native|Public|BlueprintCallable) // @ game+0x71dae8c
	void SetSourcePointDistanceMax(float InValue); // Function Procedural.ProceduralScatterSettings.SetSourcePointDistanceMax // (Final|Native|Public|BlueprintCallable) // @ game+0x71dadf4
	float GetSourcePointDistanceMin(); // Function Procedural.ProceduralScatterSettings.GetSourcePointDistanceMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71dacbc
	float GetSourcePointDistanceMax(); // Function Procedural.ProceduralScatterSettings.GetSourcePointDistanceMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71daca4
};
...
struct UProceduralSurfaceHeightMap : UProceduralFloatDataMap {
	...
	void SetHeightRangeMin(float InValue); // Function Procedural.ProceduralSurfaceHeightMap.SetHeightRangeMin // (Final|Native|Public|BlueprintCallable) // @ game+0x71fc388
	void SetHeightRangeMax(float InValue); // Function Procedural.ProceduralSurfaceHeightMap.SetHeightRangeMax // (Final|Native|Public|BlueprintCallable) // @ game+0x71fc2f0
	float GetValue(float InHeight); // Function Procedural.ProceduralSurfaceHeightMap.GetValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71fc25c
	float GetHeightRangeMin(); // Function Procedural.ProceduralSurfaceHeightMap.GetHeightRangeMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x64b8080
	float GetHeightRangeMax(); // Function Procedural.ProceduralSurfaceHeightMap.GetHeightRangeMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6476bd0
};
...
struct UProceduralSurfaceSlopeAngleMap : UProceduralFloatDataMap {
	...
	void SetSlopeAngleRangeMin(float InValue); // Function Procedural.ProceduralSurfaceSlopeAngleMap.SetSlopeAngleRangeMin // (Final|Native|Public|BlueprintCallable) // @ game+0x71fc388
	void SetSlopeAngleRangeMax(float InValue); // Function Procedural.ProceduralSurfaceSlopeAngleMap.SetSlopeAngleRangeMax // (Final|Native|Public|BlueprintCallable) // @ game+0x71fc2f0
	float GetValue(float InSlopeAngle); // Function Procedural.ProceduralSurfaceSlopeAngleMap.GetValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71fc25c
	float GetSlopeAngleRangeMin(); // Function Procedural.ProceduralSurfaceSlopeAngleMap.GetSlopeAngleRangeMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x64b8080
	float GetSlopeAngleRangeMax(); // Function Procedural.ProceduralSurfaceSlopeAngleMap.GetSlopeAngleRangeMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6476bd0
};
