...
struct UREVComponent : USynthComponent {
	...
	float PitchMultiplier; // 0x798(0x04)
	char pad_79C[0x14]; // 0x79c(0x14)

	void UpdateSimSettings(); // Function REVRuntime.REVComponent.UpdateSimSettings // (Final|Native|Public|BlueprintCallable) // @ game+0x6db4e28
	void UpdateParameters(float InPitch, float InRPM, float InThrottle, float InVelocity, int32_t InGear, bool bInEnableShifting); // Function REVRuntime.REVComponent.UpdateParameters // (Final|Native|Public|BlueprintCallable) // @ game+0x6db4c4c
	void SetSettings(struct URevSettings* InSettings); // Function REVRuntime.REVComponent.SetSettings // (Final|Native|Public|BlueprintCallable) // @ game+0x6db4bc8
	void SetRevModel(struct UREVModel* InModel); // Function REVRuntime.REVComponent.SetRevModel // (Final|Native|Public|BlueprintCallable) // @ game+0x6db4b18
};
...
struct URevSettings : UObject {
	...
	void UpdateSettings(); // Function REVRuntime.RevSettings.UpdateSettings // (Final|BlueprintCosmetic|Native|Public|BlueprintCallable) // @ game+0x6db4e14
};
