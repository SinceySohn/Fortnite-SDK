...
struct FRigVMByteCodeEntry {
	...
	int32_t InstructionIndex; // 0x04(0x04)
};
...
struct FRigVMRegister {
	...
	struct FName Name; // 0x14(0x04)
	int32_t ScriptStructIndex; // 0x18(0x04)
	bool bIsArray; // 0x1c(0x01)
	bool bIsDynamic; // 0x1d(0x01)
...
struct FRigVMRegisterOffset {
	...
	struct FName CPPType; // 0x14(0x04)
	struct UScriptStruct* ScriptStruct; // 0x18(0x08)
	struct UScriptStruct* ParentScriptStruct; // 0x20(0x08)
	int32_t ArrayIndex; // 0x28(0x04)
	uint16_t ElementSize; // 0x2c(0x02)
...
struct FRigVMTemplateArgumentType {
	struct FName CPPType; // 0x00(0x04)
	char pad_4[0x4]; // 0x04(0x04)
	struct UObject* CPPTypeObject; // 0x08(0x08)
};
...
struct FRigVMUserWorkflow {
	...
	struct FDelegate PerformDynamicDelegate; // 0x40(0x0c)
	char pad_4C[0x4]; // 0x4c(0x04)
	ClassPtrProperty OptionsClass; // 0x50(0x08)
};
