...
struct USidewaysCheatManager : UChildCheatManager {
	...
	void SetSidewaysState(enum class ESidewaysState SidewaysState); // Function SidewaysCodeRuntime.SidewaysCheatManager.SetSidewaysState // (Final|BlueprintAuthorityOnly|Exec|Native|Public) // @ game+0x6762920
};
...
struct USidewaysStateComponent : UGameFrameworkComponent {
	...
	void SetSidewaysState(enum class ESidewaysState NewState, struct ASidewaysPlayspace* NewSidewaysPlayspace); // Function SidewaysCodeRuntime.SidewaysStateComponent.SetSidewaysState // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x6762984
	void OnRep_SidewaysState(enum class ESidewaysState LastSidewaysState); // Function SidewaysCodeRuntime.SidewaysStateComponent.OnRep_SidewaysState // (Final|Native|Protected) // @ game+0x6762844
	void OnRep_SidewaysPlayspace(struct ASidewaysPlayspace* NewSidewaysPlayspace); // Function SidewaysCodeRuntime.SidewaysStateComponent.OnRep_SidewaysPlayspace // (Final|Native|Protected) // @ game+0x63db3cc
	void HandleSidewaysStateChanged(struct ASidewaysPlayspace* NewSidewaysPlayspace, enum class ESidewaysState OldState, enum class ESidewaysState NewState); // Function SidewaysCodeRuntime.SidewaysStateComponent.HandleSidewaysStateChanged // (Event|Protected|BlueprintEvent) // @ game+0xdef49c
	enum class ESidewaysState GetSidewaysState(); // Function SidewaysCodeRuntime.SidewaysStateComponent.GetSidewaysState // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x217c674
};
...
struct USidewaysLibrary : UBlueprintFunctionLibrary {
	...
	struct USidewaysStateComponent* GetSidewaysStateComponent(struct AActor* Owner); // Function SidewaysCodeRuntime.SidewaysLibrary.GetSidewaysStateComponent // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x67627b0
};
...
struct ASidewaysPlayspace : AFortPlayspace {
	...
	void RefreshActorsInSideways(); // Function SidewaysCodeRuntime.SidewaysPlayspace.RefreshActorsInSideways // (Final|Native|Public|BlueprintCallable) // @ game+0x67628c4
	void NotifySizeChanged(); // Function SidewaysCodeRuntime.SidewaysPlayspace.NotifySizeChanged // (Final|Native|Public|BlueprintCallable) // @ game+0x6762830
};
