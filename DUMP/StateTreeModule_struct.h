...
struct FStateTreeBlueprintTaskWrapper : FStateTreeTaskBase {
	struct UStateTreeTaskBlueprintBase* TaskClass; // 0x20(0x08)
};
...
struct FStateTreeTransitionResult {
	...
	enum class EStateTreeStateChangeType ChangeType; // 0x2a(0x01)
...
struct FStateTreeDebugTextTask : FStateTreeTaskCommonBase {
	...
	float FontScale; // 0x3c(0x04)
	struct FVector Offset; // 0x40(0x18)
	bool bEnabled; // 0x58(0x01)
