...
struct USubtitleDisplay : UWidget {
	...
	bool HasSubtitles(); // Function SubtitlesWidgets.SubtitleDisplay.HasSubtitles // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x695d3dc
};
...
struct UFortMediaSubtitlesPlayer : UObject {
	...
	void Stop(); // Function SubtitlesWidgets.FortMediaSubtitlesPlayer.Stop // (Final|Native|Public|BlueprintCallable) // @ game+0x695d4ac
	void SetSubtitles(struct UOverlays* Subtitles); // Function SubtitlesWidgets.FortMediaSubtitlesPlayer.SetSubtitles // (Final|Native|Public|BlueprintCallable) // @ game+0x695d430
	void Play(); // Function SubtitlesWidgets.FortMediaSubtitlesPlayer.Play // (Final|Native|Public|BlueprintCallable) // @ game+0x695d41c
	void BindToMediaPlayer(struct UMediaPlayer* InMediaPlayer); // Function SubtitlesWidgets.FortMediaSubtitlesPlayer.BindToMediaPlayer // (Final|Native|Public|BlueprintCallable) // @ game+0x695d2e4
};
