...
struct UTempestLightningComponent : UGameFrameworkComponent {
	...
	float GetLightningRadius(); // Function SuperstormRuntime.TempestLightningComponent.GetLightningRadius // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x682dcb4
	float GetCloudHeight(); // Function SuperstormRuntime.TempestLightningComponent.GetCloudHeight // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x682dc80
};
...
struct UTempestTornadoForcesComponent : UGameFrameworkComponent {
	...
	void OnVehicleInTornadoPlayerExit(struct AFortPlayerControllerAthena* PlayerController, struct AFortAthenaVehicle* Vehicle); // Function SuperstormRuntime.TempestTornadoForcesComponent.OnVehicleInTornadoPlayerExit // (Final|Native|Private) // @ game+0x682ddfc
	bool IsActorInTornado(struct AActor* Actor); // Function SuperstormRuntime.TempestTornadoForcesComponent.IsActorInTornado // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x682dce8
};
