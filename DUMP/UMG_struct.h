...
struct FAnimationEventBinding {
	...
	struct FDelegate Delegate; // 0x08(0x0c)
	enum class EWidgetAnimationEvent AnimationEvent; // 0x14(0x01)
	char pad_15[0x3]; // 0x15(0x03)
	struct FName UserTag; // 0x18(0x04)
...
struct FWidgetNavigationData {
	...
	struct FName WidgetToFocus; // 0x04(0x04)
	struct TWeakObjectPtr<struct UWidget> Widget; // 0x08(0x08)
	struct FDelegate CustomDelegate; // 0x10(0x0c)
};
...
struct FWidgetAnimationBinding {
	struct FName WidgetName; // 0x00(0x04)
	struct FName SlotWidgetName; // 0x04(0x04)
	struct FGuid AnimationGuid; // 0x08(0x10)
	bool bIsRootWidget; // 0x18(0x01)
...
struct FBlueprintWidgetAnimationDelegateBinding {
	...
	char pad_1[0x3]; // 0x01(0x03)
	struct FName AnimationToBind; // 0x04(0x04)
	struct FName FunctionNameToBind; // 0x08(0x04)
	struct FName UserTag; // 0x0c(0x04)
};
...
struct FDelegateRuntimeBinding {
	...
	struct FName FunctionName; // 0x14(0x04)
	struct FDynamicPropertyPath SourcePath; // 0x18(0x28)
	enum class EBindingKind Kind; // 0x40(0x01)
