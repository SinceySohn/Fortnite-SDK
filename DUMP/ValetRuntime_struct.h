...
struct FDagwoodState_PT {
	...
	struct FDagwoodOutPersistent OutPersistent; // 0x138(0x28)
	struct FDagwoodOutContinuous OutContinuous; // 0x160(0x48)
	bool bOutValid; // 0x1a8(0x01)
...
struct FDagwoodManagedState {
	...
	struct FDagwoodState_PT PT_State; // 0x278(0x1b0)
	struct APlayerController* PC; // 0x428(0x08)
	char pad_430[0x8]; // 0x430(0x08)
	struct TArray<struct FDagwoodFutureClientInput> FutureInputs; // 0x438(0x10)
};
...
struct FTireSimulationRuntimeData {
	struct FRuntimeTerrainHandlingInfo HandlingInfo; // 0x00(0x14)
	float PoppedTireSpringLength; // 0x14(0x04)
	float PoppedTireSpringStiff; // 0x18(0x04)
	float PoppedTireSpringDamp; // 0x1c(0x04)
};
