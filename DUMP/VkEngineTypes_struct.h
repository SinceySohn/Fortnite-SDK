...
struct FValkyrieProjectDescriptor {
	...
	struct FString VersionSuffix; // 0x08(0x10)
	...
	enum class EValkyrieProjectKind Kind; // 0x58(0x04)
	...
	float SortPriority; // 0x90(0x04)
	char pad_94[0x4]; // 0x94(0x04)
	struct TArray<struct FValkyriePluginReferenceDescriptor> Plugins; // 0x98(0x10)
	struct TArray<struct FValkyrieProjectDependencyDescriptor> Dependencies; // 0xa8(0x10)
	struct TMap<struct FString, struct FJsonObjectWrapper> DataSets; // 0xb8(0x50)
	char pad_108[0x60]; // 0x108(0x60)
	struct FValkyrieProjectBindingsDescriptor Bindings; // 0x168(0x60)
};
...
// Size: 0x28 (Inherited: 0x00)
struct FVkFileSize {
	struct TArray<struct FString> Types; // 0x00(0x10)
	int64_t SourceSize; // 0x10(0x08)
	int64_t UncompressedSize; // 0x18(0x08)
	int64_t CompressedSize; // 0x20(0x08)
};

// ScriptStruct VkEngineTypes.VkFileSizes
// Size: 0x50 (Inherited: 0x00)
struct FVkFileSizes {
	struct TMap<struct FString, struct FVkFileSize> FileSizeMap; // 0x00(0x50)
};
...
struct FVkJobOutput {
	struct FString BaseUrl; // 0x00(0x10)
	double TotalSizeKb; // 0x10(0x08)
	double UserContentTotalSizeKb; // 0x18(0x08)
	struct TArray<struct FString> Files; // 0x20(0x10)
...
struct FVkModuleVersionDoc {
	...
	struct TMap<enum class EConsumerRole, bool> Relevance; // 0xf0(0x50)
...
struct FVkGenerateTestcodeRequest {
	struct FVkResolvedContent Content; // 0x00(0x68)
	struct FString CommitMessage; // 0x68(0x10)
	struct FJsonObjectWrapper MatchmakingConfig; // 0x78(0x20)
	struct FString MatchmakingScheme; // 0x98(0x10)
};
...
struct FVkProjectInfoSlim {
	enum class EVkOwnerType OwnerType; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FVkNamedId Owner; // 0x08(0x20)
